...
00000373 <getppid>:
 373:	b8 22 00 00 00       	mov    $0x22,%eax
 378:	cd 40                	int    $0x40
 37a:	c3                   	ret    
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 80 07 00 00 	jmp    *0x780(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 77 07 00 00       	mov    $0x777,%edx
        while(*s != 0){
 ...
 5d1:	a1 80 0a 00 00       	mov    0xa80,%eax
{
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 80 0a 00 00    	mov    %edx,0xa80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 80 0a 00 00    	mov    0xa80,%edx

...
_custom_sys:     file format elf32-i386
...
int main(int argc, char *argv[]){
  ...
  11:	e8 15 03 00 00       	call   32b <calls>
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 485:	57                   	push   %edi
 486:	56                   	push   %esi
 487:	e8 17 fe ff ff       	call   2a3 <write>
 ...
 4b9:	ff 24 85 90 07 00 00 	jmp    *0x790(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 4de:	e8 c0 fd ff ff       	call   2a3 <write>
        putc(fd, c);
 ...
 4ef:	57                   	push   %edi
 4f0:	56                   	push   %esi
 4f1:	e8 ad fd ff ff       	call   2a3 <write>
        putc(fd, c);
 ...
 59c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 59f:	e8 ff fc ff ff       	call   2a3 <write>
        ap++;
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba 87 07 00 00       	mov    $0x787,%edx
        while(*s != 0){
 ...
 5e1:	a1 90 0a 00 00       	mov    0xa90,%eax
{
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 90 0a 00 00    	mov    %edx,0xa90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 90 0a 00 00    	mov    0xa90,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 90 0a 00 00    	mov    0xa90,%edi
 ...
 6d3:	e8 33 fc ff ff       	call   30b <sbrk>
  if(p == (char*)-1)
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 90 0a 00 00    	mov    0xa90,%edx
 ...
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf 94 0a 00 00       	mov    $0xa94,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 98 0a 00 00 00 	movl   $0x0,0xa98
 752:	00 00 00 
    if(p->s.size >= nunits){

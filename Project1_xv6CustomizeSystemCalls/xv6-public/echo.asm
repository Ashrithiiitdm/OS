 ...
 3bc:	89 d1                	mov    %edx,%ecx
{
 ...
 3e9:	0f b6 92 f0 07 00 00 	movzbl 0x7f0(%edx),%edx
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	56                   	push   %esi
 4a7:	e8 37 fe ff ff       	call   2e3 <write>
 ...
 4d9:	ff 24 85 98 07 00 00 	jmp    *0x798(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 4fe:	e8 e0 fd ff ff       	call   2e3 <write>
        putc(fd, c);
 ...
 5bc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5bf:	e8 1f fd ff ff       	call   2e3 <write>
        ap++;
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba 91 07 00 00       	mov    $0x791,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 a4 0a 00 00       	mov    0xaa4,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 a4 0a 00 00    	mov    %edx,0xaa4
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 a4 0a 00 00    	mov    %edx,0xaa4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d a4 0a 00 00    	mov    0xaa4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d a4 0a 00 00    	mov    0xaa4,%edi
 ...
 6f3:	e8 53 fc ff ff       	call   34b <sbrk>
  if(p == (char*)-1)
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 a4 0a 00 00    	mov    0xaa4,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 a4 0a 00 00    	mov    %edx,0xaa4
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 a4 0a 00 00 a8 	movl   $0xaa8,0xaa4
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf a8 0a 00 00       	mov    $0xaa8,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 a8 0a 00 00 a8 	movl   $0xaa8,0xaa8
 766:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 ac 0a 00 00 00 	movl   $0x0,0xaac
 772:	00 00 00 
    if(p->s.size >= nunits){

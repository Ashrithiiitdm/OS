...
int main(int argc, char *argv[]){
  ...
  97:	6a 01                	push   $0x1
  99:	e8 12 04 00 00       	call   4b0 <printf>
 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 439:	0f b6 92 a4 08 00 00 	movzbl 0x8a4(%edx),%edx
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 529:	ff 24 85 4c 08 00 00 	jmp    *0x84c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 637:	90                   	nop
          s = "(null)";
 638:	ba 43 08 00 00       	mov    $0x843,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d 4c 0b 00 00    	mov    0xb4c,%edi
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 4c 0b 00 00 50 	movl   $0xb50,0xb4c
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 50 0b 00 00       	mov    $0xb50,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 50 0b 00 00 50 	movl   $0xb50,0xb50
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){

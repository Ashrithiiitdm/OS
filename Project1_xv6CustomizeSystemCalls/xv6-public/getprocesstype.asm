...
_getprocesstype:     file format elf32-i386
...
int main(int argc, char *argv[]){
  ...
  17:	e8 74 02 00 00       	call   290 <atoi>
	int type = get_process_type(pid);
  1c:	89 04 24             	mov    %eax,(%esp)
  1f:	e8 8f 03 00 00       	call   3b3 <get_process_type>

	if(type == -1){
  24:	83 c4 10             	add    $0x10,%esp
  27:	83 f8 ff             	cmp    $0xffffffff,%eax
  2a:	74 18                	je     44 <main+0x44>
  ...
  2f:	74 39                	je     6a <main+0x6a>
		printf(1, "Process type: init\n");
	}
	else if(type == 1){
  31:	83 f8 01             	cmp    $0x1,%eax
  34:	74 47                	je     7d <main+0x7d>
		printf(1, "Process type: zombie\n");
	}
	else if(type == 0){
  36:	85 c0                	test   %eax,%eax
  38:	74 1d                	je     57 <main+0x57>
		printf(1, "Process type: orphan\n");
	}
	else if(type == 2){
  3a:	83 f8 02             	cmp    $0x2,%eax
  3d:	74 51                	je     90 <main+0x90>
		printf(1, "Process type: general\n");
	}

	exit();
  3f:	e8 bf 02 00 00       	call   303 <exit>
		printf(1, "Error: Invalid PID\n");
  44:	50                   	push   %eax
  45:	50                   	push   %eax
  46:	68 c8 07 00 00       	push   $0x7c8
  4b:	6a 01                	push   $0x1
  4d:	e8 4e 04 00 00       	call   4a0 <printf>
		exit();
  52:	e8 ac 02 00 00       	call   303 <exit>
		printf(1, "Process type: orphan\n");
  57:	52                   	push   %edx
  58:	52                   	push   %edx
  59:	68 06 08 00 00       	push   $0x806
  5e:	6a 01                	push   $0x1
  60:	e8 3b 04 00 00       	call   4a0 <printf>
  65:	83 c4 10             	add    $0x10,%esp
  68:	eb d5                	jmp    3f <main+0x3f>
		printf(1, "Process type: init\n");
  6a:	50                   	push   %eax
  6b:	50                   	push   %eax
  6c:	68 dc 07 00 00       	push   $0x7dc
  71:	6a 01                	push   $0x1
  73:	e8 28 04 00 00       	call   4a0 <printf>
  78:	83 c4 10             	add    $0x10,%esp
  7b:	eb c2                	jmp    3f <main+0x3f>
		printf(1, "Process type: zombie\n");
  7d:	51                   	push   %ecx
  7e:	51                   	push   %ecx
  7f:	68 f0 07 00 00       	push   $0x7f0
  84:	6a 01                	push   $0x1
  86:	e8 15 04 00 00       	call   4a0 <printf>
  8b:	83 c4 10             	add    $0x10,%esp
  8e:	eb af                	jmp    3f <main+0x3f>
		printf(1, "Process type: general\n");
  90:	50                   	push   %eax
  91:	50                   	push   %eax
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e5:	57                   	push   %edi
 4e6:	56                   	push   %esi
 4e7:	e8 37 fe ff ff       	call   323 <write>
 ...
 53e:	e8 e0 fd ff ff       	call   323 <write>
        putc(fd, c);
 ...
 54f:	57                   	push   %edi
 550:	56                   	push   %esi
 551:	e8 cd fd ff ff       	call   323 <write>
        putc(fd, c);
 ...
 5bb:	57                   	push   %edi
 5bc:	56                   	push   %esi
 5bd:	e8 61 fd ff ff       	call   323 <write>
        while(*s != 0){
 ...
 5fc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5ff:	e8 1f fd ff ff       	call   323 <write>
        ap++;
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 33 08 00 00       	mov    $0x833,%edx
        while(*s != 0){
 ...
 641:	a1 3c 0b 00 00       	mov    0xb3c,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 3c 0b 00 00    	mov    %edx,0xb3c
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 3c 0b 00 00    	mov    %edx,0xb3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 3c 0b 00 00    	mov    0xb3c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 3c 0b 00 00    	mov    0xb3c,%edi
 ...
 733:	e8 53 fc ff ff       	call   38b <sbrk>
  if(p == (char*)-1)
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 3c 0b 00 00    	mov    0xb3c,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 3c 0b 00 00    	mov    %edx,0xb3c
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 3c 0b 00 00 40 	movl   $0xb40,0xb3c
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 40 0b 00 00       	mov    $0xb40,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 40 0b 00 00 40 	movl   $0xb40,0xb40
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 44 0b 00 00 00 	movl   $0x0,0xb44
 7b2:	00 00 00 
    if(p->s.size >= nunits){

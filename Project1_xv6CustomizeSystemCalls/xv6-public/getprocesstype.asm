...
int main(int argc, char *argv[]){
  ...
  7d:	51                   	push   %ecx
  7e:	51                   	push   %ecx
  7f:	68 10 08 00 00       	push   $0x810
  84:	6a 01                	push   $0x1
  86:	e8 35 04 00 00       	call   4c0 <printf>
  8b:	83 c4 10             	add    $0x10,%esp
  8e:	eb af                	jmp    3f <main+0x3f>
		printf(1, "Process type: general\n");
  90:	50                   	push   %eax
  91:	50                   	push   %eax
  92:	68 3c 08 00 00       	push   $0x83c
  97:	6a 01                	push   $0x1
  99:	e8 22 04 00 00       	call   4c0 <printf>
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 53 08 00 00       	mov    $0x853,%edx
        while(*s != 0){

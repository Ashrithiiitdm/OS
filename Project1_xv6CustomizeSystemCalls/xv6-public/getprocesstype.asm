...
int main(int argc, char *argv[]){
  ...
  90:	50                   	push   %eax
  91:	50                   	push   %eax
  92:	68 0c 08 00 00       	push   $0x80c
  97:	6a 01                	push   $0x1
  99:	e8 f2 03 00 00       	call   490 <printf>
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 2c 08 00 00 	jmp    *0x82c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba 23 08 00 00       	mov    $0x823,%edx
        while(*s != 0){
 ...
 631:	a1 2c 0b 00 00       	mov    0xb2c,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 2c 0b 00 00    	mov    0xb2c,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 2c 0b 00 00 30 	movl   $0xb30,0xb2c
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 30 0b 00 00       	mov    $0xb30,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 30 0b 00 00 30 	movl   $0xb30,0xb30
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 34 0b 00 00 00 	movl   $0x0,0xb34
 7a2:	00 00 00 
    if(p->s.size >= nunits){

 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 b4 07 00 00 	movzbl 0x7b4(%edx),%edx
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 5c 07 00 00 	jmp    *0x75c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 55 07 00 00       	mov    $0x755,%edx
        while(*s != 0){
 ...
 5c1:	a1 5c 0a 00 00       	mov    0xa5c,%eax
{
 ...
 601:	5b                   	pop    %ebx
  freep = p;
 602:	89 15 5c 0a 00 00    	mov    %edx,0xa5c
}
 608:	5e                   	pop    %esi
 609:	5f                   	pop    %edi
 60a:	5d                   	pop    %ebp
 ...
 639:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 63c:	89 15 5c 0a 00 00    	mov    %edx,0xa5c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 3d 5c 0a 00 00    	mov    0xa5c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 4f                	jae    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	8b 3d 5c 0a 00 00    	mov    0xa5c,%edi
 ...
 6ca:	e8 f1 fe ff ff       	call   5c0 <free>
  return freep;
 6cf:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
 ...
 717:	0a 00 00 
    base.s.size = 0;
 71a:	bf 60 0a 00 00       	mov    $0xa60,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 729:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 72b:	c7 05 64 0a 00 00 00 	movl   $0x0,0xa64
 732:	00 00 00 
    if(p->s.size >= nunits){

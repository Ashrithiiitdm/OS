 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 525:	57                   	push   %edi
 526:	56                   	push   %esi
 527:	e8 37 fe ff ff       	call   363 <write>
 ...
 57e:	e8 e0 fd ff ff       	call   363 <write>
        putc(fd, c);
 ...
 5fb:	57                   	push   %edi
 5fc:	56                   	push   %esi
 5fd:	e8 61 fd ff ff       	call   363 <write>
        while(*s != 0){
 ...
 63c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 63f:	e8 1f fd ff ff       	call   363 <write>
        ap++;
 ...
 681:	a1 6c 0b 00 00       	mov    0xb6c,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 6c 0b 00 00    	mov    %edx,0xb6c
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 6c 0b 00 00    	mov    %edx,0xb6c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d 6c 0b 00 00    	mov    0xb6c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d 6c 0b 00 00    	mov    0xb6c,%edi
 ...
 773:	e8 53 fc ff ff       	call   3cb <sbrk>
  if(p == (char*)-1)
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 6c 0b 00 00    	mov    0xb6c,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 6c 0b 00 00    	mov    %edx,0xb6c
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 6c 0b 00 00 70 	movl   $0xb70,0xb6c
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf 70 0b 00 00       	mov    $0xb70,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 70 0b 00 00 70 	movl   $0xb70,0xb70
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 74 0b 00 00 00 	movl   $0x0,0xb74
 7f2:	00 00 00 
    if(p->s.size >= nunits){

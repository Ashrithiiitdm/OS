...
80100162:	e8 29 49 00 00       	call   80104a90 <release>
      acquiresleep(&b->lock);
...
801001be:	e8 0d 47 00 00       	call   801048d0 <holdingsleep>
...
801001ff:	e8 cc 46 00 00       	call   801048d0 <holdingsleep>
...
8010020f:	e8 7c 46 00 00       	call   80104890 <releasesleep>

  acquire(&bcache.lock);
80100214:	c7 04 24 20 b5 10 80 	movl   $0x8010b520,(%esp)
8010021b:	e8 d0 48 00 00       	call   80104af0 <acquire>
  b->refcnt--;
...
8010026b:	5d                   	pop    %ebp
  release(&bcache.lock);
8010026c:	e9 1f 48 00 00       	jmp    80104a90 <release>
    panic("brelse");
...
801002a0:	e8 4b 48 00 00       	call   80104af0 <acquire>
  while(n > 0){
...
801002f6:	e8 95 47 00 00       	call   80104a90 <release>
        ilock(ip);
801002fb:	5a                   	pop    %edx
...
8010034c:	e8 3f 47 00 00       	call   80104a90 <release>
  ilock(ip);
80100351:	58                   	pop    %eax
...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 4d 7d 10 80 	movl   $0x80107d4d,(%esp)
...
801003c8:	e8 73 45 00 00       	call   80104940 <getcallerpcs>
  for(i=0; i<10; i++)
...
80100551:	e8 fa 46 00 00       	call   80104c50 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100566:	e8 45 46 00 00       	call   80104bb0 <memset>
  outb(CRTPORT+1, pos);
...
801005ab:	e8 40 45 00 00       	call   80104af0 <acquire>
  for(i = 0; i < n; i++)
...
801005e4:	e8 a7 44 00 00       	call   80104a90 <release>
  ilock(ip);
801005e9:	58                   	pop    %eax
...
801007e8:	e8 03 43 00 00       	call   80104af0 <acquire>
...
8010085b:	e8 30 42 00 00       	call   80104a90 <release>
...
80100893:	e8 58 42 00 00       	call   80104af0 <acquire>
  while((c = getc()) >= 0){
...
801009d0:	e8 bb 40 00 00       	call   80104a90 <release>
  if(doprocdump) {
...
80100a70:	e8 ab 3e 00 00       	call   80104920 <initlock>
...
80100cd3:	e8 d8 40 00 00       	call   80104db0 <strlen>
...
80100ce4:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100ce7:	e8 c4 40 00 00       	call   80104db0 <strlen>
...
80100da1:	e8 ca 3f 00 00       	call   80104d70 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100e20:	e8 fb 3a 00 00       	call   80104920 <initlock>
}
...
80100e41:	e8 aa 3c 00 00       	call   80104af0 <acquire>
...
80100e71:	e8 1a 3c 00 00       	call   80104a90 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 01 3c 00 00       	call   80104a90 <release>
}
...
80100eaf:	e8 3c 3c 00 00       	call   80104af0 <acquire>
  if(f->ref < 1)
...
80100ecc:	e8 bf 3b 00 00       	call   80104a90 <release>
  return f;
}
...
80100f01:	e8 ea 3b 00 00       	call   80104af0 <acquire>
  if(f->ref < 1)
...
80100f39:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f3c:	e8 4f 3b 00 00       	call   80104a90 <release>
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 1d 3b 00 00       	jmp    80104a90 <release>
...
80101325:	e8 86 38 00 00       	call   80104bb0 <memset>
  log_write(bp);
...
8010136a:	e8 81 37 00 00       	call   80104af0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013d7:	e8 b4 36 00 00       	call   80104a90 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 86 36 00 00       	call   80104a90 <release>
      return ip;
...
80101541:	e8 0a 37 00 00       	call   80104c50 <memmove>
  brelse(bp);
...
80101576:	e8 a5 33 00 00       	call   80104920 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 5c 32 00 00       	call   801047f0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 8f 36 00 00       	call   80104c50 <memmove>
  brelse(bp);
...
8010168e:	e8 1d 35 00 00       	call   80104bb0 <memset>
      dip->type = type;
...
80101731:	e8 1a 35 00 00       	call   80104c50 <memmove>
  log_write(bp);
...
8010175f:	e8 8c 33 00 00       	call   80104af0 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010176f:	e8 1c 33 00 00       	call   80104a90 <release>
}
...
801017a2:	e8 89 30 00 00       	call   80104830 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 33 34 00 00       	call   80104c50 <memmove>
    brelse(bp);
...
80101873:	e8 58 30 00 00       	call   801048d0 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 fc 2f 00 00       	jmp    80104890 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 6b 2f 00 00       	call   80104830 <acquiresleep>
...
801018da:	e8 b1 2f 00 00       	call   80104890 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
801018e6:	e8 05 32 00 00       	call   80104af0 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 8b 31 00 00       	jmp    80104a90 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 09 11 80       	push   $0x80110960
80101910:	e8 db 31 00 00       	call   80104af0 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010191f:	e8 6c 31 00 00       	call   80104a90 <release>
    if(r == 1){
...
80101a23:	e8 a8 2e 00 00       	call   801048d0 <holdingsleep>
...
80101a3a:	e8 51 2e 00 00       	call   80104890 <releasesleep>
  iput(ip);
...
80101b37:	e8 14 31 00 00       	call   80104c50 <memmove>
    brelse(bp);
...
80101c33:	e8 18 30 00 00       	call   80104c50 <memmove>
    log_write(bp);
...
80101cce:	e8 ed 2f 00 00       	call   80104cc0 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 8e 2f 00 00       	call   80104cc0 <strncmp>
      continue;
...
80101dba:	e8 31 2d 00 00       	call   80104af0 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
80101dca:	e8 c1 2c 00 00       	call   80104a90 <release>
...
80101e27:	e8 24 2e 00 00       	call   80104c50 <memmove>
...
80101e8c:	e8 3f 2a 00 00       	call   801048d0 <holdingsleep>
...
80101eae:	e8 dd 29 00 00       	call   80104890 <releasesleep>
  iput(ip);
...
80101edb:	e8 70 2d 00 00       	call   80104c50 <memmove>
    name[len] = 0;
...
80101f2b:	e8 a0 29 00 00       	call   801048d0 <holdingsleep>
...
80101f4a:	e8 41 29 00 00       	call   80104890 <releasesleep>
  iput(ip);
...
80101f6d:	e8 5e 29 00 00       	call   801048d0 <holdingsleep>
...
80101f90:	e8 3b 29 00 00       	call   801048d0 <holdingsleep>
...
80101fa7:	e8 e4 28 00 00       	call   80104890 <releasesleep>
}
...
8010203d:	e8 ce 2c 00 00       	call   80104d10 <strncpy>
...
80102088:	68 36 80 10 80       	push   $0x80108036
...
801021d0:	e8 4b 27 00 00       	call   80104920 <initlock>
...
8010224e:	e8 9d 28 00 00       	call   80104af0 <acquire>
...
801022cb:	e8 c0 27 00 00       	call   80104a90 <release>
...
801022ee:	e8 dd 25 00 00       	call   801048d0 <holdingsleep>
...
80102328:	e8 c3 27 00 00       	call   80104af0 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 05 27 00 00       	jmp    80104a90 <release>
...
801024d2:	81 fb d0 66 11 80    	cmp    $0x801166d0,%ebx
...
801024f2:	e8 b9 26 00 00       	call   80104bb0 <memset>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 48 25 00 00       	jmp    80104a90 <release>
    panic("kfree");
...
80102625:	e8 f6 22 00 00       	call   80104920 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 38 24 00 00       	call   80104af0 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 aa 23 00 00       	call   80104a90 <release>
  return (char*)r;
...
80102af7:	e8 04 21 00 00       	call   80104c00 <memcmp>
...
80102c24:	e8 27 20 00 00       	call   80104c50 <memmove>
...
80102cd4:	e8 47 1c 00 00       	call   80104920 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 80 1d 00 00       	call   80104af0 <acquire>
...
80102dbc:	e8 cf 1c 00 00       	call   80104a90 <release>
      break;
    }
  }
}
...
80102e1c:	e8 6f 1c 00 00       	call   80104a90 <release>
}
...
80102e36:	e8 b5 1c 00 00       	call   80104af0 <acquire>
    wakeup(&log);
...
80102e58:	e8 33 1c 00 00       	call   80104a90 <release>
...
80102eb4:	e8 97 1d 00 00       	call   80104c50 <memmove>
...
80102f14:	e8 77 1b 00 00       	call   80104a90 <release>
...
80102f76:	e8 75 1b 00 00       	call   80104af0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 d6 1a 00 00       	jmp    80104a90 <release>
...
80103022:	e8 69 2e 00 00       	call   80105e90 <idtinit>
...
80103077:	68 d0 66 11 80       	push   $0x801166d0
...
801030a9:	e8 32 08 00 00       	call   801038e0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 5d 2d 00 00       	call   80105e10 <tvinit>
  binit();         // buffer cache
...
801030d4:	e8 77 1b 00 00       	call   80104c50 <memmove>
...
801031c4:	e8 37 1a 00 00       	call   80104c00 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 7c 19 00 00       	call   80104c00 <memcmp>
...
801033c8:	e8 33 18 00 00       	call   80104c00 <memcmp>
...
801034a9:	e8 72 14 00 00       	call   80104920 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 ac 15 00 00       	call   80104af0 <acquire>
  if(writable){
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 07 15 00 00       	jmp    80104a90 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 f7 14 00 00       	call   80104a90 <release>
    kfree((char*)p);
...
801035dd:	e8 0e 15 00 00       	call   80104af0 <acquire>
  for(i = 0; i < n; i++){
...
8010366c:	e8 1f 14 00 00       	call   80104a90 <release>
        return -1;
...
801036c2:	e8 c9 13 00 00       	call   80104a90 <release>
  return n;
...
801036e6:	e8 05 14 00 00       	call   80104af0 <acquire>
...
8010377e:	e8 0d 13 00 00       	call   80104a90 <release>
  return i;
...
80103799:	e8 f2 12 00 00       	call   80104a90 <release>
      return -1;
...
801037c1:	e8 2a 13 00 00       	call   80104af0 <acquire>
...
80103802:	8d 50 01             	lea    0x1(%eax),%edx
    release(&ptable.lock);
80103805:	68 20 2d 11 80       	push   $0x80112d20
    p->pid = nextpid++;
8010380a:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
    release(&ptable.lock);
80103810:	e8 7b 12 00 00       	call   80104a90 <release>
...
80103822:	74 55                	je     80103879 <allocproc+0xc9>
        return 0;
    }
...
80103832:	89 53 18             	mov    %edx,0x18(%ebx)
    *(uint*)sp = (uint)trapret;
80103835:	c7 40 14 fd 5d 10 80 	movl   $0x80105dfd,0x14(%eax)
    p->context = (struct context*)sp;
...
80103844:	e8 67 13 00 00       	call   80104bb0 <memset>
...
8010386a:	e8 21 12 00 00       	call   80104a90 <release>
}
...
8010389b:	e8 f0 11 00 00       	call   80104a90 <release>
...
801038f0:	e8 2b 10 00 00       	call   80104920 <initlock>
}
...
80103955:	68 c0 7d 10 80       	push   $0x80107dc0
...
80103984:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103987:	e8 14 10 00 00       	call   801049a0 <pushcli>
  c = mycpu();
8010398c:	e8 6f ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103991:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103997:	e8 54 10 00 00       	call   801049f0 <popcli>
}
...
801039bc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039be:	a3 54 4e 11 80       	mov    %eax,0x80114e54
  if((p->pgdir = setupkvm()) == 0)
801039c3:	e8 28 3a 00 00       	call   801073f0 <setupkvm>
...
801039e1:	e8 ba 36 00 00       	call   801070a0 <inituvm>
...
801039f6:	e8 b5 11 00 00       	call   80104bb0 <memset>
...
80103a55:	e8 16 13 00 00       	call   80104d70 <safestrcpy>
  p->cwd = namei("/");
...
80103aa5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aa8:	e8 f3 0e 00 00       	call   801049a0 <pushcli>
  c = mycpu();
80103aad:	e8 4e fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ab2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ab8:	e8 33 0f 00 00       	call   801049f0 <popcli>
  sz = curproc->sz;
...
80103acb:	e8 c0 34 00 00       	call   80106f90 <switchuvm>
  return 0;
...
80103aea:	e8 21 37 00 00       	call   80107210 <allocuvm>
...
80103b0a:	e8 31 38 00 00       	call   80107340 <deallocuvm>
...
80103b26:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b29:	e8 72 0e 00 00       	call   801049a0 <pushcli>
  c = mycpu();
80103b2e:	e8 cd fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b33:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b39:	e8 b2 0e 00 00       	call   801049f0 <popcli>
  if((np = allocproc()) == 0){
...
80103b58:	e8 83 39 00 00       	call   801074e0 <copyuvm>
...
80103c6e:	e8 7d 0e 00 00       	call   80104af0 <acquire>
...
80103c90:	e8 fb 32 00 00       	call   80106f90 <switchuvm>
...
80103c9b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103ca2:	e8 24 11 00 00       	call   80104dcb <swtch>
      switchkvm();
80103ca7:	e8 d4 32 00 00       	call   80106f80 <switchkvm>
      c->proc = 0;
...
80103ccf:	e8 bc 0d 00 00       	call   80104a90 <release>
    sti();
...
80103d43:	e8 83 10 00 00       	call   80104dcb <swtch>
  mycpu()->intena = intena;
...
80103da9:	e8 d2 fb ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103dae:	39 05 54 4e 11 80    	cmp    %eax,0x80114e54
...
80103e0a:	e8 e1 0c 00 00       	call   80104af0 <acquire>
...
80103e48:	75 e2                	jne    80103e2c <exit+0x8c>
      p->parent = initproc;
80103e4a:	8b 0d 54 4e 11 80    	mov    0x80114e54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103e60:	81 c2 84 00 00 00    	add    $0x84,%edx
80103e66:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
...
80103e87:	90                   	nop
80103e88:	05 84 00 00 00       	add    $0x84,%eax
80103e8d:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80103eb7:	68 08 7d 10 80       	push   $0x80107d08
80103ebc:	e8 bf c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ec1:	83 ec 0c             	sub    $0xc,%esp
80103ec4:	68 fb 7c 10 80       	push   $0x80107cfb
...
80103f41:	0f 85 8f 00 00 00    	jne    80103fd6 <wait+0x106>
  pushcli();
80103f47:	e8 54 0a 00 00       	call   801049a0 <pushcli>
  c = mycpu();
80103f4c:	e8 af f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103f51:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f57:	e8 94 0a 00 00       	call   801049f0 <popcli>
  if(p == 0)
...
80103f99:	e8 d2 33 00 00       	call   80107370 <freevm>
        p->pid = 0;
...
80103fc5:	e8 c6 0a 00 00       	call   80104a90 <release>
        return pid;
...
80103fe3:	e8 a8 0a 00 00       	call   80104a90 <release>
      return -1;
...
8010400c:	e8 df 0a 00 00       	call   80104af0 <acquire>
  pushcli();
80104011:	e8 8a 09 00 00       	call   801049a0 <pushcli>
  c = mycpu();
80104016:	e8 e5 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010401b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104021:	e8 ca 09 00 00       	call   801049f0 <popcli>
...
80104039:	e8 52 0a 00 00       	call   80104a90 <release>
}
...
8010405c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010405f:	e8 3c 09 00 00       	call   801049a0 <pushcli>
  c = mycpu();
80104064:	e8 97 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104069:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010406f:	e8 7c 09 00 00       	call   801049f0 <popcli>
  if(p == 0)
...
80104090:	e8 5b 0a 00 00       	call   80104af0 <acquire>
    release(lk);
80104095:	89 34 24             	mov    %esi,(%esp)
80104098:	e8 f3 09 00 00       	call   80104a90 <release>
  p->chan = chan;
...
801040ba:	e8 d1 09 00 00       	call   80104a90 <release>
    acquire(lk);
...
801040cb:	5d                   	pop    %ebp
    acquire(lk);
801040cc:	e9 1f 0a 00 00       	jmp    80104af0 <acquire>
...
8010411f:	e8 cc 09 00 00       	call   80104af0 <acquire>
...
80104135:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80104153:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80104164:	c9                   	leave  
  release(&ptable.lock);
80104165:	e9 26 09 00 00       	jmp    80104a90 <release>
...
8010417f:	e8 6c 09 00 00       	call   80104af0 <acquire>
...
80104195:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
801041bd:	e8 ce 08 00 00       	call   80104a90 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041d8:	e8 b3 08 00 00       	call   80104a90 <release>
}
...
8010420b:	68 4d 7d 10 80       	push   $0x80107d4d
80104210:	e8 8b c4 ff ff       	call   801006a0 <cprintf>
80104215:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104218:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010421e:	81 fb c0 4e 11 80    	cmp    $0x80114ec0,%ebx
...
8010422f:	74 e7                	je     80104218 <procdump+0x28>
      state = "???";
80104231:	ba 2b 7d 10 80       	mov    $0x80107d2b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104236:	83 f8 05             	cmp    $0x5,%eax
80104239:	77 11                	ja     8010424c <procdump+0x5c>
8010423b:	8b 14 85 30 7f 10 80 	mov    -0x7fef80d0(,%eax,4),%edx
      state = "???";
80104242:	b8 2b 7d 10 80       	mov    $0x80107d2b,%eax
...
80104251:	68 2f 7d 10 80       	push   $0x80107d2f
...
80104278:	e8 c3 06 00 00       	call   80104940 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042be:	be c0 4e 11 80       	mov    $0x80114ec0,%esi
801042c3:	68 20 2d 11 80       	push   $0x80112d20
801042c8:	e8 23 08 00 00       	call   80104af0 <acquire>
	cprintf("name \t pid \t state \t \n");
801042cd:	c7 04 24 38 7d 10 80 	movl   $0x80107d38,(%esp)
801042d4:	e8 c7 c3 ff ff       	call   801006a0 <cprintf>
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042d9:	83 c4 10             	add    $0x10,%esp
801042dc:	eb 16                	jmp    801042f4 <cps+0x44>
801042de:	66 90                	xchg   %ax,%ax
	    if (p->state == SLEEPING)
	      cprintf("%s \t %d \t SLEEPING \t \n ", p->name, p->pid);
	    else if (p->state == RUNNING)
801042e0:	83 f8 04             	cmp    $0x4,%eax
801042e3:	74 53                	je     80104338 <cps+0x88>
	      cprintf("%s \t %d \t RUNNING \t \n ", p->name, p->pid);
	    else if (p->state == RUNNABLE)
801042e5:	83 f8 03             	cmp    $0x3,%eax
801042e8:	74 66                	je     80104350 <cps+0xa0>
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042ea:	81 c3 84 00 00 00    	add    $0x84,%ebx
801042f0:	39 de                	cmp    %ebx,%esi
801042f2:	74 26                	je     8010431a <cps+0x6a>
	    if (p->state == SLEEPING)
801042f4:	8b 43 a0             	mov    -0x60(%ebx),%eax
801042f7:	83 f8 02             	cmp    $0x2,%eax
801042fa:	75 e4                	jne    801042e0 <cps+0x30>
	      cprintf("%s \t %d \t SLEEPING \t \n ", p->name, p->pid);
801042fc:	83 ec 04             	sub    $0x4,%esp
801042ff:	ff 73 a4             	push   -0x5c(%ebx)
80104302:	53                   	push   %ebx
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104303:	81 c3 84 00 00 00    	add    $0x84,%ebx
	      cprintf("%s \t %d \t SLEEPING \t \n ", p->name, p->pid);
80104309:	68 4f 7d 10 80       	push   $0x80107d4f
8010430e:	e8 8d c3 ff ff       	call   801006a0 <cprintf>
80104313:	83 c4 10             	add    $0x10,%esp
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104316:	39 de                	cmp    %ebx,%esi
80104318:	75 da                	jne    801042f4 <cps+0x44>
...
80104322:	e8 69 07 00 00       	call   80104a90 <release>
	
	return 22;
}
80104327:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010432a:	b8 16 00 00 00       	mov    $0x16,%eax
8010432f:	5b                   	pop    %ebx
80104330:	5e                   	pop    %esi
80104331:	5d                   	pop    %ebp
80104332:	c3                   	ret    
...
8010433f:	68 67 7d 10 80       	push   $0x80107d67
80104344:	e8 57 c3 ff ff       	call   801006a0 <cprintf>
80104349:	83 c4 10             	add    $0x10,%esp
8010434c:	eb 9c                	jmp    801042ea <cps+0x3a>
8010434e:	66 90                	xchg   %ax,%ax
	      cprintf("%s \t %d \t RUNNABLE \t \n ", p->name, p->pid);
80104350:	83 ec 04             	sub    $0x4,%esp
80104353:	ff 73 a4             	push   -0x5c(%ebx)
80104356:	53                   	push   %ebx
80104357:	68 7e 7d 10 80       	push   $0x80107d7e
...
80104370 <get_process_type>:

int get_process_type(void){
80104370:	55                   	push   %ebp
80104371:	89 e5                	mov    %esp,%ebp
80104373:	83 ec 20             	sub    $0x20,%esp
  int pid;
  struct proc *p;

  //Get the pid (given as argument) from argint.
  if(argint(0, &pid) < 0){
80104376:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104379:	50                   	push   %eax
8010437a:	6a 00                	push   $0x0
8010437c:	e8 ef 0a 00 00       	call   80104e70 <argint>
80104381:	83 c4 10             	add    $0x10,%esp
80104384:	85 c0                	test   %eax,%eax
80104386:	0f 88 b2 00 00 00    	js     8010443e <get_process_type+0xce>
    return -1;
  }

  if(pid == 1){
8010438c:	83 7d f4 01          	cmpl   $0x1,-0xc(%ebp)
    //init process
    return 3;
80104390:	b8 03 00 00 00       	mov    $0x3,%eax
  if(pid == 1){
80104395:	74 5a                	je     801043f1 <get_process_type+0x81>
  }
...
8010439f:	e8 4c 07 00 00       	call   80104af0 <acquire>
...
801043a7:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043aa:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801043af:	eb 13                	jmp    801043c4 <get_process_type+0x54>
801043b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801043b8:	05 84 00 00 00       	add    $0x84,%eax
801043bd:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801043c2:	74 4c                	je     80104410 <get_process_type+0xa0>
    if(p->pid == pid){
801043c4:	39 50 10             	cmp    %edx,0x10(%eax)
801043c7:	75 ef                	jne    801043b8 <get_process_type+0x48>

      //Checking whether the process is a zombie process or not.
      if(p->state == ZOMBIE){
801043c9:	83 78 0c 05          	cmpl   $0x5,0xc(%eax)
801043cd:	74 58                	je     80104427 <get_process_type+0xb7>
        release(&ptable.lock);
        return 1;
      }
...
801043cf:	8b 40 14             	mov    0x14(%eax),%eax
801043d2:	85 c0                	test   %eax,%eax
801043d4:	74 06                	je     801043dc <get_process_type+0x6c>
801043d6:	83 78 10 01          	cmpl   $0x1,0x10(%eax)
801043da:	74 1c                	je     801043f8 <get_process_type+0x88>
      }
...
801043df:	68 20 2d 11 80       	push   $0x80112d20
801043e4:	e8 a7 06 00 00       	call   80104a90 <release>
        return 2;
801043e9:	83 c4 10             	add    $0x10,%esp
801043ec:	b8 02 00 00 00       	mov    $0x2,%eax
...
80104400:	e8 8b 06 00 00       	call   80104a90 <release>
        return 0;
...
80104418:	e8 73 06 00 00       	call   80104a90 <release>
  return -1;
...
8010442f:	e8 5c 06 00 00       	call   80104a90 <release>
        return 1;
...
80104455:	83 ec 10             	sub    $0x10,%esp
  pushcli();
80104458:	e8 43 05 00 00       	call   801049a0 <pushcli>
  c = mycpu();
8010445d:	e8 9e f4 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104462:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104468:	e8 83 05 00 00       	call   801049f0 <popcli>
  int pid;
  struct proc *p;
...
80104474:	6a 00                	push   $0x0
80104476:	e8 f5 09 00 00       	call   80104e70 <argint>
8010447b:	83 c4 10             	add    $0x10,%esp
8010447e:	85 c0                	test   %eax,%eax
80104480:	0f 88 30 01 00 00    	js     801045b6 <wait_pid+0x166>
      return -1;
  }
...
8010448e:	e8 5d 06 00 00       	call   80104af0 <acquire>
  cprintf("wait_pid: Acquired ptable.lock for pid %d\n", pid);
80104493:	5b                   	pop    %ebx
80104494:	58                   	pop    %eax
80104495:	ff 75 f4             	push   -0xc(%ebp)
80104498:	68 e8 7d 10 80       	push   $0x80107de8
8010449d:	e8 fe c1 ff ff       	call   801006a0 <cprintf>
...
801044ad:	eb 11                	jmp    801044c0 <wait_pid+0x70>
801044af:	90                   	nop
801044b0:	05 84 00 00 00       	add    $0x84,%eax
801044b5:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801044ba:	0f 84 d0 00 00 00    	je     80104590 <wait_pid+0x140>
      if (p->pid == pid) {
801044c0:	39 50 10             	cmp    %edx,0x10(%eax)
801044c3:	75 eb                	jne    801044b0 <wait_pid+0x60>
          break;
      }
  }
...
801044c5:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801044ca:	0f 83 c0 00 00 00    	jae    80104590 <wait_pid+0x140>
801044d0:	39 c6                	cmp    %eax,%esi
801044d2:	0f 84 b8 00 00 00    	je     80104590 <wait_pid+0x140>
801044d8:	8b 48 0c             	mov    0xc(%eax),%ecx
801044db:	85 c9                	test   %ecx,%ecx
801044dd:	0f 84 ad 00 00 00    	je     80104590 <wait_pid+0x140>
  }
...
801044e3:	83 ec 04             	sub    $0x4,%esp
  currproc->waiting_for = pid;
801044e6:	89 56 7c             	mov    %edx,0x7c(%esi)
  currproc->wait_state = 1;
801044e9:	c7 86 80 00 00 00 01 	movl   $0x1,0x80(%esi)
801044f0:	00 00 00 
  cprintf("wait_pid: Process %d waiting for pid %d\n", currproc->pid, pid);
801044f3:	52                   	push   %edx
801044f4:	ff 76 10             	push   0x10(%esi)
801044f7:	68 3c 7e 10 80       	push   $0x80107e3c
801044fc:	e8 9f c1 ff ff       	call   801006a0 <cprintf>
  
  // Sleep until the target process finishes or is unwaited
  while (currproc->wait_state == 1) {
80104501:	8b 86 80 00 00 00    	mov    0x80(%esi),%eax
80104507:	83 c4 10             	add    $0x10,%esp
8010450a:	83 f8 01             	cmp    $0x1,%eax
8010450d:	75 52                	jne    80104561 <wait_pid+0x111>
8010450f:	90                   	nop
      cprintf("wait_pid: Process %d is sleeping\n", currproc->pid);
80104510:	83 ec 08             	sub    $0x8,%esp
80104513:	ff 76 10             	push   0x10(%esi)
80104516:	68 68 7e 10 80       	push   $0x80107e68
8010451b:	e8 80 c1 ff ff       	call   801006a0 <cprintf>
  pushcli();
80104520:	e8 7b 04 00 00       	call   801049a0 <pushcli>
  c = mycpu();
80104525:	e8 d6 f3 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010452a:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104530:	e8 bb 04 00 00       	call   801049f0 <popcli>
  if(p == 0)
80104535:	83 c4 10             	add    $0x10,%esp
80104538:	85 db                	test   %ebx,%ebx
8010453a:	0f 84 b4 00 00 00    	je     801045f4 <wait_pid+0x1a4>
  p->chan = chan;
80104540:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
80104543:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
8010454a:	e8 91 f7 ff ff       	call   80103ce0 <sched>
  p->chan = 0;
8010454f:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  while (currproc->wait_state == 1) {
80104556:	8b 86 80 00 00 00    	mov    0x80(%esi),%eax
8010455c:	83 f8 01             	cmp    $0x1,%eax
8010455f:	74 af                	je     80104510 <wait_pid+0xc0>
      sleep(currproc, &ptable.lock);
  }
  
  // Check if the wait was interrupted
  if (currproc->wait_state == 2) {
80104561:	83 f8 02             	cmp    $0x2,%eax
80104564:	74 57                	je     801045bd <wait_pid+0x16d>
      return -1;
  }
...
80104566:	83 ec 0c             	sub    $0xc,%esp
  currproc->waiting_for = -1;
80104569:	c7 46 7c ff ff ff ff 	movl   $0xffffffff,0x7c(%esi)
  currproc->wait_state = 0;
80104570:	c7 86 80 00 00 00 00 	movl   $0x0,0x80(%esi)
80104577:	00 00 00 
  release(&ptable.lock);
8010457a:	68 20 2d 11 80       	push   $0x80112d20
8010457f:	e8 0c 05 00 00       	call   80104a90 <release>
  return 0;
...
80104593:	68 20 2d 11 80       	push   $0x80112d20
80104598:	e8 f3 04 00 00       	call   80104a90 <release>
      cprintf("wait_pid: Invalid target process %d\n", pid);
8010459d:	58                   	pop    %eax
8010459e:	5a                   	pop    %edx
8010459f:	ff 75 f4             	push   -0xc(%ebp)
801045a2:	68 14 7e 10 80       	push   $0x80107e14
801045a7:	e8 f4 c0 ff ff       	call   801006a0 <cprintf>
      return -1;
801045ac:	83 c4 10             	add    $0x10,%esp
801045af:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045b4:	eb d3                	jmp    80104589 <wait_pid+0x139>
      return -1;
801045b6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045bb:	eb cc                	jmp    80104589 <wait_pid+0x139>
      cprintf("wait_pid: Wait interrupted for process %d\n", currproc->pid);
801045bd:	83 ec 08             	sub    $0x8,%esp
801045c0:	ff 76 10             	push   0x10(%esi)
801045c3:	68 8c 7e 10 80       	push   $0x80107e8c
801045c8:	e8 d3 c0 ff ff       	call   801006a0 <cprintf>
      currproc->waiting_for = -1;
801045cd:	c7 46 7c ff ff ff ff 	movl   $0xffffffff,0x7c(%esi)
      currproc->wait_state = 0;
801045d4:	c7 86 80 00 00 00 00 	movl   $0x0,0x80(%esi)
801045db:	00 00 00 
      release(&ptable.lock);
801045de:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801045e5:	e8 a6 04 00 00       	call   80104a90 <release>
      return -1;
801045ea:	83 c4 10             	add    $0x10,%esp
801045ed:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045f2:	eb 95                	jmp    80104589 <wait_pid+0x139>
    panic("sleep");
801045f4:	83 ec 0c             	sub    $0xc,%esp
801045f7:	68 14 7d 10 80       	push   $0x80107d14
801045fc:	e8 7f bd ff ff       	call   80100380 <panic>
...
80104616:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80104619:	e8 82 03 00 00       	call   801049a0 <pushcli>
  c = mycpu();
8010461e:	e8 dd f2 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104623:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
80104629:	e8 c2 03 00 00       	call   801049f0 <popcli>
  int pid;
  struct proc *p;
  struct proc *currproc = myproc();
  int woken = 0;
...
80104631:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104634:	50                   	push   %eax
80104635:	6a 00                	push   $0x0
80104637:	e8 34 08 00 00       	call   80104e70 <argint>
8010463c:	83 c4 10             	add    $0x10,%esp
8010463f:	85 c0                	test   %eax,%eax
80104641:	0f 88 0c 01 00 00    	js     80104753 <unwait_pid+0x143>
      return -1;
  }
...
80104647:	83 ec 0c             	sub    $0xc,%esp
  int woken = 0;
8010464a:	31 f6                	xor    %esi,%esi
  cprintf("unwait_pid: Process %d releasing waiters\n", currproc->pid);
  
  // Wake up the processes waiting for the current process (currproc)
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010464c:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  acquire(&ptable.lock);
80104651:	68 20 2d 11 80       	push   $0x80112d20
80104656:	e8 95 04 00 00       	call   80104af0 <acquire>
  cprintf("unwait_pid: Process %d releasing waiters\n", currproc->pid);
8010465b:	58                   	pop    %eax
8010465c:	5a                   	pop    %edx
8010465d:	ff 77 10             	push   0x10(%edi)
80104660:	68 b8 7e 10 80       	push   $0x80107eb8
80104665:	e8 36 c0 ff ff       	call   801006a0 <cprintf>
8010466a:	83 c4 10             	add    $0x10,%esp
8010466d:	eb 13                	jmp    80104682 <unwait_pid+0x72>
8010466f:	90                   	nop
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104670:	81 c3 84 00 00 00    	add    $0x84,%ebx
80104676:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
8010467c:	0f 84 aa 00 00 00    	je     8010472c <unwait_pid+0x11c>
      //cprintf("unwait_pid: Checking process %d, waiting_for: %d, currproc pid: %d\n", 
        //      p->pid, p->waiting_for, currproc->pid);
      
      if (p->state == SLEEPING && 
80104682:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
80104686:	75 e8                	jne    80104670 <unwait_pid+0x60>
80104688:	8b 47 10             	mov    0x10(%edi),%eax
8010468b:	39 43 7c             	cmp    %eax,0x7c(%ebx)
8010468e:	75 e0                	jne    80104670 <unwait_pid+0x60>
          p->waiting_for == currproc->pid && 
          (pid == -1 || p->pid == pid)) {
80104690:	8b 45 e4             	mov    -0x1c(%ebp),%eax
          p->waiting_for == currproc->pid && 
80104693:	83 f8 ff             	cmp    $0xffffffff,%eax
80104696:	74 05                	je     8010469d <unwait_pid+0x8d>
          (pid == -1 || p->pid == pid)) {
80104698:	3b 43 10             	cmp    0x10(%ebx),%eax
8010469b:	75 d3                	jne    80104670 <unwait_pid+0x60>
  acquire(&ptable.lock);
8010469d:	83 ec 0c             	sub    $0xc,%esp
          
          p->wait_state = 0;
          p->waiting_for = -1;
801046a0:	c7 43 7c ff ff ff ff 	movl   $0xffffffff,0x7c(%ebx)
  acquire(&ptable.lock);
801046a7:	68 20 2d 11 80       	push   $0x80112d20
          p->wait_state = 0;
801046ac:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
801046b3:	00 00 00 
  acquire(&ptable.lock);
801046b6:	e8 35 04 00 00       	call   80104af0 <acquire>
801046bb:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801046be:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801046c3:	eb 0f                	jmp    801046d4 <unwait_pid+0xc4>
801046c5:	8d 76 00             	lea    0x0(%esi),%esi
801046c8:	05 84 00 00 00       	add    $0x84,%eax
801046cd:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801046d2:	74 24                	je     801046f8 <unwait_pid+0xe8>
    if(p->state == SLEEPING && p->chan == chan)
801046d4:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
801046d8:	75 ee                	jne    801046c8 <unwait_pid+0xb8>
801046da:	39 58 20             	cmp    %ebx,0x20(%eax)
801046dd:	75 e9                	jne    801046c8 <unwait_pid+0xb8>
      p->state = RUNNABLE;
801046df:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801046e6:	05 84 00 00 00       	add    $0x84,%eax
801046eb:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801046f0:	75 e2                	jne    801046d4 <unwait_pid+0xc4>
801046f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  release(&ptable.lock);
801046f8:	83 ec 0c             	sub    $0xc,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801046fb:	81 c3 84 00 00 00    	add    $0x84,%ebx
          wakeup(p);  // Wake up the parent process
          woken++;
80104701:	83 c6 01             	add    $0x1,%esi
  release(&ptable.lock);
80104704:	68 20 2d 11 80       	push   $0x80112d20
80104709:	e8 82 03 00 00       	call   80104a90 <release>
          cprintf("unwait_pid: Woke up process %d\n", p->pid);
8010470e:	59                   	pop    %ecx
8010470f:	58                   	pop    %eax
80104710:	ff 73 8c             	push   -0x74(%ebx)
80104713:	68 e4 7e 10 80       	push   $0x80107ee4
80104718:	e8 83 bf ff ff       	call   801006a0 <cprintf>
8010471d:	83 c4 10             	add    $0x10,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104720:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80104726:	0f 85 56 ff ff ff    	jne    80104682 <unwait_pid+0x72>
      }
  }
  
  release(&ptable.lock);
8010472c:	83 ec 0c             	sub    $0xc,%esp
8010472f:	68 20 2d 11 80       	push   $0x80112d20
80104734:	e8 57 03 00 00       	call   80104a90 <release>
  cprintf("unwait_pid: Released %d waiting processes\n", woken);
80104739:	58                   	pop    %eax
8010473a:	5a                   	pop    %edx
8010473b:	56                   	push   %esi
8010473c:	68 04 7f 10 80       	push   $0x80107f04
80104741:	e8 5a bf ff ff       	call   801006a0 <cprintf>
  return woken;
...
80104752:	c3                   	ret    
      return -1;
80104753:	be ff ff ff ff       	mov    $0xffffffff,%esi
80104758:	eb ef                	jmp    80104749 <unwait_pid+0x139>
...
8010476d:	e8 fe 06 00 00       	call   80104e70 <argint>
...
8010477c:	68 20 2d 11 80       	push   $0x80112d20
80104781:	e8 6a 03 00 00       	call   80104af0 <acquire>
...
80104789:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010478c:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104791:	eb 11                	jmp    801047a4 <mem_usage+0x44>
80104793:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104797:	90                   	nop
80104798:	05 84 00 00 00       	add    $0x84,%eax
8010479d:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
801047ac:	8b 18                	mov    (%eax),%ebx
  release(&ptable.lock);
801047ae:	68 20 2d 11 80       	push   $0x80112d20
801047b3:	e8 d8 02 00 00       	call   80104a90 <release>
...
801047d5:	e8 b6 02 00 00       	call   80104a90 <release>
...
801047fa:	68 48 7f 10 80       	push   $0x80107f48
...
8010483f:	e8 ac 02 00 00       	call   80104af0 <acquire>
  while (lk->locked) {
...
80104855:	e8 f6 f7 ff ff       	call   80104050 <sleep>
  while (lk->locked) {
...
80104863:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104869:	e8 12 f1 ff ff       	call   80103980 <myproc>
...
8010487c:	5d                   	pop    %ebp
  release(&lk->lk);
8010487d:	e9 0e 02 00 00       	jmp    80104a90 <release>
...
8010489f:	e8 4c 02 00 00       	call   80104af0 <acquire>
  lk->locked = 0;
...
801048b4:	e8 57 f8 ff ff       	call   80104110 <wakeup>
  release(&lk->lk);
...
801048c4:	5d                   	pop    %ebp
  release(&lk->lk);
801048c5:	e9 c6 01 00 00       	jmp    80104a90 <release>
...
801048e2:	e8 09 02 00 00       	call   80104af0 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
801048e7:	8b 03                	mov    (%ebx),%eax
801048e9:	83 c4 10             	add    $0x10,%esp
801048ec:	85 c0                	test   %eax,%eax
801048ee:	75 18                	jne    80104908 <holdingsleep+0x38>
  release(&lk->lk);
801048f0:	83 ec 0c             	sub    $0xc,%esp
801048f3:	56                   	push   %esi
801048f4:	e8 97 01 00 00       	call   80104a90 <release>
  return r;
}
801048f9:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80104907:	90                   	nop
  r = lk->locked && (lk->pid == myproc()->pid);
80104908:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
8010490b:	e8 70 f0 ff ff       	call   80103980 <myproc>
80104910:	39 58 10             	cmp    %ebx,0x10(%eax)
80104913:	0f 94 c0             	sete   %al
80104916:	0f b6 c0             	movzbl %al,%eax
80104919:	89 c7                	mov    %eax,%edi
8010491b:	eb d3                	jmp    801048f0 <holdingsleep+0x20>
...
8010497b:	8d 51 28             	lea    0x28(%ecx),%edx
...
801049a9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801049aa:	e8 51 ef ff ff       	call   80103900 <mycpu>
801049af:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801049b5:	85 c0                	test   %eax,%eax
801049b7:	74 17                	je     801049d0 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
801049b9:	e8 42 ef ff ff       	call   80103900 <mycpu>
801049be:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
801049e1:	eb d6                	jmp    801049b9 <pushcli+0x19>
...
80104a1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104a20:	e8 db ee ff ff       	call   80103900 <mycpu>
...
80104a35:	68 53 7f 10 80       	push   $0x80107f53
80104a3a:	e8 41 b9 ff ff       	call   80100380 <panic>
    panic("popcli");
80104a3f:	83 ec 0c             	sub    $0xc,%esp
80104a42:	68 6a 7f 10 80       	push   $0x80107f6a
80104a47:	e8 34 b9 ff ff       	call   80100380 <panic>
...
80104a58:	31 db                	xor    %ebx,%ebx
  pushcli();
80104a5a:	e8 41 ff ff ff       	call   801049a0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104a5f:	8b 06                	mov    (%esi),%eax
80104a61:	85 c0                	test   %eax,%eax
80104a63:	75 0b                	jne    80104a70 <holding+0x20>
  popcli();
80104a65:	e8 86 ff ff ff       	call   801049f0 <popcli>
}
...
80104a6f:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
80104a70:	8b 5e 08             	mov    0x8(%esi),%ebx
80104a73:	e8 88 ee ff ff       	call   80103900 <mycpu>
80104a78:	39 c3                	cmp    %eax,%ebx
80104a7a:	0f 94 c3             	sete   %bl
  popcli();
80104a7d:	e8 6e ff ff ff       	call   801049f0 <popcli>
  r = lock->locked && lock->cpu == mycpu();
80104a82:	0f b6 db             	movzbl %bl,%ebx
}
...
80104a95:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80104a98:	e8 03 ff ff ff       	call   801049a0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104a9d:	8b 03                	mov    (%ebx),%eax
80104a9f:	85 c0                	test   %eax,%eax
80104aa1:	75 15                	jne    80104ab8 <release+0x28>
  popcli();
80104aa3:	e8 48 ff ff ff       	call   801049f0 <popcli>
    panic("release");
80104aa8:	83 ec 0c             	sub    $0xc,%esp
80104aab:	68 71 7f 10 80       	push   $0x80107f71
80104ab0:	e8 cb b8 ff ff       	call   80100380 <panic>
80104ab5:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80104ab8:	8b 73 08             	mov    0x8(%ebx),%esi
80104abb:	e8 40 ee ff ff       	call   80103900 <mycpu>
80104ac0:	39 c6                	cmp    %eax,%esi
80104ac2:	75 df                	jne    80104aa3 <release+0x13>
  popcli();
80104ac4:	e8 27 ff ff ff       	call   801049f0 <popcli>
  lk->pcs[0] = 0;
80104ac9:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104ad0:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104ad7:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80104adc:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
...
80104ae7:	5d                   	pop    %ebp
  popcli();
80104ae8:	e9 03 ff ff ff       	jmp    801049f0 <popcli>
...
80104af7:	e8 a4 fe ff ff       	call   801049a0 <pushcli>
  if(holding(lk))
80104afc:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80104aff:	e8 9c fe ff ff       	call   801049a0 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104b04:	8b 03                	mov    (%ebx),%eax
80104b06:	85 c0                	test   %eax,%eax
80104b08:	75 7e                	jne    80104b88 <acquire+0x98>
  popcli();
80104b0a:	e8 e1 fe ff ff       	call   801049f0 <popcli>
  asm volatile("lock; xchgl %0, %1" :
80104b0f:	b9 01 00 00 00       	mov    $0x1,%ecx
80104b14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  while(xchg(&lk->locked, 1) != 0)
80104b18:	8b 55 08             	mov    0x8(%ebp),%edx
80104b1b:	89 c8                	mov    %ecx,%eax
80104b1d:	f0 87 02             	lock xchg %eax,(%edx)
80104b20:	85 c0                	test   %eax,%eax
80104b22:	75 f4                	jne    80104b18 <acquire+0x28>
  __sync_synchronize();
80104b24:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104b29:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104b2c:	e8 cf ed ff ff       	call   80103900 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80104b31:	8b 4d 08             	mov    0x8(%ebp),%ecx
  ebp = (uint*)v - 2;
80104b34:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
80104b36:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
...
80104b4c:	77 1a                	ja     80104b68 <acquire+0x78>
    pcs[i] = ebp[1];     // saved %eip
...
80104b5d:	75 e1                	jne    80104b40 <acquire+0x50>
}
...
80104b6c:	8d 51 34             	lea    0x34(%ecx),%edx
80104b6f:	90                   	nop
    pcs[i] = 0;
...
80104b7b:	75 f3                	jne    80104b70 <acquire+0x80>
}
80104b7d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104b80:	c9                   	leave  
80104b81:	c3                   	ret    
80104b82:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80104b88:	8b 5b 08             	mov    0x8(%ebx),%ebx
80104b8b:	e8 70 ed ff ff       	call   80103900 <mycpu>
80104b90:	39 c3                	cmp    %eax,%ebx
80104b92:	0f 85 72 ff ff ff    	jne    80104b0a <acquire+0x1a>
  popcli();
80104b98:	e8 53 fe ff ff       	call   801049f0 <popcli>
    panic("acquire");
80104b9d:	83 ec 0c             	sub    $0xc,%esp
80104ba0:	68 79 7f 10 80       	push   $0x80107f79
80104ba5:	e8 d6 b7 ff ff       	call   80100380 <panic>
...
80104bb4:	8b 55 08             	mov    0x8(%ebp),%edx
80104bb7:	8b 4d 10             	mov    0x10(%ebp),%ecx
80104bba:	53                   	push   %ebx
80104bbb:	8b 45 0c             	mov    0xc(%ebp),%eax
  if ((int)dst%4 == 0 && n%4 == 0){
80104bbe:	89 d7                	mov    %edx,%edi
80104bc0:	09 cf                	or     %ecx,%edi
80104bc2:	83 e7 03             	and    $0x3,%edi
80104bc5:	75 29                	jne    80104bf0 <memset+0x40>
    c &= 0xFF;
80104bc7:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80104bca:	c1 e0 18             	shl    $0x18,%eax
80104bcd:	89 fb                	mov    %edi,%ebx
80104bcf:	c1 e9 02             	shr    $0x2,%ecx
80104bd2:	c1 e3 10             	shl    $0x10,%ebx
80104bd5:	09 d8                	or     %ebx,%eax
80104bd7:	09 f8                	or     %edi,%eax
80104bd9:	c1 e7 08             	shl    $0x8,%edi
80104bdc:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80104bde:	89 d7                	mov    %edx,%edi
80104be0:	fc                   	cld    
80104be1:	f3 ab                	rep stos %eax,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
80104be3:	5b                   	pop    %ebx
80104be4:	89 d0                	mov    %edx,%eax
80104be6:	5f                   	pop    %edi
80104be7:	5d                   	pop    %ebp
80104be8:	c3                   	ret    
...
80104c04:	8b 75 10             	mov    0x10(%ebp),%esi
...
80104c0b:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  s2 = v2;
  while(n-- > 0){
80104c0e:	85 f6                	test   %esi,%esi
80104c10:	74 2e                	je     80104c40 <memcmp+0x40>
80104c12:	01 c6                	add    %eax,%esi
80104c14:	eb 14                	jmp    80104c2a <memcmp+0x2a>
...
80104c54:	8b 55 08             	mov    0x8(%ebp),%edx
80104c57:	8b 4d 10             	mov    0x10(%ebp),%ecx
80104c5a:	56                   	push   %esi
80104c5b:	8b 75 0c             	mov    0xc(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80104c5e:	39 d6                	cmp    %edx,%esi
80104c60:	73 26                	jae    80104c88 <memmove+0x38>
80104c62:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
80104c65:	39 fa                	cmp    %edi,%edx
80104c67:	73 1f                	jae    80104c88 <memmove+0x38>
80104c69:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
80104c6c:	85 c9                	test   %ecx,%ecx
80104c6e:	74 0c                	je     80104c7c <memmove+0x2c>
      *--d = *--s;
80104c70:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
80104c74:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
80104c77:	83 e8 01             	sub    $0x1,%eax
80104c7a:	73 f4                	jae    80104c70 <memmove+0x20>
  } else
    while(n-- > 0)
      *d++ = *s++;
...
80104c7c:	5e                   	pop    %esi
80104c7d:	89 d0                	mov    %edx,%eax
80104c7f:	5f                   	pop    %edi
80104c80:	5d                   	pop    %ebp
80104c81:	c3                   	ret    
80104c82:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
80104c88:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
80104c8b:	89 d7                	mov    %edx,%edi
80104c8d:	85 c9                	test   %ecx,%ecx
80104c8f:	74 eb                	je     80104c7c <memmove+0x2c>
80104c91:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
80104c98:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
80104c99:	39 c6                	cmp    %eax,%esi
80104c9b:	75 fb                	jne    80104c98 <memmove+0x48>
}
80104c9d:	5e                   	pop    %esi
...
80104cb0:	eb 9e                	jmp    80104c50 <memmove>
...
80104cc7:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104cca:	53                   	push   %ebx
80104ccb:	8b 55 0c             	mov    0xc(%ebp),%edx
  while(n > 0 && *p && *p == *q)
80104cce:	85 f6                	test   %esi,%esi
80104cd0:	74 2e                	je     80104d00 <strncmp+0x40>
80104cd2:	01 d6                	add    %edx,%esi
80104cd4:	eb 18                	jmp    80104cee <strncmp+0x2e>
80104cd6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104cdd:	8d 76 00             	lea    0x0(%esi),%esi
80104ce0:	38 d8                	cmp    %bl,%al
80104ce2:	75 14                	jne    80104cf8 <strncmp+0x38>
    n--, p++, q++;
80104ce4:	83 c2 01             	add    $0x1,%edx
80104ce7:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80104cea:	39 f2                	cmp    %esi,%edx
80104cec:	74 12                	je     80104d00 <strncmp+0x40>
80104cee:	0f b6 01             	movzbl (%ecx),%eax
80104cf1:	0f b6 1a             	movzbl (%edx),%ebx
80104cf4:	84 c0                	test   %al,%al
80104cf6:	75 e8                	jne    80104ce0 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104cf8:	29 d8                	sub    %ebx,%eax
}
80104cfa:	5b                   	pop    %ebx
80104cfb:	5e                   	pop    %esi
80104cfc:	5d                   	pop    %ebp
...
80104d19:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80104d1c:	89 f0                	mov    %esi,%eax
80104d1e:	eb 15                	jmp    80104d35 <strncpy+0x25>
80104d20:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104d24:	8b 7d 0c             	mov    0xc(%ebp),%edi
80104d27:	83 c0 01             	add    $0x1,%eax
80104d2a:	0f b6 57 ff          	movzbl -0x1(%edi),%edx
80104d2e:	88 50 ff             	mov    %dl,-0x1(%eax)
80104d31:	84 d2                	test   %dl,%dl
80104d33:	74 09                	je     80104d3e <strncpy+0x2e>
80104d35:	89 cb                	mov    %ecx,%ebx
80104d37:	83 e9 01             	sub    $0x1,%ecx
80104d3a:	85 db                	test   %ebx,%ebx
80104d3c:	7f e2                	jg     80104d20 <strncpy+0x10>
    ;
  while(n-- > 0)
80104d3e:	89 c2                	mov    %eax,%edx
80104d40:	85 c9                	test   %ecx,%ecx
80104d42:	7e 17                	jle    80104d5b <strncpy+0x4b>
80104d44:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    *s++ = 0;
80104d48:	83 c2 01             	add    $0x1,%edx
80104d4b:	89 c1                	mov    %eax,%ecx
80104d4d:	c6 42 ff 00          	movb   $0x0,-0x1(%edx)
  while(n-- > 0)
80104d51:	29 d1                	sub    %edx,%ecx
80104d53:	8d 4c 0b ff          	lea    -0x1(%ebx,%ecx,1),%ecx
80104d57:	85 c9                	test   %ecx,%ecx
80104d59:	7f ed                	jg     80104d48 <strncpy+0x38>
  return os;
}
80104d5b:	5b                   	pop    %ebx
...
80104d74:	8b 55 10             	mov    0x10(%ebp),%edx
80104d77:	8b 75 08             	mov    0x8(%ebp),%esi
...
80104d7b:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  os = s;
  if(n <= 0)
80104d7e:	85 d2                	test   %edx,%edx
80104d80:	7e 25                	jle    80104da7 <safestrcpy+0x37>
80104d82:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
80104d86:	89 f2                	mov    %esi,%edx
80104d88:	eb 16                	jmp    80104da0 <safestrcpy+0x30>
...
80104de7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104dea:	e8 91 eb ff ff       	call   80103980 <myproc>
...
80104e27:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104e2a:	e8 51 eb ff ff       	call   80103980 <myproc>

  if(addr >= curproc->sz)
80104e2f:	39 18                	cmp    %ebx,(%eax)
80104e31:	76 2d                	jbe    80104e60 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
80104e33:	8b 55 0c             	mov    0xc(%ebp),%edx
80104e36:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80104e38:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
80104e3a:	39 d3                	cmp    %edx,%ebx
80104e3c:	73 22                	jae    80104e60 <fetchstr+0x40>
80104e3e:	89 d8                	mov    %ebx,%eax
80104e40:	eb 0d                	jmp    80104e4f <fetchstr+0x2f>
80104e42:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104e48:	83 c0 01             	add    $0x1,%eax
80104e4b:	39 c2                	cmp    %eax,%edx
80104e4d:	76 11                	jbe    80104e60 <fetchstr+0x40>
    if(*s == 0)
80104e4f:	80 38 00             	cmpb   $0x0,(%eax)
80104e52:	75 f4                	jne    80104e48 <fetchstr+0x28>
      return s - *pp;
80104e54:	29 d8                	sub    %ebx,%eax
  }
  return -1;
}
80104e56:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104e59:	c9                   	leave  
80104e5a:	c3                   	ret    
...
80104e75:	e8 06 eb ff ff       	call   80103980 <myproc>
80104e7a:	8b 55 08             	mov    0x8(%ebp),%edx
80104e7d:	8b 40 18             	mov    0x18(%eax),%eax
80104e80:	8b 40 44             	mov    0x44(%eax),%eax
80104e83:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104e86:	e8 f5 ea ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104ec6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104ec9:	e8 b2 ea ff ff       	call   80103980 <myproc>
80104ece:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ed0:	e8 ab ea ff ff       	call   80103980 <myproc>
80104ed5:	8b 55 08             	mov    0x8(%ebp),%edx
80104ed8:	8b 40 18             	mov    0x18(%eax),%eax
80104edb:	8b 40 44             	mov    0x44(%eax),%eax
80104ede:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ee1:	e8 9a ea ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ee6:	8d 7b 04             	lea    0x4(%ebx),%edi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104ee9:	8b 00                	mov    (%eax),%eax
80104eeb:	39 c7                	cmp    %eax,%edi
80104eed:	73 31                	jae    80104f20 <argptr+0x60>
80104eef:	8d 4b 08             	lea    0x8(%ebx),%ecx
80104ef2:	39 c8                	cmp    %ecx,%eax
80104ef4:	72 2a                	jb     80104f20 <argptr+0x60>
 
  if(argint(n, &i) < 0)
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104ef6:	8b 55 10             	mov    0x10(%ebp),%edx
  *ip = *(int*)(addr);
80104ef9:	8b 43 04             	mov    0x4(%ebx),%eax
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80104efc:	85 d2                	test   %edx,%edx
80104efe:	78 20                	js     80104f20 <argptr+0x60>
80104f00:	8b 16                	mov    (%esi),%edx
80104f02:	39 c2                	cmp    %eax,%edx
80104f04:	76 1a                	jbe    80104f20 <argptr+0x60>
80104f06:	8b 5d 10             	mov    0x10(%ebp),%ebx
80104f09:	01 c3                	add    %eax,%ebx
80104f0b:	39 da                	cmp    %ebx,%edx
80104f0d:	72 11                	jb     80104f20 <argptr+0x60>
    return -1;
  *pp = (char*)i;
80104f0f:	8b 55 0c             	mov    0xc(%ebp),%edx
80104f12:	89 02                	mov    %eax,(%edx)
  return 0;
...
80104f25:	eb ef                	jmp    80104f16 <argptr+0x56>
...
80104f52:	73 44                	jae    80104f98 <argstr+0x68>
80104f54:	8d 53 08             	lea    0x8(%ebx),%edx
80104f57:	39 d0                	cmp    %edx,%eax
80104f59:	72 3d                	jb     80104f98 <argstr+0x68>
  *ip = *(int*)(addr);
80104f5b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104f5e:	e8 1d ea ff ff       	call   80103980 <myproc>
  if(addr >= curproc->sz)
80104f63:	3b 18                	cmp    (%eax),%ebx
80104f65:	73 31                	jae    80104f98 <argstr+0x68>
  *pp = (char*)addr;
...
80104f70:	73 26                	jae    80104f98 <argstr+0x68>
80104f72:	89 d8                	mov    %ebx,%eax
80104f74:	eb 11                	jmp    80104f87 <argstr+0x57>
...
80104f85:	76 11                	jbe    80104f98 <argstr+0x68>
    if(*s == 0)
80104f87:	80 38 00             	cmpb   $0x0,(%eax)
80104f8a:	75 f4                	jne    80104f80 <argstr+0x50>
      return s - *pp;
...
80104fb4:	83 ec 04             	sub    $0x4,%esp
  total_calls++;
80104fb7:	83 05 08 b0 10 80 01 	addl   $0x1,0x8010b008
  int num;
  struct proc *curproc = myproc();
80104fbe:	e8 bd e9 ff ff       	call   80103980 <myproc>
80104fc3:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104fc5:	8b 40 18             	mov    0x18(%eax),%eax
80104fc8:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104fcb:	8d 50 ff             	lea    -0x1(%eax),%edx
80104fce:	83 fa 1a             	cmp    $0x1a,%edx
80104fd1:	77 1d                	ja     80104ff0 <syscall+0x40>
80104fd3:	8b 14 85 a0 7f 10 80 	mov    -0x7fef8060(,%eax,4),%edx
80104fda:	85 d2                	test   %edx,%edx
80104fdc:	74 12                	je     80104ff0 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
80104fde:	ff d2                	call   *%edx
80104fe0:	89 c2                	mov    %eax,%edx
80104fe2:	8b 43 18             	mov    0x18(%ebx),%eax
80104fe5:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104ff5:	ff 73 10             	push   0x10(%ebx)
80104ff8:	68 81 7f 10 80       	push   $0x80107f81
80104ffd:	e8 9e b6 ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
...
80105037:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010503a:	e8 81 d0 ff ff       	call   801020c0 <nameiparent>
...
8010505c:	e8 7f cc ff ff       	call   80101ce0 <dirlookup>
...
8010506e:	e8 9d c9 ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80105073:	89 34 24             	mov    %esi,(%esp)
80105076:	e8 05 c7 ff ff       	call   80101780 <ilock>
...
801050a4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
801050a6:	e8 65 c9 ff ff       	call   80101a10 <iunlockput>
    return 0;
...
801050c8:	ff 33                	push   (%ebx)
801050ca:	e8 41 c5 ff ff       	call   80101610 <ialloc>
...
801050e0:	e8 9b c6 ff ff       	call   80101780 <ilock>
  ip->major = major;
...
80105101:	e8 ca c5 ff ff       	call   801016d0 <iupdate>
...
80105113:	ff 76 04             	push   0x4(%esi)
80105116:	57                   	push   %edi
80105117:	53                   	push   %ebx
80105118:	e8 c3 ce ff ff       	call   80101fe0 <dirlink>
...
80105128:	e8 e3 c8 ff ff       	call   80101a10 <iunlockput>
  return ip;
...
80105149:	e8 82 c5 ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010514e:	83 c4 0c             	add    $0xc,%esp
80105151:	ff 76 04             	push   0x4(%esi)
80105154:	68 2c 80 10 80       	push   $0x8010802c
80105159:	56                   	push   %esi
8010515a:	e8 81 ce ff ff       	call   80101fe0 <dirlink>
...
80105169:	ff 73 04             	push   0x4(%ebx)
8010516c:	68 2b 80 10 80       	push   $0x8010802b
80105171:	56                   	push   %esi
80105172:	e8 69 ce ff ff       	call   80101fe0 <dirlink>
...
80105181:	68 1f 80 10 80       	push   $0x8010801f
80105186:	e8 f5 b1 ff ff       	call   80100380 <panic>
...
8010519f:	68 2e 80 10 80       	push   $0x8010802e
801051a4:	e8 d7 b1 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
801051a9:	83 ec 0c             	sub    $0xc,%esp
801051ac:	68 10 80 10 80       	push   $0x80108010
...
801051ce:	e8 9d fc ff ff       	call   80104e70 <argint>
...
8010524e:	e8 1d fc ff ff       	call   80104e70 <argint>
...
80105279:	e8 f2 fb ff ff       	call   80104e70 <argint>
...
8010528e:	e8 2d fc ff ff       	call   80104ec0 <argptr>
...
801052ce:	e8 9d fb ff ff       	call   80104e70 <argint>
...
801052f9:	e8 72 fb ff ff       	call   80104e70 <argint>
...
8010530e:	e8 ad fb ff ff       	call   80104ec0 <argptr>
...
8010534e:	e8 1d fb ff ff       	call   80104e70 <argint>
...
801053ae:	e8 bd fa ff ff       	call   80104e70 <argint>
...
801053d8:	e8 e3 fa ff ff       	call   80104ec0 <argptr>
...
8010541f:	e8 0c fb ff ff       	call   80104f30 <argstr>
...
80105438:	e8 f3 fa ff ff       	call   80104f30 <argstr>
...
8010556f:	e8 bc f9 ff ff       	call   80104f30 <argstr>
...
801055ad:	58                   	pop    %eax
801055ae:	5a                   	pop    %edx
801055af:	68 2c 80 10 80       	push   $0x8010802c
...
801055c8:	68 2b 80 10 80       	push   $0x8010802b
...
80105622:	e8 89 f5 ff ff       	call   80104bb0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010574f:	e8 dc f7 ff ff       	call   80104f30 <argstr>
...
80105768:	e8 03 f7 ff ff       	call   80104e70 <argint>
...
80105807:	e8 14 f8 ff ff       	call   80105020 <create>
    if(ip == 0){
...
801058af:	e8 6c f7 ff ff       	call   80105020 <create>
...
80105909:	e8 62 f5 ff ff       	call   80104e70 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010591e:	e8 4d f5 ff ff       	call   80104e70 <argint>
     argint(1, &major) < 0 ||
...
8010593e:	e8 dd f6 ff ff       	call   80105020 <create>
     argint(2, &minor) < 0 ||
...
80105a51:	e8 1a f4 ff ff       	call   80104e70 <argint>
...
80105a70:	e8 3b f1 ff ff       	call   80104bb0 <memset>
...
80105a9a:	e8 41 f3 ff ff       	call   80104de0 <fetchint>
...
80105ab8:	e8 63 f3 ff ff       	call   80104e20 <fetchstr>
...
80105b21:	e8 9a f3 ff ff       	call   80104ec0 <argptr>
...
80105c1c:	e8 4f f2 ff ff       	call   80104e70 <argint>
...
80105c6d:	e8 fe f1 ff ff       	call   80104e70 <argint>
...
80105cbd:	e8 ae f1 ff ff       	call   80104e70 <argint>
...
80105cd0:	68 80 4e 11 80       	push   $0x80114e80
80105cd5:	e8 16 ee ff ff       	call   80104af0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105cda:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105cdd:	8b 1d 60 4e 11 80    	mov    0x80114e60,%ebx
  while(ticks - ticks0 < n){
...
80105cf3:	68 80 4e 11 80       	push   $0x80114e80
80105cf8:	68 60 4e 11 80       	push   $0x80114e60
80105cfd:	e8 4e e3 ff ff       	call   80104050 <sleep>
  while(ticks - ticks0 < n){
80105d02:	a1 60 4e 11 80       	mov    0x80114e60,%eax
...
80105d20:	68 80 4e 11 80       	push   $0x80114e80
80105d25:	e8 66 ed ff ff       	call   80104a90 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105d43:	68 80 4e 11 80       	push   $0x80114e80
80105d48:	e8 43 ed ff ff       	call   80104a90 <release>
  return 0;
...
80105d64:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105d67:	68 80 4e 11 80       	push   $0x80114e80
80105d6c:	e8 7f ed ff ff       	call   80104af0 <acquire>
  xticks = ticks;
80105d71:	8b 1d 60 4e 11 80    	mov    0x80114e60,%ebx
  release(&tickslock);
80105d77:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
80105d7e:	e8 0d ed ff ff       	call   80104a90 <release>
  return xticks;
}
...
int sys_cps(void){
	return cps();
80105d90:	e9 1b e5 ff ff       	jmp    801042b0 <cps>
...
int sys_calls(void){
  if(total_calls == -1){
80105da0:	a1 08 b0 10 80       	mov    0x8010b008,%eax
80105da5:	83 f8 ff             	cmp    $0xffffffff,%eax
80105da8:	74 03                	je     80105dad <sys_calls+0xd>
    return total_calls;
  }
  else{
    return total_calls + 1;
80105daa:	83 c0 01             	add    $0x1,%eax
  }
}
80105dad:	c3                   	ret    
80105dae:	66 90                	xchg   %ax,%ax

80105db0 <sys_get_process_type>:

int sys_get_process_type(void){
  return get_process_type();
80105db0:	e9 bb e5 ff ff       	jmp    80104370 <get_process_type>
80105db5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105dbc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80105dc0 <sys_wait_pid>:
}

int sys_wait_pid(void){
  return wait_pid();
80105dc0:	e9 8b e6 ff ff       	jmp    80104450 <wait_pid>
80105dc5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105dcc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80105dd0 <sys_unwait_pid>:
}

int sys_unwait_pid(void){
  return unwait_pid();
80105dd0:	e9 3b e8 ff ff       	jmp    80104610 <unwait_pid>
80105dd5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105ddc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80105de0 <sys_mem_usage>:
}

int sys_mem_usage(void){
  return mem_usage();
80105de0:	e9 7b e9 ff ff       	jmp    80104760 <mem_usage>
...
80105de6:	06                   	push   %es
  pushl %fs
80105de7:	0f a0                	push   %fs
  pushl %gs
80105de9:	0f a8                	push   %gs
  pushal
80105deb:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105dec:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105df0:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105df2:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105df4:	54                   	push   %esp
  call trap
80105df5:	e8 c6 00 00 00       	call   80105ec0 <trap>
  addl $4, %esp
80105dfa:	83 c4 04             	add    $0x4,%esp
...
80105dfd:	61                   	popa   
  popl %gs
80105dfe:	0f a9                	pop    %gs
  popl %fs
80105e00:	0f a1                	pop    %fs
  popl %es
80105e02:	07                   	pop    %es
  popl %ds
80105e03:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105e04:	83 c4 08             	add    $0x8,%esp
  iret
80105e07:	cf                   	iret   
...
80105e20:	8b 14 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%edx
80105e27:	c7 04 c5 c2 4e 11 80 	movl   $0x8e000008,-0x7feeb13e(,%eax,8)
80105e2e:	08 00 00 8e 
80105e32:	66 89 14 c5 c0 4e 11 	mov    %dx,-0x7feeb140(,%eax,8)
80105e39:	80 
80105e3a:	c1 ea 10             	shr    $0x10,%edx
80105e3d:	66 89 14 c5 c6 4e 11 	mov    %dx,-0x7feeb13a(,%eax,8)
80105e44:	80 
  for(i = 0; i < 256; i++)
...
80105e4f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105e52:	a1 0c b1 10 80       	mov    0x8010b10c,%eax
80105e57:	c7 05 c2 50 11 80 08 	movl   $0xef000008,0x801150c2
80105e5e:	00 00 ef 
  initlock(&tickslock, "time");
80105e61:	68 71 80 10 80       	push   $0x80108071
80105e66:	68 80 4e 11 80       	push   $0x80114e80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105e6b:	66 a3 c0 50 11 80    	mov    %ax,0x801150c0
80105e71:	c1 e8 10             	shr    $0x10,%eax
80105e74:	66 a3 c6 50 11 80    	mov    %ax,0x801150c6
  initlock(&tickslock, "time");
80105e7a:	e8 a1 ea ff ff       	call   80104920 <initlock>
}
...
80105e9b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105e9f:	b8 c0 4e 11 80       	mov    $0x80114ec0,%eax
...
80105ed2:	0f 84 68 01 00 00    	je     80106040 <trap+0x180>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105ede:	0f 87 8c 00 00 00    	ja     80105f70 <trap+0xb0>
80105ee4:	ff 24 85 18 81 10 80 	jmp    *-0x7fef7ee8(,%eax,4)
...
80105eef:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105ef0:	e8 4b c3 ff ff       	call   80102240 <ideintr>
    lapiceoi();
...
80105efa:	e8 81 da ff ff       	call   80103980 <myproc>
80105eff:	85 c0                	test   %eax,%eax
80105f01:	74 1d                	je     80105f20 <trap+0x60>
80105f03:	e8 78 da ff ff       	call   80103980 <myproc>
80105f08:	8b 50 24             	mov    0x24(%eax),%edx
80105f0b:	85 d2                	test   %edx,%edx
80105f0d:	74 11                	je     80105f20 <trap+0x60>
80105f0f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105f13:	83 e0 03             	and    $0x3,%eax
80105f16:	66 83 f8 03          	cmp    $0x3,%ax
80105f1a:	0f 84 e8 01 00 00    	je     80106108 <trap+0x248>
    exit();
...
80105f27:	74 0f                	je     80105f38 <trap+0x78>
80105f29:	e8 52 da ff ff       	call   80103980 <myproc>
80105f2e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105f32:	0f 84 b8 00 00 00    	je     80105ff0 <trap+0x130>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f38:	e8 43 da ff ff       	call   80103980 <myproc>
80105f3d:	85 c0                	test   %eax,%eax
80105f3f:	74 1d                	je     80105f5e <trap+0x9e>
80105f41:	e8 3a da ff ff       	call   80103980 <myproc>
80105f46:	8b 40 24             	mov    0x24(%eax),%eax
80105f49:	85 c0                	test   %eax,%eax
80105f4b:	74 11                	je     80105f5e <trap+0x9e>
80105f4d:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105f51:	83 e0 03             	and    $0x3,%eax
80105f54:	66 83 f8 03          	cmp    $0x3,%ax
80105f58:	0f 84 0f 01 00 00    	je     8010606d <trap+0x1ad>
    exit();
}
...
80105f7a:	0f 84 a2 01 00 00    	je     80106122 <trap+0x262>
80105f80:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105f84:	0f 84 98 01 00 00    	je     80106122 <trap+0x262>
...
80105fc5:	68 d4 80 10 80       	push   $0x801080d4
80105fca:	e8 d1 a6 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105fcf:	83 c4 20             	add    $0x20,%esp
80105fd2:	e8 a9 d9 ff ff       	call   80103980 <myproc>
80105fd7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105fde:	e8 9d d9 ff ff       	call   80103980 <myproc>
80105fe3:	85 c0                	test   %eax,%eax
80105fe5:	0f 85 18 ff ff ff    	jne    80105f03 <trap+0x43>
80105feb:	e9 30 ff ff ff       	jmp    80105f20 <trap+0x60>
  if(myproc() && myproc()->state == RUNNING &&
80105ff0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105ff4:	0f 85 3e ff ff ff    	jne    80105f38 <trap+0x78>
    yield();
80105ffa:	e8 01 e0 ff ff       	call   80104000 <yield>
80105fff:	e9 34 ff ff ff       	jmp    80105f38 <trap+0x78>
...
8010600f:	e8 4c d9 ff ff       	call   80103960 <cpuid>
80106014:	57                   	push   %edi
80106015:	56                   	push   %esi
80106016:	50                   	push   %eax
80106017:	68 7c 80 10 80       	push   $0x8010807c
8010601c:	e8 7f a6 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80106021:	e8 ea c8 ff ff       	call   80102910 <lapiceoi>
    break;
80106026:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106029:	e8 52 d9 ff ff       	call   80103980 <myproc>
8010602e:	85 c0                	test   %eax,%eax
80106030:	0f 85 cd fe ff ff    	jne    80105f03 <trap+0x43>
80106036:	e9 e5 fe ff ff       	jmp    80105f20 <trap+0x60>
...
8010604a:	0f 85 c8 00 00 00    	jne    80106118 <trap+0x258>
    myproc()->tf = tf;
80106050:	e8 2b d9 ff ff       	call   80103980 <myproc>
80106055:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80106058:	e8 53 ef ff ff       	call   80104fb0 <syscall>
    if(myproc()->killed)
8010605d:	e8 1e d9 ff ff       	call   80103980 <myproc>
80106062:	8b 48 24             	mov    0x24(%eax),%ecx
80106065:	85 c9                	test   %ecx,%ecx
80106067:	0f 84 f1 fe ff ff    	je     80105f5e <trap+0x9e>
}
...
80106073:	5d                   	pop    %ebp
      exit();
80106074:	e9 27 dd ff ff       	jmp    80103da0 <exit>
80106079:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80106080:	e8 3b 02 00 00       	call   801062c0 <uartintr>
    lapiceoi();
80106085:	e8 86 c8 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010608a:	e8 f1 d8 ff ff       	call   80103980 <myproc>
8010608f:	85 c0                	test   %eax,%eax
80106091:	0f 85 6c fe ff ff    	jne    80105f03 <trap+0x43>
80106097:	e9 84 fe ff ff       	jmp    80105f20 <trap+0x60>
8010609c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801060a0:	e8 2b c7 ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
801060a5:	e8 66 c8 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801060aa:	e8 d1 d8 ff ff       	call   80103980 <myproc>
801060af:	85 c0                	test   %eax,%eax
801060b1:	0f 85 4c fe ff ff    	jne    80105f03 <trap+0x43>
801060b7:	e9 64 fe ff ff       	jmp    80105f20 <trap+0x60>
801060bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
801060c0:	e8 9b d8 ff ff       	call   80103960 <cpuid>
801060c5:	85 c0                	test   %eax,%eax
801060c7:	0f 85 28 fe ff ff    	jne    80105ef5 <trap+0x35>
      acquire(&tickslock);
801060cd:	83 ec 0c             	sub    $0xc,%esp
801060d0:	68 80 4e 11 80       	push   $0x80114e80
801060d5:	e8 16 ea ff ff       	call   80104af0 <acquire>
      wakeup(&ticks);
801060da:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
      ticks++;
801060e1:	83 05 60 4e 11 80 01 	addl   $0x1,0x80114e60
      wakeup(&ticks);
801060e8:	e8 23 e0 ff ff       	call   80104110 <wakeup>
      release(&tickslock);
801060ed:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
801060f4:	e8 97 e9 ff ff       	call   80104a90 <release>
801060f9:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
801060fc:	e9 f4 fd ff ff       	jmp    80105ef5 <trap+0x35>
80106101:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80106108:	e8 93 dc ff ff       	call   80103da0 <exit>
8010610d:	e9 0e fe ff ff       	jmp    80105f20 <trap+0x60>
80106112:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80106118:	e8 83 dc ff ff       	call   80103da0 <exit>
8010611d:	e9 2e ff ff ff       	jmp    80106050 <trap+0x190>
80106122:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106125:	e8 36 d8 ff ff       	call   80103960 <cpuid>
8010612a:	83 ec 0c             	sub    $0xc,%esp
8010612d:	56                   	push   %esi
8010612e:	57                   	push   %edi
8010612f:	50                   	push   %eax
80106130:	ff 73 30             	push   0x30(%ebx)
80106133:	68 a0 80 10 80       	push   $0x801080a0
80106138:	e8 63 a5 ff ff       	call   801006a0 <cprintf>
      panic("trap");
8010613d:	83 c4 14             	add    $0x14,%esp
80106140:	68 76 80 10 80       	push   $0x80108076
...
{
  if(!uart)
80106150:	a1 c0 56 11 80       	mov    0x801156c0,%eax
...
801061d7:	74 78                	je     80106251 <uartinit+0xd1>
  uart = 1;
801061d9:	c7 05 c0 56 11 80 01 	movl   $0x1,0x801156c0
801061e0:	00 00 00 
...
801061ec:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
801061ef:	bf 98 81 10 80       	mov    $0x80108198,%edi
...
80106209:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80106210:	a1 c0 56 11 80       	mov    0x801156c0,%eax
...
801062d7:	6a 00                	push   $0x0
  jmp alltraps
801062d9:	e9 07 fb ff ff       	jmp    80105de5 <alltraps>
...
801062e0:	6a 01                	push   $0x1
  jmp alltraps
801062e2:	e9 fe fa ff ff       	jmp    80105de5 <alltraps>
...
801062e9:	6a 02                	push   $0x2
  jmp alltraps
801062eb:	e9 f5 fa ff ff       	jmp    80105de5 <alltraps>
...
801062f2:	6a 03                	push   $0x3
  jmp alltraps
801062f4:	e9 ec fa ff ff       	jmp    80105de5 <alltraps>
...
801062fb:	6a 04                	push   $0x4
  jmp alltraps
801062fd:	e9 e3 fa ff ff       	jmp    80105de5 <alltraps>
...
80106304:	6a 05                	push   $0x5
  jmp alltraps
80106306:	e9 da fa ff ff       	jmp    80105de5 <alltraps>
...
8010630d:	6a 06                	push   $0x6
  jmp alltraps
8010630f:	e9 d1 fa ff ff       	jmp    80105de5 <alltraps>
...
80106316:	6a 07                	push   $0x7
  jmp alltraps
80106318:	e9 c8 fa ff ff       	jmp    80105de5 <alltraps>
...
8010631d:	6a 08                	push   $0x8
  jmp alltraps
8010631f:	e9 c1 fa ff ff       	jmp    80105de5 <alltraps>
...
80106326:	6a 09                	push   $0x9
  jmp alltraps
80106328:	e9 b8 fa ff ff       	jmp    80105de5 <alltraps>
...
8010632d:	6a 0a                	push   $0xa
  jmp alltraps
8010632f:	e9 b1 fa ff ff       	jmp    80105de5 <alltraps>
...
80106334:	6a 0b                	push   $0xb
  jmp alltraps
80106336:	e9 aa fa ff ff       	jmp    80105de5 <alltraps>
...
8010633b:	6a 0c                	push   $0xc
  jmp alltraps
8010633d:	e9 a3 fa ff ff       	jmp    80105de5 <alltraps>
...
80106342:	6a 0d                	push   $0xd
  jmp alltraps
80106344:	e9 9c fa ff ff       	jmp    80105de5 <alltraps>
...
80106349:	6a 0e                	push   $0xe
  jmp alltraps
8010634b:	e9 95 fa ff ff       	jmp    80105de5 <alltraps>
...
80106352:	6a 0f                	push   $0xf
  jmp alltraps
80106354:	e9 8c fa ff ff       	jmp    80105de5 <alltraps>
...
8010635b:	6a 10                	push   $0x10
  jmp alltraps
8010635d:	e9 83 fa ff ff       	jmp    80105de5 <alltraps>
...
80106362:	6a 11                	push   $0x11
  jmp alltraps
80106364:	e9 7c fa ff ff       	jmp    80105de5 <alltraps>
...
8010636b:	6a 12                	push   $0x12
  jmp alltraps
8010636d:	e9 73 fa ff ff       	jmp    80105de5 <alltraps>
...
80106374:	6a 13                	push   $0x13
  jmp alltraps
80106376:	e9 6a fa ff ff       	jmp    80105de5 <alltraps>
...
8010637d:	6a 14                	push   $0x14
  jmp alltraps
8010637f:	e9 61 fa ff ff       	jmp    80105de5 <alltraps>
...
80106386:	6a 15                	push   $0x15
  jmp alltraps
80106388:	e9 58 fa ff ff       	jmp    80105de5 <alltraps>
...
8010638f:	6a 16                	push   $0x16
  jmp alltraps
80106391:	e9 4f fa ff ff       	jmp    80105de5 <alltraps>
...
80106398:	6a 17                	push   $0x17
  jmp alltraps
8010639a:	e9 46 fa ff ff       	jmp    80105de5 <alltraps>
...
801063a1:	6a 18                	push   $0x18
  jmp alltraps
801063a3:	e9 3d fa ff ff       	jmp    80105de5 <alltraps>
...
801063aa:	6a 19                	push   $0x19
  jmp alltraps
801063ac:	e9 34 fa ff ff       	jmp    80105de5 <alltraps>
...
801063b3:	6a 1a                	push   $0x1a
  jmp alltraps
801063b5:	e9 2b fa ff ff       	jmp    80105de5 <alltraps>
...
801063bc:	6a 1b                	push   $0x1b
  jmp alltraps
801063be:	e9 22 fa ff ff       	jmp    80105de5 <alltraps>
...
801063c5:	6a 1c                	push   $0x1c
  jmp alltraps
801063c7:	e9 19 fa ff ff       	jmp    80105de5 <alltraps>
...
801063ce:	6a 1d                	push   $0x1d
  jmp alltraps
801063d0:	e9 10 fa ff ff       	jmp    80105de5 <alltraps>
...
801063d7:	6a 1e                	push   $0x1e
  jmp alltraps
801063d9:	e9 07 fa ff ff       	jmp    80105de5 <alltraps>
...
801063e0:	6a 1f                	push   $0x1f
  jmp alltraps
801063e2:	e9 fe f9 ff ff       	jmp    80105de5 <alltraps>
...
801063e9:	6a 20                	push   $0x20
  jmp alltraps
801063eb:	e9 f5 f9 ff ff       	jmp    80105de5 <alltraps>
...
801063f2:	6a 21                	push   $0x21
  jmp alltraps
801063f4:	e9 ec f9 ff ff       	jmp    80105de5 <alltraps>
...
801063fb:	6a 22                	push   $0x22
  jmp alltraps
801063fd:	e9 e3 f9 ff ff       	jmp    80105de5 <alltraps>
...
80106404:	6a 23                	push   $0x23
  jmp alltraps
80106406:	e9 da f9 ff ff       	jmp    80105de5 <alltraps>
...
8010640d:	6a 24                	push   $0x24
  jmp alltraps
8010640f:	e9 d1 f9 ff ff       	jmp    80105de5 <alltraps>
...
80106416:	6a 25                	push   $0x25
  jmp alltraps
80106418:	e9 c8 f9 ff ff       	jmp    80105de5 <alltraps>
...
8010641f:	6a 26                	push   $0x26
  jmp alltraps
80106421:	e9 bf f9 ff ff       	jmp    80105de5 <alltraps>
...
80106428:	6a 27                	push   $0x27
  jmp alltraps
8010642a:	e9 b6 f9 ff ff       	jmp    80105de5 <alltraps>
...
80106431:	6a 28                	push   $0x28
  jmp alltraps
80106433:	e9 ad f9 ff ff       	jmp    80105de5 <alltraps>
...
8010643a:	6a 29                	push   $0x29
  jmp alltraps
8010643c:	e9 a4 f9 ff ff       	jmp    80105de5 <alltraps>
...
80106443:	6a 2a                	push   $0x2a
  jmp alltraps
80106445:	e9 9b f9 ff ff       	jmp    80105de5 <alltraps>
...
8010644c:	6a 2b                	push   $0x2b
  jmp alltraps
8010644e:	e9 92 f9 ff ff       	jmp    80105de5 <alltraps>
...
80106455:	6a 2c                	push   $0x2c
  jmp alltraps
80106457:	e9 89 f9 ff ff       	jmp    80105de5 <alltraps>
...
8010645e:	6a 2d                	push   $0x2d
  jmp alltraps
80106460:	e9 80 f9 ff ff       	jmp    80105de5 <alltraps>
...
80106467:	6a 2e                	push   $0x2e
  jmp alltraps
80106469:	e9 77 f9 ff ff       	jmp    80105de5 <alltraps>
...
80106470:	6a 2f                	push   $0x2f
  jmp alltraps
80106472:	e9 6e f9 ff ff       	jmp    80105de5 <alltraps>
...
80106479:	6a 30                	push   $0x30
  jmp alltraps
8010647b:	e9 65 f9 ff ff       	jmp    80105de5 <alltraps>
...
80106482:	6a 31                	push   $0x31
  jmp alltraps
80106484:	e9 5c f9 ff ff       	jmp    80105de5 <alltraps>
...
8010648b:	6a 32                	push   $0x32
  jmp alltraps
8010648d:	e9 53 f9 ff ff       	jmp    80105de5 <alltraps>
...
80106494:	6a 33                	push   $0x33
  jmp alltraps
80106496:	e9 4a f9 ff ff       	jmp    80105de5 <alltraps>
...
8010649d:	6a 34                	push   $0x34
  jmp alltraps
8010649f:	e9 41 f9 ff ff       	jmp    80105de5 <alltraps>
...
801064a6:	6a 35                	push   $0x35
  jmp alltraps
801064a8:	e9 38 f9 ff ff       	jmp    80105de5 <alltraps>
...
801064af:	6a 36                	push   $0x36
  jmp alltraps
801064b1:	e9 2f f9 ff ff       	jmp    80105de5 <alltraps>
...
801064b8:	6a 37                	push   $0x37
  jmp alltraps
801064ba:	e9 26 f9 ff ff       	jmp    80105de5 <alltraps>
...
801064c1:	6a 38                	push   $0x38
  jmp alltraps
801064c3:	e9 1d f9 ff ff       	jmp    80105de5 <alltraps>
...
801064ca:	6a 39                	push   $0x39
  jmp alltraps
801064cc:	e9 14 f9 ff ff       	jmp    80105de5 <alltraps>
...
801064d3:	6a 3a                	push   $0x3a
  jmp alltraps
801064d5:	e9 0b f9 ff ff       	jmp    80105de5 <alltraps>
...
801064dc:	6a 3b                	push   $0x3b
  jmp alltraps
801064de:	e9 02 f9 ff ff       	jmp    80105de5 <alltraps>
...
801064e5:	6a 3c                	push   $0x3c
  jmp alltraps
801064e7:	e9 f9 f8 ff ff       	jmp    80105de5 <alltraps>
...
801064ee:	6a 3d                	push   $0x3d
  jmp alltraps
801064f0:	e9 f0 f8 ff ff       	jmp    80105de5 <alltraps>
...
801064f7:	6a 3e                	push   $0x3e
  jmp alltraps
801064f9:	e9 e7 f8 ff ff       	jmp    80105de5 <alltraps>
...
80106500:	6a 3f                	push   $0x3f
  jmp alltraps
80106502:	e9 de f8 ff ff       	jmp    80105de5 <alltraps>
...
80106509:	6a 40                	push   $0x40
  jmp alltraps
8010650b:	e9 d5 f8 ff ff       	jmp    80105de5 <alltraps>
...
80106512:	6a 41                	push   $0x41
  jmp alltraps
80106514:	e9 cc f8 ff ff       	jmp    80105de5 <alltraps>
...
8010651b:	6a 42                	push   $0x42
  jmp alltraps
8010651d:	e9 c3 f8 ff ff       	jmp    80105de5 <alltraps>
...
80106524:	6a 43                	push   $0x43
  jmp alltraps
80106526:	e9 ba f8 ff ff       	jmp    80105de5 <alltraps>
...
8010652d:	6a 44                	push   $0x44
  jmp alltraps
8010652f:	e9 b1 f8 ff ff       	jmp    80105de5 <alltraps>
...
80106536:	6a 45                	push   $0x45
  jmp alltraps
80106538:	e9 a8 f8 ff ff       	jmp    80105de5 <alltraps>
...
8010653f:	6a 46                	push   $0x46
  jmp alltraps
80106541:	e9 9f f8 ff ff       	jmp    80105de5 <alltraps>
...
80106548:	6a 47                	push   $0x47
  jmp alltraps
8010654a:	e9 96 f8 ff ff       	jmp    80105de5 <alltraps>
...
80106551:	6a 48                	push   $0x48
  jmp alltraps
80106553:	e9 8d f8 ff ff       	jmp    80105de5 <alltraps>
...
8010655a:	6a 49                	push   $0x49
  jmp alltraps
8010655c:	e9 84 f8 ff ff       	jmp    80105de5 <alltraps>
...
80106563:	6a 4a                	push   $0x4a
  jmp alltraps
80106565:	e9 7b f8 ff ff       	jmp    80105de5 <alltraps>
...
8010656c:	6a 4b                	push   $0x4b
  jmp alltraps
8010656e:	e9 72 f8 ff ff       	jmp    80105de5 <alltraps>
...
80106575:	6a 4c                	push   $0x4c
  jmp alltraps
80106577:	e9 69 f8 ff ff       	jmp    80105de5 <alltraps>
...
8010657e:	6a 4d                	push   $0x4d
  jmp alltraps
80106580:	e9 60 f8 ff ff       	jmp    80105de5 <alltraps>
...
80106587:	6a 4e                	push   $0x4e
  jmp alltraps
80106589:	e9 57 f8 ff ff       	jmp    80105de5 <alltraps>
...
80106590:	6a 4f                	push   $0x4f
  jmp alltraps
80106592:	e9 4e f8 ff ff       	jmp    80105de5 <alltraps>
...
80106599:	6a 50                	push   $0x50
  jmp alltraps
8010659b:	e9 45 f8 ff ff       	jmp    80105de5 <alltraps>
...
801065a2:	6a 51                	push   $0x51
  jmp alltraps
801065a4:	e9 3c f8 ff ff       	jmp    80105de5 <alltraps>
...
801065ab:	6a 52                	push   $0x52
  jmp alltraps
801065ad:	e9 33 f8 ff ff       	jmp    80105de5 <alltraps>
...
801065b4:	6a 53                	push   $0x53
  jmp alltraps
801065b6:	e9 2a f8 ff ff       	jmp    80105de5 <alltraps>
...
801065bd:	6a 54                	push   $0x54
  jmp alltraps
801065bf:	e9 21 f8 ff ff       	jmp    80105de5 <alltraps>
...
801065c6:	6a 55                	push   $0x55
  jmp alltraps
801065c8:	e9 18 f8 ff ff       	jmp    80105de5 <alltraps>
...
801065cf:	6a 56                	push   $0x56
  jmp alltraps
801065d1:	e9 0f f8 ff ff       	jmp    80105de5 <alltraps>
...
801065d8:	6a 57                	push   $0x57
  jmp alltraps
801065da:	e9 06 f8 ff ff       	jmp    80105de5 <alltraps>
...
801065e1:	6a 58                	push   $0x58
  jmp alltraps
801065e3:	e9 fd f7 ff ff       	jmp    80105de5 <alltraps>
...
801065ea:	6a 59                	push   $0x59
  jmp alltraps
801065ec:	e9 f4 f7 ff ff       	jmp    80105de5 <alltraps>
...
801065f3:	6a 5a                	push   $0x5a
  jmp alltraps
801065f5:	e9 eb f7 ff ff       	jmp    80105de5 <alltraps>
...
801065fc:	6a 5b                	push   $0x5b
  jmp alltraps
801065fe:	e9 e2 f7 ff ff       	jmp    80105de5 <alltraps>
...
80106605:	6a 5c                	push   $0x5c
  jmp alltraps
80106607:	e9 d9 f7 ff ff       	jmp    80105de5 <alltraps>
...
8010660e:	6a 5d                	push   $0x5d
  jmp alltraps
80106610:	e9 d0 f7 ff ff       	jmp    80105de5 <alltraps>
...
80106617:	6a 5e                	push   $0x5e
  jmp alltraps
80106619:	e9 c7 f7 ff ff       	jmp    80105de5 <alltraps>
...
80106620:	6a 5f                	push   $0x5f
  jmp alltraps
80106622:	e9 be f7 ff ff       	jmp    80105de5 <alltraps>
...
80106629:	6a 60                	push   $0x60
  jmp alltraps
8010662b:	e9 b5 f7 ff ff       	jmp    80105de5 <alltraps>
...
80106632:	6a 61                	push   $0x61
  jmp alltraps
80106634:	e9 ac f7 ff ff       	jmp    80105de5 <alltraps>
...
8010663b:	6a 62                	push   $0x62
  jmp alltraps
8010663d:	e9 a3 f7 ff ff       	jmp    80105de5 <alltraps>
...
80106644:	6a 63                	push   $0x63
  jmp alltraps
80106646:	e9 9a f7 ff ff       	jmp    80105de5 <alltraps>
...
8010664d:	6a 64                	push   $0x64
  jmp alltraps
8010664f:	e9 91 f7 ff ff       	jmp    80105de5 <alltraps>
...
80106656:	6a 65                	push   $0x65
  jmp alltraps
80106658:	e9 88 f7 ff ff       	jmp    80105de5 <alltraps>
...
8010665f:	6a 66                	push   $0x66
  jmp alltraps
80106661:	e9 7f f7 ff ff       	jmp    80105de5 <alltraps>
...
80106668:	6a 67                	push   $0x67
  jmp alltraps
8010666a:	e9 76 f7 ff ff       	jmp    80105de5 <alltraps>
...
80106671:	6a 68                	push   $0x68
  jmp alltraps
80106673:	e9 6d f7 ff ff       	jmp    80105de5 <alltraps>
...
8010667a:	6a 69                	push   $0x69
  jmp alltraps
8010667c:	e9 64 f7 ff ff       	jmp    80105de5 <alltraps>
...
80106683:	6a 6a                	push   $0x6a
  jmp alltraps
80106685:	e9 5b f7 ff ff       	jmp    80105de5 <alltraps>
...
8010668c:	6a 6b                	push   $0x6b
  jmp alltraps
8010668e:	e9 52 f7 ff ff       	jmp    80105de5 <alltraps>
...
80106695:	6a 6c                	push   $0x6c
  jmp alltraps
80106697:	e9 49 f7 ff ff       	jmp    80105de5 <alltraps>
...
8010669e:	6a 6d                	push   $0x6d
  jmp alltraps
801066a0:	e9 40 f7 ff ff       	jmp    80105de5 <alltraps>
...
801066a7:	6a 6e                	push   $0x6e
  jmp alltraps
801066a9:	e9 37 f7 ff ff       	jmp    80105de5 <alltraps>
...
801066b0:	6a 6f                	push   $0x6f
  jmp alltraps
801066b2:	e9 2e f7 ff ff       	jmp    80105de5 <alltraps>
...
801066b9:	6a 70                	push   $0x70
  jmp alltraps
801066bb:	e9 25 f7 ff ff       	jmp    80105de5 <alltraps>
...
801066c2:	6a 71                	push   $0x71
  jmp alltraps
801066c4:	e9 1c f7 ff ff       	jmp    80105de5 <alltraps>
...
801066cb:	6a 72                	push   $0x72
  jmp alltraps
801066cd:	e9 13 f7 ff ff       	jmp    80105de5 <alltraps>
...
801066d4:	6a 73                	push   $0x73
  jmp alltraps
801066d6:	e9 0a f7 ff ff       	jmp    80105de5 <alltraps>
...
801066dd:	6a 74                	push   $0x74
  jmp alltraps
801066df:	e9 01 f7 ff ff       	jmp    80105de5 <alltraps>
...
801066e6:	6a 75                	push   $0x75
  jmp alltraps
801066e8:	e9 f8 f6 ff ff       	jmp    80105de5 <alltraps>
...
801066ef:	6a 76                	push   $0x76
  jmp alltraps
801066f1:	e9 ef f6 ff ff       	jmp    80105de5 <alltraps>
...
801066f8:	6a 77                	push   $0x77
  jmp alltraps
801066fa:	e9 e6 f6 ff ff       	jmp    80105de5 <alltraps>
...
80106701:	6a 78                	push   $0x78
  jmp alltraps
80106703:	e9 dd f6 ff ff       	jmp    80105de5 <alltraps>
...
8010670a:	6a 79                	push   $0x79
  jmp alltraps
8010670c:	e9 d4 f6 ff ff       	jmp    80105de5 <alltraps>
...
80106713:	6a 7a                	push   $0x7a
  jmp alltraps
80106715:	e9 cb f6 ff ff       	jmp    80105de5 <alltraps>
...
8010671c:	6a 7b                	push   $0x7b
  jmp alltraps
8010671e:	e9 c2 f6 ff ff       	jmp    80105de5 <alltraps>
...
80106725:	6a 7c                	push   $0x7c
  jmp alltraps
80106727:	e9 b9 f6 ff ff       	jmp    80105de5 <alltraps>
...
8010672e:	6a 7d                	push   $0x7d
  jmp alltraps
80106730:	e9 b0 f6 ff ff       	jmp    80105de5 <alltraps>
...
80106737:	6a 7e                	push   $0x7e
  jmp alltraps
80106739:	e9 a7 f6 ff ff       	jmp    80105de5 <alltraps>
...
80106740:	6a 7f                	push   $0x7f
  jmp alltraps
80106742:	e9 9e f6 ff ff       	jmp    80105de5 <alltraps>
...
80106749:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010674e:	e9 92 f6 ff ff       	jmp    80105de5 <alltraps>
...
80106755:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010675a:	e9 86 f6 ff ff       	jmp    80105de5 <alltraps>
...
80106761:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106766:	e9 7a f6 ff ff       	jmp    80105de5 <alltraps>
...
8010676d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106772:	e9 6e f6 ff ff       	jmp    80105de5 <alltraps>
...
80106779:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010677e:	e9 62 f6 ff ff       	jmp    80105de5 <alltraps>
...
80106785:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010678a:	e9 56 f6 ff ff       	jmp    80105de5 <alltraps>
...
80106791:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106796:	e9 4a f6 ff ff       	jmp    80105de5 <alltraps>
...
8010679d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801067a2:	e9 3e f6 ff ff       	jmp    80105de5 <alltraps>
...
801067a9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801067ae:	e9 32 f6 ff ff       	jmp    80105de5 <alltraps>
...
801067b5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801067ba:	e9 26 f6 ff ff       	jmp    80105de5 <alltraps>
...
801067c1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801067c6:	e9 1a f6 ff ff       	jmp    80105de5 <alltraps>
...
801067cd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801067d2:	e9 0e f6 ff ff       	jmp    80105de5 <alltraps>
...
801067d9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801067de:	e9 02 f6 ff ff       	jmp    80105de5 <alltraps>
...
801067e5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801067ea:	e9 f6 f5 ff ff       	jmp    80105de5 <alltraps>
...
801067f1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801067f6:	e9 ea f5 ff ff       	jmp    80105de5 <alltraps>
...
801067fd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106802:	e9 de f5 ff ff       	jmp    80105de5 <alltraps>
...
80106809:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010680e:	e9 d2 f5 ff ff       	jmp    80105de5 <alltraps>
...
80106815:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010681a:	e9 c6 f5 ff ff       	jmp    80105de5 <alltraps>
...
80106821:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106826:	e9 ba f5 ff ff       	jmp    80105de5 <alltraps>
...
8010682d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106832:	e9 ae f5 ff ff       	jmp    80105de5 <alltraps>
...
80106839:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010683e:	e9 a2 f5 ff ff       	jmp    80105de5 <alltraps>
...
80106845:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010684a:	e9 96 f5 ff ff       	jmp    80105de5 <alltraps>
...
80106851:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106856:	e9 8a f5 ff ff       	jmp    80105de5 <alltraps>
...
8010685d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106862:	e9 7e f5 ff ff       	jmp    80105de5 <alltraps>
...
80106869:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010686e:	e9 72 f5 ff ff       	jmp    80105de5 <alltraps>
...
80106875:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010687a:	e9 66 f5 ff ff       	jmp    80105de5 <alltraps>
...
80106881:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106886:	e9 5a f5 ff ff       	jmp    80105de5 <alltraps>
...
8010688d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106892:	e9 4e f5 ff ff       	jmp    80105de5 <alltraps>
...
80106899:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010689e:	e9 42 f5 ff ff       	jmp    80105de5 <alltraps>
...
801068a5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801068aa:	e9 36 f5 ff ff       	jmp    80105de5 <alltraps>
...
801068b1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801068b6:	e9 2a f5 ff ff       	jmp    80105de5 <alltraps>
...
801068bd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801068c2:	e9 1e f5 ff ff       	jmp    80105de5 <alltraps>
...
801068c9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801068ce:	e9 12 f5 ff ff       	jmp    80105de5 <alltraps>
...
801068d5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801068da:	e9 06 f5 ff ff       	jmp    80105de5 <alltraps>
...
801068e1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801068e6:	e9 fa f4 ff ff       	jmp    80105de5 <alltraps>
...
801068ed:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801068f2:	e9 ee f4 ff ff       	jmp    80105de5 <alltraps>
...
801068f9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801068fe:	e9 e2 f4 ff ff       	jmp    80105de5 <alltraps>
...
80106905:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010690a:	e9 d6 f4 ff ff       	jmp    80105de5 <alltraps>
...
80106911:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106916:	e9 ca f4 ff ff       	jmp    80105de5 <alltraps>
...
8010691d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106922:	e9 be f4 ff ff       	jmp    80105de5 <alltraps>
...
80106929:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010692e:	e9 b2 f4 ff ff       	jmp    80105de5 <alltraps>
...
80106935:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010693a:	e9 a6 f4 ff ff       	jmp    80105de5 <alltraps>
...
80106941:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106946:	e9 9a f4 ff ff       	jmp    80105de5 <alltraps>
...
8010694d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106952:	e9 8e f4 ff ff       	jmp    80105de5 <alltraps>
...
80106959:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010695e:	e9 82 f4 ff ff       	jmp    80105de5 <alltraps>
...
80106965:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010696a:	e9 76 f4 ff ff       	jmp    80105de5 <alltraps>
...
80106971:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106976:	e9 6a f4 ff ff       	jmp    80105de5 <alltraps>
...
8010697d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106982:	e9 5e f4 ff ff       	jmp    80105de5 <alltraps>
...
80106989:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010698e:	e9 52 f4 ff ff       	jmp    80105de5 <alltraps>
...
80106995:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010699a:	e9 46 f4 ff ff       	jmp    80105de5 <alltraps>
...
801069a1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801069a6:	e9 3a f4 ff ff       	jmp    80105de5 <alltraps>
...
801069ad:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801069b2:	e9 2e f4 ff ff       	jmp    80105de5 <alltraps>
...
801069b9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801069be:	e9 22 f4 ff ff       	jmp    80105de5 <alltraps>
...
801069c5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801069ca:	e9 16 f4 ff ff       	jmp    80105de5 <alltraps>
...
801069d1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801069d6:	e9 0a f4 ff ff       	jmp    80105de5 <alltraps>
...
801069dd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801069e2:	e9 fe f3 ff ff       	jmp    80105de5 <alltraps>
...
801069e9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801069ee:	e9 f2 f3 ff ff       	jmp    80105de5 <alltraps>
...
801069f5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801069fa:	e9 e6 f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a01:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106a06:	e9 da f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a0d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106a12:	e9 ce f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a19:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106a1e:	e9 c2 f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a25:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106a2a:	e9 b6 f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a31:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106a36:	e9 aa f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a3d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106a42:	e9 9e f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a49:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106a4e:	e9 92 f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a55:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106a5a:	e9 86 f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a61:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106a66:	e9 7a f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a6d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106a72:	e9 6e f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a79:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106a7e:	e9 62 f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a85:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106a8a:	e9 56 f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a91:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106a96:	e9 4a f3 ff ff       	jmp    80105de5 <alltraps>
...
80106a9d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106aa2:	e9 3e f3 ff ff       	jmp    80105de5 <alltraps>
...
80106aa9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106aae:	e9 32 f3 ff ff       	jmp    80105de5 <alltraps>
...
80106ab5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106aba:	e9 26 f3 ff ff       	jmp    80105de5 <alltraps>
...
80106ac1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106ac6:	e9 1a f3 ff ff       	jmp    80105de5 <alltraps>
...
80106acd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106ad2:	e9 0e f3 ff ff       	jmp    80105de5 <alltraps>
...
80106ad9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106ade:	e9 02 f3 ff ff       	jmp    80105de5 <alltraps>
...
80106ae5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106aea:	e9 f6 f2 ff ff       	jmp    80105de5 <alltraps>
...
80106af1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106af6:	e9 ea f2 ff ff       	jmp    80105de5 <alltraps>
...
80106afd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106b02:	e9 de f2 ff ff       	jmp    80105de5 <alltraps>
...
80106b09:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106b0e:	e9 d2 f2 ff ff       	jmp    80105de5 <alltraps>
...
80106b15:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106b1a:	e9 c6 f2 ff ff       	jmp    80105de5 <alltraps>
...
80106b21:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106b26:	e9 ba f2 ff ff       	jmp    80105de5 <alltraps>
...
80106b2d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106b32:	e9 ae f2 ff ff       	jmp    80105de5 <alltraps>
...
80106b39:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106b3e:	e9 a2 f2 ff ff       	jmp    80105de5 <alltraps>
...
80106b45:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106b4a:	e9 96 f2 ff ff       	jmp    80105de5 <alltraps>
...
80106b51:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106b56:	e9 8a f2 ff ff       	jmp    80105de5 <alltraps>
...
80106b5d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106b62:	e9 7e f2 ff ff       	jmp    80105de5 <alltraps>
...
80106b69:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106b6e:	e9 72 f2 ff ff       	jmp    80105de5 <alltraps>
...
80106b75:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106b7a:	e9 66 f2 ff ff       	jmp    80105de5 <alltraps>
...
80106b81:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106b86:	e9 5a f2 ff ff       	jmp    80105de5 <alltraps>
...
80106b8d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106b92:	e9 4e f2 ff ff       	jmp    80105de5 <alltraps>
...
80106b99:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106b9e:	e9 42 f2 ff ff       	jmp    80105de5 <alltraps>
...
80106ba5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106baa:	e9 36 f2 ff ff       	jmp    80105de5 <alltraps>
...
80106bb1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106bb6:	e9 2a f2 ff ff       	jmp    80105de5 <alltraps>
...
80106bbd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106bc2:	e9 1e f2 ff ff       	jmp    80105de5 <alltraps>
...
80106bc9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106bce:	e9 12 f2 ff ff       	jmp    80105de5 <alltraps>
...
80106bd5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106bda:	e9 06 f2 ff ff       	jmp    80105de5 <alltraps>
...
80106be1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106be6:	e9 fa f1 ff ff       	jmp    80105de5 <alltraps>
...
80106bed:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106bf2:	e9 ee f1 ff ff       	jmp    80105de5 <alltraps>
...
80106bf9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106bfe:	e9 e2 f1 ff ff       	jmp    80105de5 <alltraps>
...
80106c05:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106c0a:	e9 d6 f1 ff ff       	jmp    80105de5 <alltraps>
...
80106c11:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106c16:	e9 ca f1 ff ff       	jmp    80105de5 <alltraps>
...
80106c1d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106c22:	e9 be f1 ff ff       	jmp    80105de5 <alltraps>
...
80106c29:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106c2e:	e9 b2 f1 ff ff       	jmp    80105de5 <alltraps>
...
80106c35:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106c3a:	e9 a6 f1 ff ff       	jmp    80105de5 <alltraps>
...
80106c41:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106c46:	e9 9a f1 ff ff       	jmp    80105de5 <alltraps>
...
80106c4d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106c52:	e9 8e f1 ff ff       	jmp    80105de5 <alltraps>
...
80106c59:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106c5e:	e9 82 f1 ff ff       	jmp    80105de5 <alltraps>
...
80106c65:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106c6a:	e9 76 f1 ff ff       	jmp    80105de5 <alltraps>
...
80106c71:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106c76:	e9 6a f1 ff ff       	jmp    80105de5 <alltraps>
...
80106c7d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106c82:	e9 5e f1 ff ff       	jmp    80105de5 <alltraps>
...
80106c89:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106c8e:	e9 52 f1 ff ff       	jmp    80105de5 <alltraps>
...
80106c95:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106c9a:	e9 46 f1 ff ff       	jmp    80105de5 <alltraps>
...
80106ca1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106ca6:	e9 3a f1 ff ff       	jmp    80105de5 <alltraps>
...
80106cad:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106cb2:	e9 2e f1 ff ff       	jmp    80105de5 <alltraps>
...
80106cb9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106cbe:	e9 22 f1 ff ff       	jmp    80105de5 <alltraps>
...
80106cc5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106cca:	e9 16 f1 ff ff       	jmp    80105de5 <alltraps>
...
80106cd1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106cd6:	e9 0a f1 ff ff       	jmp    80105de5 <alltraps>
...
80106cdd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106ce2:	e9 fe f0 ff ff       	jmp    80105de5 <alltraps>
...
80106ce9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106cee:	e9 f2 f0 ff ff       	jmp    80105de5 <alltraps>
...
80106cf5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106cfa:	e9 e6 f0 ff ff       	jmp    80105de5 <alltraps>
...
80106d01:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106d06:	e9 da f0 ff ff       	jmp    80105de5 <alltraps>
...
80106d0d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106d12:	e9 ce f0 ff ff       	jmp    80105de5 <alltraps>
...
80106d19:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106d1e:	e9 c2 f0 ff ff       	jmp    80105de5 <alltraps>
...
80106d25:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106d2a:	e9 b6 f0 ff ff       	jmp    80105de5 <alltraps>
...
80106d31:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106d36:	e9 aa f0 ff ff       	jmp    80105de5 <alltraps>
...
80106d3d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106d42:	e9 9e f0 ff ff       	jmp    80105de5 <alltraps>
...
80106e95:	e8 16 dd ff ff       	call   80104bb0 <memset>
...
80106edd:	68 a0 81 10 80       	push   $0x801081a0
...
80106ef3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106ef6:	e8 65 ca ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106f80:	a1 c4 56 11 80       	mov    0x801156c4,%eax
...
80106fb4:	0f 84 c2 00 00 00    	je     8010707c <switchuvm+0xec>
  pushcli();
80106fba:	e8 e1 d9 ff ff       	call   801049a0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106fbf:	e8 3c c9 ff ff       	call   80103900 <mycpu>
80106fc4:	89 c3                	mov    %eax,%ebx
80106fc6:	e8 35 c9 ff ff       	call   80103900 <mycpu>
...
80106fd8:	e8 23 c9 ff ff       	call   80103900 <mycpu>
...
801070cf:	e8 dc da ff ff       	call   80104bb0 <memset>
...
80107102:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107103:	e9 48 db ff ff       	jmp    80104c50 <memmove>
    panic("inituvm: more than a page");
80107108:	83 ec 0c             	sub    $0xc,%esp
8010710b:	68 e5 81 10 80       	push   $0x801081e5
...
80107170:	68 ff 81 10 80       	push   $0x801081ff
...
801071f8:	68 a0 82 10 80       	push   $0x801082a0
...
8010725b:	e8 50 d9 ff ff       	call   80104bb0 <memset>
...
80107299:	68 1d 82 10 80       	push   $0x8010821d
...
801072fb:	68 35 82 10 80       	push   $0x80108235
...
801073dc:	68 51 82 10 80       	push   $0x80108251
...
80107410:	e8 9b d7 ff ff       	call   80104bb0 <memset>
...
8010747b:	a3 c4 56 11 80       	mov    %eax,0x801156c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801074ac:	68 62 82 10 80       	push   $0x80108262
...
80107522:	68 6c 82 10 80       	push   $0x8010826c
...
80107580:	e8 cb d6 ff ff       	call   80104c50 <memmove>
...
801075f7:	68 86 82 10 80       	push   $0x80108286
...
801076b0:	e8 9b d5 ff ff       	call   80104c50 <memmove>
    len -= n;
    buf += n;

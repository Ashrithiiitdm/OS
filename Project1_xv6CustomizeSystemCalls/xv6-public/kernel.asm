...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 cd 81 10 80 	movl   $0x801081cd,(%esp)
...
8010041a:	e8 c1 62 00 00       	call   801066e0 <uartputc>
...
80100505:	e8 d6 61 00 00       	call   801066e0 <uartputc>
8010050a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100511:	e8 ca 61 00 00       	call   801066e0 <uartputc>
80100516:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010051d:	e8 be 61 00 00       	call   801066e0 <uartputc>
...
80100b32:	75 d2                	jne    80100b06 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100b34:	e8 37 6d 00 00       	call   80107870 <setupkvm>
...
80100ba3:	e8 e8 6a 00 00       	call   80107690 <allocuvm>
...
80100bd9:	e8 c2 69 00 00       	call   801075a0 <loaduvm>
...
80100c1b:	e8 d0 6b 00 00       	call   801077f0 <freevm>
  if(ip){
...
80100c62:	e8 29 6a 00 00       	call   80107690 <allocuvm>
...
80100c81:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c83:	e8 88 6c 00 00       	call   80107910 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cf8:	e8 e3 6d 00 00       	call   80107ae0 <copyout>
...
80100d11:	e8 da 6a 00 00       	call   801077f0 <freevm>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 78 6d 00 00       	call   80107ae0 <copyout>
...
80100dcd:	e8 3e 66 00 00       	call   80107410 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 16 6a 00 00       	call   801077f0 <freevm>
  return 0;
...
80102088:	68 b2 83 10 80       	push   $0x801083b2
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 b5 43 00 00       	call   80107400 <switchkvm>
  seginit();
8010304b:	e8 20 43 00 00       	call   80107370 <seginit>
  lapicinit();
...
80103081:	e8 6a 48 00 00       	call   801078f0 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 db 42 00 00       	call   80107370 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 57 35 00 00       	call   80106600 <uartinit>
  pinit();         // process table
...
80103814:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
    release(&ptable.lock);
8010381a:	e8 31 15 00 00       	call   80104d50 <release>
...
8010383c:	89 53 18             	mov    %edx,0x18(%ebx)
    *(uint*)sp = (uint)trapret;
8010383f:	c7 40 14 5f 62 10 80 	movl   $0x8010625f,0x14(%eax)
    p->context = (struct context*)sp;
...
8010384e:	e8 1d 16 00 00       	call   80104e70 <memset>
...
801038ab:	e8 a0 14 00 00       	call   80104d50 <release>
...
801038f6:	68 00 81 10 80       	push   $0x80108100
801038fb:	68 a0 34 11 80       	push   $0x801134a0
80103900:	e8 db 12 00 00       	call   80104be0 <initlock>
}
...
80103994:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103997:	e8 c4 12 00 00       	call   80104c60 <pushcli>
  c = mycpu();
8010399c:	e8 6f ff ff ff       	call   80103910 <mycpu>
  p = c->proc;
801039a1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039a7:	e8 04 13 00 00       	call   80104cb0 <popcli>
}
...
801039d3:	e8 98 3e 00 00       	call   80107870 <setupkvm>
...
80103a06:	e8 65 14 00 00       	call   80104e70 <memset>
...
80103a5f:	68 30 81 10 80       	push   $0x80108130
80103a64:	50                   	push   %eax
80103a65:	e8 c6 15 00 00       	call   80105030 <safestrcpy>
  p->cwd = namei("/");
80103a6a:	c7 04 24 39 81 10 80 	movl   $0x80108139,(%esp)
...
80103aa3:	68 17 81 10 80       	push   $0x80108117
...
80103ab5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103ab8:	e8 a3 11 00 00       	call   80104c60 <pushcli>
  c = mycpu();
80103abd:	e8 4e fe ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103ac2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ac8:	e8 e3 11 00 00       	call   80104cb0 <popcli>
  sz = curproc->sz;
...
80103adb:	e8 30 39 00 00       	call   80107410 <switchuvm>
  return 0;
...
80103b36:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b39:	e8 22 11 00 00       	call   80104c60 <pushcli>
  c = mycpu();
80103b3e:	e8 cd fd ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103b43:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b49:	e8 62 11 00 00       	call   80104cb0 <popcli>
  if((np = allocproc()) == 0){
...
80103b68:	e8 f3 3d 00 00       	call   80107960 <copyuvm>
...
80103c7b:	e8 30 11 00 00       	call   80104db0 <acquire>
...
80103cd6:	e8 35 37 00 00       	call   80107410 <switchuvm>
...
80103ce8:	e8 9e 13 00 00       	call   8010508b <swtch>
      switchkvm();
80103ced:	e8 0e 37 00 00       	call   80107400 <switchkvm>
      c->proc = 0;
...
80103d02:	68 a0 34 11 80       	push   $0x801134a0
80103d07:	e8 44 10 00 00       	call   80104d50 <release>
    sti();
...
80103d24:	53                   	push   %ebx
  pushcli();
80103d25:	e8 36 0f 00 00       	call   80104c60 <pushcli>
  c = mycpu();
80103d2a:	e8 e1 fb ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103d2f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d35:	e8 76 0f 00 00       	call   80104cb0 <popcli>
  if(!holding(&ptable.lock))
80103d3a:	83 ec 0c             	sub    $0xc,%esp
80103d3d:	68 a0 34 11 80       	push   $0x801134a0
80103d42:	e8 c9 0f 00 00       	call   80104d10 <holding>
...
80103d83:	e8 03 13 00 00       	call   8010508b <swtch>
  mycpu()->intena = intena;
...
80103de9:	e8 a2 fb ff ff       	call   80103990 <myproc>
  if(curproc == initproc)
80103dee:	39 05 d4 56 11 80    	cmp    %eax,0x801156d4
...
80103e3c:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103e43:	c7 04 24 a0 34 11 80 	movl   $0x801134a0,(%esp)
80103e4a:	e8 61 0f 00 00       	call   80104db0 <acquire>
...
80103e83:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
80103e88:	75 e2                	jne    80103e6c <exit+0x8c>
      p->parent = initproc;
80103e8a:	8b 0d d4 56 11 80    	mov    0x801156d4,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e90:	ba d4 34 11 80       	mov    $0x801134d4,%edx
...
80103ea6:	81 fa d4 56 11 80    	cmp    $0x801156d4,%edx
...
80103ef7:	68 88 81 10 80       	push   $0x80108188
80103efc:	e8 7f c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103f01:	83 ec 0c             	sub    $0xc,%esp
80103f04:	68 7b 81 10 80       	push   $0x8010817b
...
80103f67:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f6c:	81 fb d4 56 11 80    	cmp    $0x801156d4,%ebx
...
80103f81:	0f 85 8f 00 00 00    	jne    80104016 <wait+0x106>
  pushcli();
80103f87:	e8 d4 0c 00 00       	call   80104c60 <pushcli>
  c = mycpu();
80103f8c:	e8 7f f9 ff ff       	call   80103910 <mycpu>
  p = c->proc;
80103f91:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f97:	e8 14 0d 00 00       	call   80104cb0 <popcli>
  if(p == 0)
...
80103fd9:	e8 12 38 00 00       	call   801077f0 <freevm>
        p->pid = 0;
...
80103ff7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103ffe:	c7 04 24 a0 34 11 80 	movl   $0x801134a0,(%esp)
80104005:	e8 46 0d 00 00       	call   80104d50 <release>
        return pid;
...
80104019:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010401e:	68 a0 34 11 80       	push   $0x801134a0
80104023:	e8 28 0d 00 00       	call   80104d50 <release>
      return -1;
80104028:	83 c4 10             	add    $0x10,%esp
8010402b:	eb e0                	jmp    8010400d <wait+0xfd>
    panic("sleep");
8010402d:	83 ec 0c             	sub    $0xc,%esp
80104030:	68 94 81 10 80       	push   $0x80108194
...
80104047:	68 a0 34 11 80       	push   $0x801134a0
8010404c:	e8 5f 0d 00 00       	call   80104db0 <acquire>
  pushcli();
80104051:	e8 0a 0c 00 00       	call   80104c60 <pushcli>
  c = mycpu();
80104056:	e8 b5 f8 ff ff       	call   80103910 <mycpu>
  p = c->proc;
8010405b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104061:	e8 4a 0c 00 00       	call   80104cb0 <popcli>
  myproc()->state = RUNNABLE;
80104066:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
8010406d:	e8 ae fc ff ff       	call   80103d20 <sched>
  release(&ptable.lock);
80104072:	c7 04 24 a0 34 11 80 	movl   $0x801134a0,(%esp)
80104079:	e8 d2 0c 00 00       	call   80104d50 <release>
}
...
8010409c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010409f:	e8 bc 0b 00 00       	call   80104c60 <pushcli>
  c = mycpu();
801040a4:	e8 67 f8 ff ff       	call   80103910 <mycpu>
  p = c->proc;
801040a9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040af:	e8 fc 0b 00 00       	call   80104cb0 <popcli>
  if(p == 0)
...
801040c0:	81 fe a0 34 11 80    	cmp    $0x801134a0,%esi
801040c6:	74 50                	je     80104118 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
801040c8:	83 ec 0c             	sub    $0xc,%esp
801040cb:	68 a0 34 11 80       	push   $0x801134a0
801040d0:	e8 db 0c 00 00       	call   80104db0 <acquire>
    release(lk);
801040d5:	89 34 24             	mov    %esi,(%esp)
801040d8:	e8 73 0c 00 00       	call   80104d50 <release>
  p->chan = chan;
...
801040ec:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801040f3:	c7 04 24 a0 34 11 80 	movl   $0x801134a0,(%esp)
801040fa:	e8 51 0c 00 00       	call   80104d50 <release>
    acquire(lk);
...
8010410b:	5d                   	pop    %ebp
    acquire(lk);
8010410c:	e9 9f 0c 00 00       	jmp    80104db0 <acquire>
...
80104139:	68 9a 81 10 80       	push   $0x8010819a
8010413e:	e8 3d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104143:	83 ec 0c             	sub    $0xc,%esp
80104146:	68 94 81 10 80       	push   $0x80108194
...
80104157:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010415a:	68 a0 34 11 80       	push   $0x801134a0
8010415f:	e8 4c 0c 00 00       	call   80104db0 <acquire>
80104164:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104167:	b8 d4 34 11 80       	mov    $0x801134d4,%eax
8010416c:	eb 0e                	jmp    8010417c <wakeup+0x2c>
8010416e:	66 90                	xchg   %ax,%ax
80104170:	05 88 00 00 00       	add    $0x88,%eax
80104175:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
...
80104193:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
80104198:	75 e2                	jne    8010417c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010419a:	c7 45 08 a0 34 11 80 	movl   $0x801134a0,0x8(%ebp)
}
801041a1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801041a4:	c9                   	leave  
  release(&ptable.lock);
801041a5:	e9 a6 0b 00 00       	jmp    80104d50 <release>
...
801041b7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
801041ba:	68 a0 34 11 80       	push   $0x801134a0
801041bf:	e8 ec 0b 00 00       	call   80104db0 <acquire>
801041c4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041c7:	b8 d4 34 11 80       	mov    $0x801134d4,%eax
801041cc:	eb 0e                	jmp    801041dc <kill+0x2c>
801041ce:	66 90                	xchg   %ax,%ax
801041d0:	05 88 00 00 00       	add    $0x88,%eax
801041d5:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
...
801041f8:	68 a0 34 11 80       	push   $0x801134a0
801041fd:	e8 4e 0b 00 00       	call   80104d50 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104213:	68 a0 34 11 80       	push   $0x801134a0
80104218:	e8 33 0b 00 00       	call   80104d50 <release>
}
...
80104239:	bb 40 35 11 80       	mov    $0x80113540,%ebx
...
8010426f:	74 e7                	je     80104258 <procdump+0x28>
      state = "???";
80104271:	ba ab 81 10 80       	mov    $0x801081ab,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104276:	83 f8 05             	cmp    $0x5,%eax
80104279:	77 11                	ja     8010428c <procdump+0x5c>
8010427b:	8b 14 85 78 82 10 80 	mov    -0x7fef7d88(,%eax,4),%edx
      state = "???";
80104282:	b8 ab 81 10 80       	mov    $0x801081ab,%eax
...
80104291:	68 af 81 10 80       	push   $0x801081af
...
801042b8:	e8 43 09 00 00       	call   80104c00 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042cd:	68 01 7c 10 80       	push   $0x80107c01
...
801042f9:	bb 40 35 11 80       	mov    $0x80113540,%ebx
801042fe:	be 40 57 11 80       	mov    $0x80115740,%esi
80104303:	68 a0 34 11 80       	push   $0x801134a0
80104308:	e8 a3 0a 00 00       	call   80104db0 <acquire>
	cprintf("name \t pid \t state \t \n");
8010430d:	c7 04 24 b8 81 10 80 	movl   $0x801081b8,(%esp)
...
80104343:	81 c3 88 00 00 00    	add    $0x88,%ebx
	      cprintf("%s \t %d \t SLEEPING \t \n ", p->name, p->pid);
80104349:	68 cf 81 10 80       	push   $0x801081cf
...
8010435d:	68 a0 34 11 80       	push   $0x801134a0
80104362:	e8 e9 09 00 00       	call   80104d50 <release>
...
8010437f:	68 e7 81 10 80       	push   $0x801081e7
...
80104397:	68 fe 81 10 80       	push   $0x801081fe
...
801043bc:	e8 6f 0d 00 00       	call   80105130 <argint>
...
801043da:	68 a0 34 11 80       	push   $0x801134a0
801043df:	e8 cc 09 00 00       	call   80104db0 <acquire>
...
801043e7:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043ea:	b8 d4 34 11 80       	mov    $0x801134d4,%eax
...
801043fd:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
...
8010441f:	68 a0 34 11 80       	push   $0x801134a0
80104424:	e8 27 09 00 00       	call   80104d50 <release>
        return 2;
...
8010443b:	68 a0 34 11 80       	push   $0x801134a0
80104440:	e8 0b 09 00 00       	call   80104d50 <release>
        return 0;
...
80104453:	68 a0 34 11 80       	push   $0x801134a0
80104458:	e8 f3 08 00 00       	call   80104d50 <release>
  return -1;
...
8010446a:	68 a0 34 11 80       	push   $0x801134a0
8010446f:	e8 dc 08 00 00       	call   80104d50 <release>
        return 1;
...
int getppid(void){
80104497:	83 ec 1c             	sub    $0x1c,%esp
  if(argint(0, &pid) < 0){
8010449a:	50                   	push   %eax
8010449b:	6a 00                	push   $0x0
8010449d:	e8 8e 0c 00 00       	call   80105130 <argint>
801044a2:	83 c4 10             	add    $0x10,%esp
801044a5:	85 c0                	test   %eax,%eax
801044a7:	78 75                	js     8010451e <getppid+0x8e>
    return -1;
  }
...
801044a9:	83 ec 0c             	sub    $0xc,%esp
  ...
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801044ac:	bb d4 34 11 80       	mov    $0x801134d4,%ebx
  acquire(&ptable.lock);
801044b1:	68 a0 34 11 80       	push   $0x801134a0
801044b6:	e8 f5 08 00 00       	call   80104db0 <acquire>
      if (p->pid == pid) {
801044bb:	8b 45 f4             	mov    -0xc(%ebp),%eax
801044be:	83 c4 10             	add    $0x10,%esp
801044c1:	eb 13                	jmp    801044d6 <getppid+0x46>
801044c3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801044c7:	90                   	nop
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801044c8:	81 c3 88 00 00 00    	add    $0x88,%ebx
801044ce:	81 fb d4 56 11 80    	cmp    $0x801156d4,%ebx
801044d4:	74 2a                	je     80104500 <getppid+0x70>
      if (p->pid == pid) {
801044d6:	39 43 10             	cmp    %eax,0x10(%ebx)
801044d9:	75 ed                	jne    801044c8 <getppid+0x38>
          break;
      }
  }

  if(p >= &ptable.proc[NPROC]){
801044db:	81 fb d4 56 11 80    	cmp    $0x801156d4,%ebx
801044e1:	73 1d                	jae    80104500 <getppid+0x70>
    release(&ptable.lock);
    cprintf("Invalid pid..\n");
  }
...
801044e6:	68 a0 34 11 80       	push   $0x801134a0
801044eb:	e8 60 08 00 00       	call   80104d50 <release>
  return p->parent->pid;
801044f0:	8b 43 14             	mov    0x14(%ebx),%eax
801044f3:	83 c4 10             	add    $0x10,%esp
801044f6:	8b 40 10             	mov    0x10(%eax),%eax

}
801044f9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801044fc:	c9                   	leave  
801044fd:	c3                   	ret    
801044fe:	66 90                	xchg   %ax,%ax
    release(&ptable.lock);
80104500:	83 ec 0c             	sub    $0xc,%esp
80104503:	68 a0 34 11 80       	push   $0x801134a0
80104508:	e8 43 08 00 00       	call   80104d50 <release>
    cprintf("Invalid pid..\n");
8010450d:	c7 04 24 16 82 10 80 	movl   $0x80108216,(%esp)
80104514:	e8 87 c1 ff ff       	call   801006a0 <cprintf>
80104519:	83 c4 10             	add    $0x10,%esp
8010451c:	eb c5                	jmp    801044e3 <getppid+0x53>
    return -1;
8010451e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104523:	eb d4                	jmp    801044f9 <getppid+0x69>
...
80104535:	83 ec 10             	sub    $0x10,%esp
  pushcli();
80104538:	e8 23 07 00 00       	call   80104c60 <pushcli>
  c = mycpu();
8010453d:	e8 ce f3 ff ff       	call   80103910 <mycpu>
  p = c->proc;
80104542:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104548:	e8 63 07 00 00       	call   80104cb0 <popcli>
    int pid;
    struct proc *p;
    struct proc *currproc = myproc();

    // Fetch the target PID from arguments
    if (argint(0, &pid) < 0) {
8010454d:	83 ec 08             	sub    $0x8,%esp
80104550:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104553:	50                   	push   %eax
80104554:	6a 00                	push   $0x0
80104556:	e8 d5 0b 00 00       	call   80105130 <argint>
8010455b:	83 c4 10             	add    $0x10,%esp
8010455e:	85 c0                	test   %eax,%eax
80104560:	0f 88 e1 00 00 00    	js     80104647 <wait_pid+0x117>
        return -1;
    }

    acquire(&ptable.lock);
80104566:	83 ec 0c             	sub    $0xc,%esp
80104569:	68 a0 34 11 80       	push   $0x801134a0
8010456e:	e8 3d 08 00 00       	call   80104db0 <acquire>

    // Find the target process with the given PID
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
        if (p->pid == pid && p->state != UNUSED) {
80104573:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104576:	83 c4 10             	add    $0x10,%esp
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104579:	b8 d4 34 11 80       	mov    $0x801134d4,%eax
8010457e:	eb 10                	jmp    80104590 <wait_pid+0x60>
80104580:	05 88 00 00 00       	add    $0x88,%eax
80104585:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
8010458a:	0f 84 a0 00 00 00    	je     80104630 <wait_pid+0x100>
        if (p->pid == pid && p->state != UNUSED) {
80104590:	39 50 10             	cmp    %edx,0x10(%eax)
80104593:	75 eb                	jne    80104580 <wait_pid+0x50>
80104595:	8b 48 0c             	mov    0xc(%eax),%ecx
80104598:	85 c9                	test   %ecx,%ecx
8010459a:	74 e4                	je     80104580 <wait_pid+0x50>
            break;
        }
    }

    // Validate the found process
    if (p >= &ptable.proc[NPROC] || p == currproc || p->state == UNUSED) {
8010459c:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
801045a1:	0f 83 89 00 00 00    	jae    80104630 <wait_pid+0x100>
801045a7:	39 c6                	cmp    %eax,%esi
801045a9:	0f 84 81 00 00 00    	je     80104630 <wait_pid+0x100>
        release(&ptable.lock);
        return -1;
    }

    // Set the current process to wait for the target process
    currproc->waiting_for = pid;
801045af:	89 56 7c             	mov    %edx,0x7c(%esi)
    currproc->wait_state = 1;
801045b2:	c7 86 80 00 00 00 01 	movl   $0x1,0x80(%esi)
801045b9:	00 00 00 

    // Sleep until the target process is unwaited or terminated
    while (currproc->wait_state == 1) {
801045bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  pushcli();
801045c0:	e8 9b 06 00 00       	call   80104c60 <pushcli>
  c = mycpu();
801045c5:	e8 46 f3 ff ff       	call   80103910 <mycpu>
  p = c->proc;
801045ca:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801045d0:	e8 db 06 00 00       	call   80104cb0 <popcli>
  if(p == 0)
801045d5:	85 db                	test   %ebx,%ebx
801045d7:	74 75                	je     8010464e <wait_pid+0x11e>
  p->chan = chan;
801045d9:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
801045dc:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801045e3:	e8 38 f7 ff ff       	call   80103d20 <sched>
  p->chan = 0;
801045e8:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    while (currproc->wait_state == 1) {
801045ef:	8b 86 80 00 00 00    	mov    0x80(%esi),%eax
801045f5:	83 f8 01             	cmp    $0x1,%eax
801045f8:	74 c6                	je     801045c0 <wait_pid+0x90>
        sleep(currproc, &ptable.lock);
    }

    // Check if the wait was interrupted (unwaited)
    if (currproc->wait_state == 2) {
        currproc->waiting_for = -1;
801045fa:	c7 46 7c ff ff ff ff 	movl   $0xffffffff,0x7c(%esi)
        currproc->wait_state = 0;
80104601:	c7 86 80 00 00 00 00 	movl   $0x0,0x80(%esi)
80104608:	00 00 00 
    if (currproc->wait_state == 2) {
8010460b:	83 f8 02             	cmp    $0x2,%eax
8010460e:	74 20                	je     80104630 <wait_pid+0x100>
    }

    // Reset wait state after successful wait
    currproc->waiting_for = -1;
    currproc->wait_state = 0;
    release(&ptable.lock);
80104610:	83 ec 0c             	sub    $0xc,%esp
80104613:	68 a0 34 11 80       	push   $0x801134a0
80104618:	e8 33 07 00 00       	call   80104d50 <release>
    return 0;
...
80104633:	68 a0 34 11 80       	push   $0x801134a0
80104638:	e8 13 07 00 00       	call   80104d50 <release>
        return -1;
8010463d:	83 c4 10             	add    $0x10,%esp
80104640:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104645:	eb db                	jmp    80104622 <wait_pid+0xf2>
        return -1;
80104647:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010464c:	eb d4                	jmp    80104622 <wait_pid+0xf2>
    panic("sleep");
8010464e:	83 ec 0c             	sub    $0xc,%esp
80104651:	68 94 81 10 80       	push   $0x80108194
80104656:	e8 25 bd ff ff       	call   80100380 <panic>
...
80104664:	53                   	push   %ebx
    ...
    // Fetch the target PID from arguments
    if (argint(0, &pid) < 0) {
80104665:	8d 45 f4             	lea    -0xc(%ebp),%eax
int unwait_pid(void) {
80104668:	83 ec 18             	sub    $0x18,%esp
    if (argint(0, &pid) < 0) {
8010466b:	50                   	push   %eax
8010466c:	6a 00                	push   $0x0
8010466e:	e8 bd 0a 00 00       	call   80105130 <argint>
80104673:	83 c4 10             	add    $0x10,%esp
80104676:	85 c0                	test   %eax,%eax
80104678:	0f 88 d8 00 00 00    	js     80104756 <unwait_pid+0xf6>
        return -1;
    }
...
8010467e:	83 ec 0c             	sub    $0xc,%esp
    int woke = 0;
80104681:	31 f6                	xor    %esi,%esi

    // Iterate through all processes to find those waiting on the specified PID
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104683:	bb d4 34 11 80       	mov    $0x801134d4,%ebx
    acquire(&ptable.lock);
80104688:	68 a0 34 11 80       	push   $0x801134a0
8010468d:	e8 1e 07 00 00       	call   80104db0 <acquire>
80104692:	83 c4 10             	add    $0x10,%esp
80104695:	eb 1b                	jmp    801046b2 <unwait_pid+0x52>
80104697:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010469e:	66 90                	xchg   %ax,%ax
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801046a0:	81 c3 88 00 00 00    	add    $0x88,%ebx
801046a6:	81 fb d4 56 11 80    	cmp    $0x801156d4,%ebx
801046ac:	0f 84 8b 00 00 00    	je     8010473d <unwait_pid+0xdd>
        if (p->state == SLEEPING && p->waiting_for == pid) {
801046b2:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
801046b6:	75 e8                	jne    801046a0 <unwait_pid+0x40>
801046b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801046bb:	39 43 7c             	cmp    %eax,0x7c(%ebx)
801046be:	75 e0                	jne    801046a0 <unwait_pid+0x40>
  acquire(&ptable.lock);
801046c0:	83 ec 0c             	sub    $0xc,%esp
            // Reset the waiting state
            p->wait_state = 2;  // Mark as unwaited
            p->waiting_for = -1;
801046c3:	c7 43 7c ff ff ff ff 	movl   $0xffffffff,0x7c(%ebx)
  acquire(&ptable.lock);
801046ca:	68 a0 34 11 80       	push   $0x801134a0
            p->wait_state = 2;  // Mark as unwaited
801046cf:	c7 83 80 00 00 00 02 	movl   $0x2,0x80(%ebx)
801046d6:	00 00 00 
  acquire(&ptable.lock);
801046d9:	e8 d2 06 00 00       	call   80104db0 <acquire>
801046de:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801046e1:	b8 d4 34 11 80       	mov    $0x801134d4,%eax
801046e6:	eb 14                	jmp    801046fc <unwait_pid+0x9c>
801046e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801046ef:	90                   	nop
801046f0:	05 88 00 00 00       	add    $0x88,%eax
801046f5:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
801046fa:	74 24                	je     80104720 <unwait_pid+0xc0>
    if(p->state == SLEEPING && p->chan == chan)
801046fc:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80104700:	75 ee                	jne    801046f0 <unwait_pid+0x90>
80104702:	39 58 20             	cmp    %ebx,0x20(%eax)
80104705:	75 e9                	jne    801046f0 <unwait_pid+0x90>
      p->state = RUNNABLE;
80104707:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010470e:	05 88 00 00 00       	add    $0x88,%eax
80104713:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
80104718:	75 e2                	jne    801046fc <unwait_pid+0x9c>
...
80104720:	83 ec 0c             	sub    $0xc,%esp
            ...
            wakeup(p);
            woke++;
80104723:	83 c6 01             	add    $0x1,%esi
  release(&ptable.lock);
80104726:	68 a0 34 11 80       	push   $0x801134a0
8010472b:	e8 20 06 00 00       	call   80104d50 <release>

            // If a specific PID was provided, stop after handling the first process
            if (pid != -1) {
80104730:	83 c4 10             	add    $0x10,%esp
80104733:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
80104737:	0f 84 63 ff ff ff    	je     801046a0 <unwait_pid+0x40>
                break;
            }
        }
    }
...
80104740:	68 a0 34 11 80       	push   $0x801134a0
80104745:	e8 06 06 00 00       	call   80104d50 <release>
    return woke;
...
80104755:	c3                   	ret    
        return -1;
80104756:	be ff ff ff ff       	mov    $0xffffffff,%esi
8010475b:	eb f0                	jmp    8010474d <unwait_pid+0xed>
...
8010477c:	68 a0 34 11 80       	push   $0x801134a0
80104781:	e8 2a 06 00 00       	call   80104db0 <acquire>

  //Going throught the process table for finding the process with the given pid.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == pid){
80104786:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104789:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010478c:	b8 d4 34 11 80       	mov    $0x801134d4,%eax
80104791:	eb 11                	jmp    801047a4 <mem_usage+0x44>
80104793:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104797:	90                   	nop
80104798:	05 88 00 00 00       	add    $0x88,%eax
8010479d:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
801047a2:	74 24                	je     801047c8 <mem_usage+0x68>
    if(p->pid == pid){
801047a4:	39 50 10             	cmp    %edx,0x10(%eax)
801047a7:	75 ef                	jne    80104798 <mem_usage+0x38>
...
801047a9:	83 ec 0c             	sub    $0xc,%esp
      size = p->sz;
801047ac:	8b 18                	mov    (%eax),%ebx
  release(&ptable.lock);
801047ae:	68 a0 34 11 80       	push   $0x801134a0
801047b3:	e8 98 05 00 00       	call   80104d50 <release>
...
801047cb:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  release(&ptable.lock);
801047d0:	68 a0 34 11 80       	push   $0x801134a0
801047d5:	e8 76 05 00 00       	call   80104d50 <release>
}
...
801047e3:	c3                   	ret    
    return -1;
801047e4:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801047e9:	eb d0                	jmp    801047bb <mem_usage+0x5b>
801047eb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801047ef:	90                   	nop

801047f0 <get_priority>:
...
801047f3:	53                   	push   %ebx
  ...
  int priority = -1;
  if(argint(0, &pid) < 0){
801047f4:	8d 45 f4             	lea    -0xc(%ebp),%eax
int get_priority(void){
801047f7:	83 ec 1c             	sub    $0x1c,%esp
  if(argint(0, &pid) < 0){
801047fa:	50                   	push   %eax
801047fb:	6a 00                	push   $0x0
801047fd:	e8 2e 09 00 00       	call   80105130 <argint>
80104802:	83 c4 10             	add    $0x10,%esp
80104805:	85 c0                	test   %eax,%eax
80104807:	78 52                	js     8010485b <get_priority+0x6b>
    return -1;
  }
...
8010480c:	68 a0 34 11 80       	push   $0x801134a0
80104811:	e8 9a 05 00 00       	call   80104db0 <acquire>
...
80104819:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
8010481c:	b8 d4 34 11 80       	mov    $0x801134d4,%eax
80104821:	eb 11                	jmp    80104834 <get_priority+0x44>
80104823:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104827:	90                   	nop
80104828:	05 88 00 00 00       	add    $0x88,%eax
8010482d:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
80104832:	74 34                	je     80104868 <get_priority+0x78>
    if(p->pid == pid){
80104834:	39 50 10             	cmp    %edx,0x10(%eax)
80104837:	75 ef                	jne    80104828 <get_priority+0x38>
      priority =  p->priority;
      break;
    }
  }
...
80104839:	83 ec 0c             	sub    $0xc,%esp
      priority =  p->priority;
8010483c:	8b 98 84 00 00 00    	mov    0x84(%eax),%ebx
  release(&ptable.lock);
80104842:	68 a0 34 11 80       	push   $0x801134a0
80104847:	e8 04 05 00 00       	call   80104d50 <release>

  if(priority==-1){
8010484c:	83 c4 10             	add    $0x10,%esp
8010484f:	83 fb ff             	cmp    $0xffffffff,%ebx
80104852:	74 24                	je     80104878 <get_priority+0x88>
    return -2; // pid not found
  }

  return priority;  
}
80104854:	89 d8                	mov    %ebx,%eax
80104856:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104859:	c9                   	leave  
8010485a:	c3                   	ret    
    return -1;
8010485b:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104860:	eb f2                	jmp    80104854 <get_priority+0x64>
80104862:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  release(&ptable.lock);
80104868:	83 ec 0c             	sub    $0xc,%esp
8010486b:	68 a0 34 11 80       	push   $0x801134a0
80104870:	e8 db 04 00 00       	call   80104d50 <release>
80104875:	83 c4 10             	add    $0x10,%esp
    return -2; // pid not found
80104878:	bb fe ff ff ff       	mov    $0xfffffffe,%ebx
8010487d:	eb d5                	jmp    80104854 <get_priority+0x64>
8010487f:	90                   	nop

80104880 <set_priority>:
...
801048ae:	83 ec 0c             	sub    $0xc,%esp
    int setPrior = -1; 
801048b1:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    acquire(&ptable.lock);
801048b6:	68 a0 34 11 80       	push   $0x801134a0
801048bb:	e8 f0 04 00 00       	call   80104db0 <acquire>
...
801048c0:	8b 55 f0             	mov    -0x10(%ebp),%edx
        p->priority = priority;
801048c3:	8b 4d f4             	mov    -0xc(%ebp),%ecx
801048c6:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
801048c9:	b8 d4 34 11 80       	mov    $0x801134d4,%eax
801048ce:	66 90                	xchg   %ax,%ax
      if(p->pid==pid){
801048d0:	39 50 10             	cmp    %edx,0x10(%eax)
801048d3:	75 08                	jne    801048dd <set_priority+0x5d>
        p->priority = priority;
801048d5:	89 88 84 00 00 00    	mov    %ecx,0x84(%eax)
        setPrior = 0;
801048db:	31 db                	xor    %ebx,%ebx
    for(p = ptable.proc; p<&ptable.proc[NPROC]; p++){
801048dd:	05 88 00 00 00       	add    $0x88,%eax
801048e2:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
801048e7:	75 e7                	jne    801048d0 <set_priority+0x50>
      }
    }

    release(&ptable.lock);
801048e9:	83 ec 0c             	sub    $0xc,%esp
801048ec:	68 a0 34 11 80       	push   $0x801134a0
801048f1:	e8 5a 04 00 00       	call   80104d50 <release>

    return setPrior; //-1 for failure and 0 for success
801048f6:	83 c4 10             	add    $0x10,%esp
}
801048f9:	89 d8                	mov    %ebx,%eax
801048fb:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801048fe:	c9                   	leave  
801048ff:	c3                   	ret    
      return -1;
80104900:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104905:	eb f2                	jmp    801048f9 <set_priority+0x79>
...
80104919:	6b 5d 08 3c          	imul   $0x3c,0x8(%ebp),%ebx
8010491d:	8d bb 28 2d 11 80    	lea    -0x7feed2d8(%ebx),%edi
80104923:	57                   	push   %edi
80104924:	e8 87 04 00 00       	call   80104db0 <acquire>

  if (sema[sem].active == 0)
80104929:	8b b3 24 2d 11 80    	mov    -0x7feed2dc(%ebx),%esi
8010492f:	83 c4 10             	add    $0x10,%esp
80104932:	85 f6                	test   %esi,%esi
80104934:	75 2a                	jne    80104960 <sem_init+0x50>
  {
     sema[sem].active = 1;
80104936:	c7 83 24 2d 11 80 01 	movl   $0x1,-0x7feed2dc(%ebx)
8010493d:	00 00 00 
  else
  {
     return -1;
...
80104943:	8b 45 0c             	mov    0xc(%ebp),%eax
  release(&sema[sem].lock);
80104946:	57                   	push   %edi
     sema[sem].value = value;
80104947:	89 83 20 2d 11 80    	mov    %eax,-0x7feed2e0(%ebx)
  release(&sema[sem].lock);
8010494d:	e8 fe 03 00 00       	call   80104d50 <release>
...
8010495f:	90                   	nop
     return -1;
80104960:	be ff ff ff ff       	mov    $0xffffffff,%esi
80104965:	eb ee                	jmp    80104955 <sem_init+0x45>
80104967:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010496e:	66 90                	xchg   %ax,%ax

80104970 <sem_destroy>:
...
80104973:	56                   	push   %esi
  acquire(&sema[sem].lock);
80104974:	6b 75 08 3c          	imul   $0x3c,0x8(%ebp),%esi
{
80104978:	53                   	push   %ebx
  acquire(&sema[sem].lock);
80104979:	8d 9e 28 2d 11 80    	lea    -0x7feed2d8(%esi),%ebx
8010497f:	83 ec 0c             	sub    $0xc,%esp
80104982:	53                   	push   %ebx
80104983:	e8 28 04 00 00       	call   80104db0 <acquire>
  sema[sem].active = 0;
  release(&sema[sem].lock);
80104988:	89 1c 24             	mov    %ebx,(%esp)
  sema[sem].active = 0;
8010498b:	c7 86 24 2d 11 80 00 	movl   $0x0,-0x7feed2dc(%esi)
80104992:	00 00 00 
  release(&sema[sem].lock);
80104995:	e8 b6 03 00 00       	call   80104d50 <release>
...
801049b9:	6b 5d 08 3c          	imul   $0x3c,0x8(%ebp),%ebx
  acquire(&sema[sem].lock);
801049bd:	8d b3 28 2d 11 80    	lea    -0x7feed2d8(%ebx),%esi
801049c3:	56                   	push   %esi
801049c4:	e8 e7 03 00 00       	call   80104db0 <acquire>

  if (sema[sem].value >= count)
801049c9:	8b 93 20 2d 11 80    	mov    -0x7feed2e0(%ebx),%edx
801049cf:	83 c4 10             	add    $0x10,%esp
  {
     sema[sem].value = sema[sem].value - count;
801049d2:	89 d0                	mov    %edx,%eax
801049d4:	2b 45 0c             	sub    0xc(%ebp),%eax
  if (sema[sem].value >= count)
801049d7:	3b 55 0c             	cmp    0xc(%ebp),%edx
801049da:	7d 27                	jge    80104a03 <sem_wait+0x53>
801049dc:	8d bb 20 2d 11 80    	lea    -0x7feed2e0(%ebx),%edi
...
801049ed:	e8 9e f6 ff ff       	call   80104090 <sleep>
     while (sema[sem].value < count)
801049f2:	8b 83 20 2d 11 80    	mov    -0x7feed2e0(%ebx),%eax
801049f8:	83 c4 10             	add    $0x10,%esp
801049fb:	3b 45 0c             	cmp    0xc(%ebp),%eax
801049fe:	7c e8                	jl     801049e8 <sem_wait+0x38>
     }
     sema[sem].value = sema[sem].value - count;
80104a00:	2b 45 0c             	sub    0xc(%ebp),%eax
  }

  release(&sema[sem].lock);
80104a03:	83 ec 0c             	sub    $0xc,%esp
     sema[sem].value = sema[sem].value - count;
80104a06:	6b 55 08 3c          	imul   $0x3c,0x8(%ebp),%edx
  release(&sema[sem].lock);
80104a0a:	56                   	push   %esi
     sema[sem].value = sema[sem].value - count;
80104a0b:	89 82 20 2d 11 80    	mov    %eax,-0x7feed2e0(%edx)
  release(&sema[sem].lock);
80104a11:	e8 3a 03 00 00       	call   80104d50 <release>
...
80104a29:	6b 7d 08 3c          	imul   $0x3c,0x8(%ebp),%edi
  acquire(&sema[sem].lock);
80104a2d:	8d b7 28 2d 11 80    	lea    -0x7feed2d8(%edi),%esi

  sema[sem].value = sema[sem].value + count;
80104a33:	8d 9f 20 2d 11 80    	lea    -0x7feed2e0(%edi),%ebx
  acquire(&sema[sem].lock);
80104a39:	56                   	push   %esi
80104a3a:	e8 71 03 00 00       	call   80104db0 <acquire>
  sema[sem].value = sema[sem].value + count;
80104a3f:	8b 45 0c             	mov    0xc(%ebp),%eax
  acquire(&ptable.lock);
80104a42:	c7 04 24 a0 34 11 80 	movl   $0x801134a0,(%esp)
  sema[sem].value = sema[sem].value + count;
80104a49:	01 87 20 2d 11 80    	add    %eax,-0x7feed2e0(%edi)
  acquire(&ptable.lock);
80104a4f:	e8 5c 03 00 00       	call   80104db0 <acquire>
80104a54:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104a57:	b8 d4 34 11 80       	mov    $0x801134d4,%eax
80104a5c:	eb 0e                	jmp    80104a6c <sem_signal+0x4c>
80104a5e:	66 90                	xchg   %ax,%ax
80104a60:	05 88 00 00 00       	add    $0x88,%eax
80104a65:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
80104a6a:	74 1e                	je     80104a8a <sem_signal+0x6a>
    if(p->state == SLEEPING && p->chan == chan)
80104a6c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80104a70:	75 ee                	jne    80104a60 <sem_signal+0x40>
80104a72:	3b 58 20             	cmp    0x20(%eax),%ebx
80104a75:	75 e9                	jne    80104a60 <sem_signal+0x40>
      p->state = RUNNABLE;
80104a77:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104a7e:	05 88 00 00 00       	add    $0x88,%eax
80104a83:	3d d4 56 11 80       	cmp    $0x801156d4,%eax
80104a88:	75 e2                	jne    80104a6c <sem_signal+0x4c>
  release(&ptable.lock);
80104a8a:	83 ec 0c             	sub    $0xc,%esp
80104a8d:	68 a0 34 11 80       	push   $0x801134a0
80104a92:	e8 b9 02 00 00       	call   80104d50 <release>
  wakeup(&sema[sem]); 
  release(&sema[sem].lock);
80104a97:	89 34 24             	mov    %esi,(%esp)
80104a9a:	e8 b1 02 00 00       	call   80104d50 <release>

  return 0;
80104a9f:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104aa2:	31 c0                	xor    %eax,%eax
80104aa4:	5b                   	pop    %ebx
80104aa5:	5e                   	pop    %esi
80104aa6:	5f                   	pop    %edi
80104aa7:	5d                   	pop    %ebp
...
80104aba:	68 90 82 10 80       	push   $0x80108290
...
80104b15:	e8 76 f5 ff ff       	call   80104090 <sleep>
  while (lk->locked) {
...
80104b74:	e8 d7 f5 ff ff       	call   80104150 <wakeup>
  release(&lk->lk);
...
80104bcb:	e8 c0 ed ff ff       	call   80103990 <myproc>
...
80104cdc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104ce0:	e8 2b ec ff ff       	call   80103910 <mycpu>
...
80104cf5:	68 9b 82 10 80       	push   $0x8010829b
80104cfa:	e8 81 b6 ff ff       	call   80100380 <panic>
    panic("popcli");
80104cff:	83 ec 0c             	sub    $0xc,%esp
80104d02:	68 b2 82 10 80       	push   $0x801082b2
...
80104d33:	e8 d8 eb ff ff       	call   80103910 <mycpu>
...
80104dec:	e8 1f eb ff ff       	call   80103910 <mycpu>
...
80104e4b:	e8 c0 ea ff ff       	call   80103910 <mycpu>
...
80104e60:	68 c1 82 10 80       	push   $0x801082c1
...
80105135:	e8 56 e8 ff ff       	call   80103990 <myproc>
...
80105143:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80105146:	e8 45 e8 ff ff       	call   80103990 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80105186:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80105189:	e8 02 e8 ff ff       	call   80103990 <myproc>
8010518e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80105190:	e8 fb e7 ff ff       	call   80103990 <myproc>
...
8010519e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801051a1:	e8 ea e7 ff ff       	call   80103990 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
801051f4:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801051f5:	e8 96 e7 ff ff       	call   80103990 <myproc>
...
80105203:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80105206:	e8 85 e7 ff ff       	call   80103990 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
8010521b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
8010521e:	e8 6d e7 ff ff       	call   80103990 <myproc>
  if(addr >= curproc->sz)
...
80105274:	83 ec 04             	sub    $0x4,%esp
  total_calls++;
80105277:	83 05 08 b0 10 80 01 	addl   $0x1,0x8010b008
  int num;
  struct proc *curproc = myproc();
8010527e:	e8 0d e7 ff ff       	call   80103990 <myproc>
80105283:	89 c3                	mov    %eax,%ebx
...
8010528e:	83 fa 21             	cmp    $0x21,%edx
80105291:	77 1d                	ja     801052b0 <syscall+0x40>
80105293:	8b 14 85 00 83 10 80 	mov    -0x7fef7d00(,%eax,4),%edx
8010529a:	85 d2                	test   %edx,%edx
8010529c:	74 12                	je     801052b0 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
8010529e:	ff d2                	call   *%edx
801052a0:	89 c2                	mov    %eax,%edx
801052a2:	8b 43 18             	mov    0x18(%ebx),%eax
801052a5:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
801052b8:	68 c9 82 10 80       	push   $0x801082c9
...
80105414:	68 a8 83 10 80       	push   $0x801083a8
...
8010542c:	68 a7 83 10 80       	push   $0x801083a7
...
80105441:	68 9b 83 10 80       	push   $0x8010839b
...
8010545f:	68 aa 83 10 80       	push   $0x801083aa
80105464:	e8 17 af ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80105469:	83 ec 0c             	sub    $0xc,%esp
8010546c:	68 8c 83 10 80       	push   $0x8010838c
...
80105483:	83 ec 08             	sub    $0x8,%esp
  struct proc *curproc = myproc();
80105486:	e8 05 e5 ff ff       	call   80103990 <myproc>
8010548b:	89 c2                	mov    %eax,%edx
  for(fd = 0; fd < NOFILE; fd++){
8010548d:	31 c0                	xor    %eax,%eax
8010548f:	90                   	nop
    if(curproc->ofile[fd] == 0){
80105490:	8b 4c 82 28          	mov    0x28(%edx,%eax,4),%ecx
80105494:	85 c9                	test   %ecx,%ecx
80105496:	74 18                	je     801054b0 <fdalloc+0x30>
  for(fd = 0; fd < NOFILE; fd++){
80105498:	83 c0 01             	add    $0x1,%eax
8010549b:	83 f8 10             	cmp    $0x10,%eax
8010549e:	75 f0                	jne    80105490 <fdalloc+0x10>
}
801054a0:	c9                   	leave  
  return -1;
...
801054ae:	66 90                	xchg   %ax,%ax
      curproc->ofile[fd] = f;
801054b0:	8b 4d 08             	mov    0x8(%ebp),%ecx
801054b3:	89 4c 82 28          	mov    %ecx,0x28(%edx,%eax,4)
}
801054b7:	c9                   	leave  
801054b8:	c3                   	ret    
...
801054ce:	e8 5d fc ff ff       	call   80105130 <argint>
...
801054e0:	e8 ab e4 ff ff       	call   80103990 <myproc>
...
801054ee:	74 20                	je     80105510 <sys_dup+0x50>
  struct proc *curproc = myproc();
801054f0:	e8 9b e4 ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010554e:	e8 dd fb ff ff       	call   80105130 <argint>
...
80105560:	e8 2b e4 ff ff       	call   80103990 <myproc>
...
80105579:	e8 b2 fb ff ff       	call   80105130 <argint>
...
8010558e:	e8 ed fb ff ff       	call   80105180 <argptr>
...
801055ce:	e8 5d fb ff ff       	call   80105130 <argint>
...
801055e0:	e8 ab e3 ff ff       	call   80103990 <myproc>
...
801055f9:	e8 32 fb ff ff       	call   80105130 <argint>
...
8010560e:	e8 6d fb ff ff       	call   80105180 <argptr>
...
8010564e:	e8 dd fa ff ff       	call   80105130 <argint>
...
80105671:	74 25                	je     80105698 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105673:	e8 18 e3 ff ff       	call   80103990 <myproc>
  fileclose(f);
...
801056ae:	e8 7d fa ff ff       	call   80105130 <argint>
...
801056c0:	e8 cb e2 ff ff       	call   80103990 <myproc>
...
801056d8:	e8 a3 fa ff ff       	call   80105180 <argptr>
...
8010571f:	e8 cc fa ff ff       	call   801051f0 <argstr>
...
80105738:	e8 b3 fa ff ff       	call   801051f0 <argstr>
...
8010586f:	e8 7c f9 ff ff       	call   801051f0 <argstr>
...
801058ad:	58                   	pop    %eax
801058ae:	5a                   	pop    %edx
801058af:	68 a8 83 10 80       	push   $0x801083a8
...
801058c8:	68 a7 83 10 80       	push   $0x801083a7
...
80105922:	e8 49 f5 ff ff       	call   80104e70 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80105a4f:	e8 9c f7 ff ff       	call   801051f0 <argstr>
...
80105a68:	e8 c3 f6 ff ff       	call   80105130 <argint>
...
80105ab7:	74 23                	je     80105adc <sys_open+0x9c>
  struct proc *curproc = myproc();
80105ab9:	e8 d2 de ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105b07:	e8 d4 f7 ff ff       	call   801052e0 <create>
    if(ip == 0){
...
80105b94:	e8 57 f6 ff ff       	call   801051f0 <argstr>
...
80105baf:	e8 2c f7 ff ff       	call   801052e0 <create>
...
80105bf4:	e8 f7 f5 ff ff       	call   801051f0 <argstr>
...
80105c09:	e8 22 f5 ff ff       	call   80105130 <argint>
  if((argstr(0, &path)) < 0 ||
...
80105c1e:	e8 0d f5 ff ff       	call   80105130 <argint>
     argint(1, &major) < 0 ||
...
80105c3e:	e8 9d f6 ff ff       	call   801052e0 <create>
     argint(2, &minor) < 0 ||
...
80105c8d:	e8 5e f5 ff ff       	call   801051f0 <argstr>
...
80105d35:	e8 b6 f4 ff ff       	call   801051f0 <argstr>
...
80105d51:	e8 da f3 ff ff       	call   80105130 <argint>
...
80105d70:	e8 fb f0 ff ff       	call   80104e70 <memset>
...
80105d9a:	e8 01 f3 ff ff       	call   801050a0 <fetchint>
...
80105db8:	e8 23 f3 ff ff       	call   801050e0 <fetchstr>
...
80105e21:	e8 5a f3 ff ff       	call   80105180 <argptr>
...
80105e47:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105e49:	e8 42 db ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105e87:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105e8a:	e8 01 db ff ff       	call   80103990 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105ea6:	75 f0                	jne    80105e98 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105ea8:	e8 e3 da ff ff       	call   80103990 <myproc>
...
{
  return fork();
80105ee0:	e9 4b dc ff ff       	jmp    80103b30 <fork>
...
80105ef3:	83 ec 08             	sub    $0x8,%esp
  exit();
80105ef6:	e8 e5 de ff ff       	call   80103de0 <exit>
...
{
  return wait();
80105f00:	e9 0b e0 ff ff       	jmp    80103f10 <wait>
...
80105f1c:	e8 0f f2 ff ff       	call   80105130 <argint>
...
80105f2e:	e8 7d e2 ff ff       	call   801041b0 <kill>
...
80105f53:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105f56:	e8 35 da ff ff       	call   80103990 <myproc>
...
80105f86:	e8 25 db ff ff       	call   80103ab0 <growproc>
...
80105fbd:	e8 6e f1 ff ff       	call   80105130 <argint>
...
80105fd0:	68 00 57 11 80       	push   $0x80115700
80105fd5:	e8 d6 ed ff ff       	call   80104db0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105fda:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105fdd:	8b 1d e0 56 11 80    	mov    0x801156e0,%ebx
  while(ticks - ticks0 < n){
...
80105ff3:	68 00 57 11 80       	push   $0x80115700
80105ff8:	68 e0 56 11 80       	push   $0x801156e0
80105ffd:	e8 8e e0 ff ff       	call   80104090 <sleep>
  while(ticks - ticks0 < n){
80106002:	a1 e0 56 11 80       	mov    0x801156e0,%eax
...
8010600f:	73 2f                	jae    80106040 <sys_sleep+0x90>
    if(myproc()->killed){
80106011:	e8 7a d9 ff ff       	call   80103990 <myproc>
...
80106020:	68 00 57 11 80       	push   $0x80115700
80106025:	e8 26 ed ff ff       	call   80104d50 <release>
  }
  release(&tickslock);
  return 0;
}
...
80106043:	68 00 57 11 80       	push   $0x80115700
80106048:	e8 03 ed ff ff       	call   80104d50 <release>
  return 0;
...
80106064:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80106067:	68 00 57 11 80       	push   $0x80115700
8010606c:	e8 3f ed ff ff       	call   80104db0 <acquire>
  xticks = ticks;
80106071:	8b 1d e0 56 11 80    	mov    0x801156e0,%ebx
  release(&tickslock);
80106077:	c7 04 24 00 57 11 80 	movl   $0x80115700,(%esp)
8010607e:	e8 cd ec ff ff       	call   80104d50 <release>
  return xticks;
}
...
int sys_cps(void){
	return cps();
80106090:	e9 5b e2 ff ff       	jmp    801042f0 <cps>
...
8010612c:	e8 ff ef ff ff       	call   80105130 <argint>
80106131:	83 c4 10             	add    $0x10,%esp
80106134:	85 c0                	test   %eax,%eax
80106136:	78 28                	js     80106160 <sys_sem_init+0x40>
    return -1;
  if (argint(1, &value) < 0)
80106138:	83 ec 08             	sub    $0x8,%esp
8010613b:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010613e:	50                   	push   %eax
8010613f:	6a 01                	push   $0x1
80106141:	e8 ea ef ff ff       	call   80105130 <argint>
80106146:	83 c4 10             	add    $0x10,%esp
80106149:	85 c0                	test   %eax,%eax
8010614b:	78 13                	js     80106160 <sys_sem_init+0x40>
    return -1;

  return sem_init(sem, value);
8010614d:	83 ec 08             	sub    $0x8,%esp
80106150:	ff 75 f4             	push   -0xc(%ebp)
80106153:	ff 75 f0             	push   -0x10(%ebp)
80106156:	e8 b5 e7 ff ff       	call   80104910 <sem_init>
...
8010617c:	e8 af ef ff ff       	call   80105130 <argint>
80106181:	83 c4 10             	add    $0x10,%esp
80106184:	85 c0                	test   %eax,%eax
80106186:	78 18                	js     801061a0 <sys_sem_destroy+0x30>
    return -1;

  return sem_destroy(sem);
80106188:	83 ec 0c             	sub    $0xc,%esp
8010618b:	ff 75 f4             	push   -0xc(%ebp)
8010618e:	e8 dd e7 ff ff       	call   80104970 <sem_destroy>
...
801061bc:	e8 6f ef ff ff       	call   80105130 <argint>
801061c1:	83 c4 10             	add    $0x10,%esp
801061c4:	85 c0                	test   %eax,%eax
801061c6:	78 28                	js     801061f0 <sys_sem_wait+0x40>
    return -1;
  if (argint(1, &count) < 0)
...
801061d1:	e8 5a ef ff ff       	call   80105130 <argint>
801061d6:	83 c4 10             	add    $0x10,%esp
801061d9:	85 c0                	test   %eax,%eax
801061db:	78 13                	js     801061f0 <sys_sem_wait+0x40>
    return -1;
...
801061e6:	e8 c5 e7 ff ff       	call   801049b0 <sem_wait>
...
8010620c:	e8 1f ef ff ff       	call   80105130 <argint>
80106211:	83 c4 10             	add    $0x10,%esp
80106214:	85 c0                	test   %eax,%eax
80106216:	78 28                	js     80106240 <sys_sem_signal+0x40>
    return -1;
  if (argint(1, &count) < 0)
...
80106221:	e8 0a ef ff ff       	call   80105130 <argint>
80106226:	83 c4 10             	add    $0x10,%esp
80106229:	85 c0                	test   %eax,%eax
8010622b:	78 13                	js     80106240 <sys_sem_signal+0x40>
    return -1;

  return sem_signal(sem, count);
8010622d:	83 ec 08             	sub    $0x8,%esp
80106230:	ff 75 f4             	push   -0xc(%ebp)
80106233:	ff 75 f0             	push   -0x10(%ebp)
80106236:	e8 e5 e7 ff ff       	call   80104a20 <sem_signal>
...
80106248:	06                   	push   %es
  pushl %fs
80106249:	0f a0                	push   %fs
  pushl %gs
8010624b:	0f a8                	push   %gs
  pushal
8010624d:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
8010624e:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106252:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106254:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80106256:	54                   	push   %esp
  call trap
80106257:	e8 c4 00 00 00       	call   80106320 <trap>
  addl $4, %esp
8010625c:	83 c4 04             	add    $0x4,%esp
...
8010625f:	61                   	popa   
  popl %gs
80106260:	0f a9                	pop    %gs
  popl %fs
80106262:	0f a1                	pop    %fs
  popl %es
80106264:	07                   	pop    %es
  popl %ds
80106265:	1f                   	pop    %ds
...
80106280:	8b 14 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%edx
80106287:	c7 04 c5 42 57 11 80 	movl   $0x8e000008,-0x7feea8be(,%eax,8)
8010628e:	08 00 00 8e 
80106292:	66 89 14 c5 40 57 11 	mov    %dx,-0x7feea8c0(,%eax,8)
80106299:	80 
8010629a:	c1 ea 10             	shr    $0x10,%edx
8010629d:	66 89 14 c5 46 57 11 	mov    %dx,-0x7feea8ba(,%eax,8)
801062a4:	80 
  for(i = 0; i < 256; i++)
...
801062af:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801062b2:	a1 0c b1 10 80       	mov    0x8010b10c,%eax
801062b7:	c7 05 42 59 11 80 08 	movl   $0xef000008,0x80115942
801062be:	00 00 ef 
  initlock(&tickslock, "time");
801062c1:	68 ed 83 10 80       	push   $0x801083ed
801062c6:	68 00 57 11 80       	push   $0x80115700
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801062cb:	66 a3 40 59 11 80    	mov    %ax,0x80115940
801062d1:	c1 e8 10             	shr    $0x10,%eax
801062d4:	66 a3 46 59 11 80    	mov    %ax,0x80115946
  initlock(&tickslock, "time");
801062da:	e8 01 e9 ff ff       	call   80104be0 <initlock>
}
...
801062fb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801062ff:	b8 40 57 11 80       	mov    $0x80115740,%eax
...
80106332:	0f 84 68 01 00 00    	je     801064a0 <trap+0x180>
    if(myproc()->killed)
      exit();
    return;
  }
...
80106344:	ff 24 85 94 84 10 80 	jmp    *-0x7fef7b6c(,%eax,4)
...
8010635a:	e8 31 d6 ff ff       	call   80103990 <myproc>
8010635f:	85 c0                	test   %eax,%eax
80106361:	74 1d                	je     80106380 <trap+0x60>
80106363:	e8 28 d6 ff ff       	call   80103990 <myproc>
...
8010637a:	0f 84 d0 01 00 00    	je     80106550 <trap+0x230>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80106380:	e8 0b d6 ff ff       	call   80103990 <myproc>
80106385:	85 c0                	test   %eax,%eax
80106387:	74 0f                	je     80106398 <trap+0x78>
80106389:	e8 02 d6 ff ff       	call   80103990 <myproc>
...
80106392:	0f 84 b8 00 00 00    	je     80106450 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106398:	e8 f3 d5 ff ff       	call   80103990 <myproc>
8010639d:	85 c0                	test   %eax,%eax
8010639f:	74 1d                	je     801063be <trap+0x9e>
801063a1:	e8 ea d5 ff ff       	call   80103990 <myproc>
...
801063b8:	0f 84 0f 01 00 00    	je     801064cd <trap+0x1ad>
    exit();
}
...
801063d0:	e8 bb d5 ff ff       	call   80103990 <myproc>
801063d5:	8b 7b 38             	mov    0x38(%ebx),%edi
801063d8:	85 c0                	test   %eax,%eax
801063da:	0f 84 c2 01 00 00    	je     801065a2 <trap+0x282>
801063e0:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801063e4:	0f 84 b8 01 00 00    	je     801065a2 <trap+0x282>
...
801063f0:	e8 7b d5 ff ff       	call   80103970 <cpuid>
...
80106401:	e8 8a d5 ff ff       	call   80103990 <myproc>
80106406:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106409:	e8 82 d5 ff ff       	call   80103990 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80106425:	68 50 84 10 80       	push   $0x80108450
8010642a:	e8 71 a2 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
8010642f:	83 c4 20             	add    $0x20,%esp
80106432:	e8 59 d5 ff ff       	call   80103990 <myproc>
80106437:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010643e:	e8 4d d5 ff ff       	call   80103990 <myproc>
...
80106454:	0f 85 3e ff ff ff    	jne    80106398 <trap+0x78>
    yield();
8010645a:	e8 e1 db ff ff       	call   80104040 <yield>
8010645f:	e9 34 ff ff ff       	jmp    80106398 <trap+0x78>
...
8010646f:	e8 fc d4 ff ff       	call   80103970 <cpuid>
80106474:	57                   	push   %edi
80106475:	56                   	push   %esi
80106476:	50                   	push   %eax
80106477:	68 f8 83 10 80       	push   $0x801083f8
8010647c:	e8 1f a2 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80106481:	e8 8a c4 ff ff       	call   80102910 <lapiceoi>
    break;
80106486:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106489:	e8 02 d5 ff ff       	call   80103990 <myproc>
8010648e:	85 c0                	test   %eax,%eax
80106490:	0f 85 cd fe ff ff    	jne    80106363 <trap+0x43>
80106496:	e9 e5 fe ff ff       	jmp    80106380 <trap+0x60>
8010649b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010649f:	90                   	nop
    if(myproc()->killed)
801064a0:	e8 eb d4 ff ff       	call   80103990 <myproc>
801064a5:	8b 70 24             	mov    0x24(%eax),%esi
801064a8:	85 f6                	test   %esi,%esi
801064aa:	0f 85 e8 00 00 00    	jne    80106598 <trap+0x278>
    myproc()->tf = tf;
801064b0:	e8 db d4 ff ff       	call   80103990 <myproc>
801064b5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801064b8:	e8 b3 ed ff ff       	call   80105270 <syscall>
    if(myproc()->killed)
801064bd:	e8 ce d4 ff ff       	call   80103990 <myproc>
801064c2:	8b 48 24             	mov    0x24(%eax),%ecx
801064c5:	85 c9                	test   %ecx,%ecx
801064c7:	0f 84 f1 fe ff ff    	je     801063be <trap+0x9e>
}
...
801064d3:	5d                   	pop    %ebp
      exit();
801064d4:	e9 07 d9 ff ff       	jmp    80103de0 <exit>
801064d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
801064e0:	e8 5b 02 00 00       	call   80106740 <uartintr>
    lapiceoi();
801064e5:	e8 26 c4 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801064ea:	e8 a1 d4 ff ff       	call   80103990 <myproc>
801064ef:	85 c0                	test   %eax,%eax
801064f1:	0f 85 6c fe ff ff    	jne    80106363 <trap+0x43>
801064f7:	e9 84 fe ff ff       	jmp    80106380 <trap+0x60>
801064fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80106500:	e8 cb c2 ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80106505:	e8 06 c4 ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010650a:	e8 81 d4 ff ff       	call   80103990 <myproc>
8010650f:	85 c0                	test   %eax,%eax
80106511:	0f 85 4c fe ff ff    	jne    80106363 <trap+0x43>
80106517:	e9 64 fe ff ff       	jmp    80106380 <trap+0x60>
8010651c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80106520:	e8 4b d4 ff ff       	call   80103970 <cpuid>
80106525:	85 c0                	test   %eax,%eax
80106527:	74 37                	je     80106560 <trap+0x240>
    if(myproc()!=0 && myproc()->state == RUNNING){
80106529:	e8 62 d4 ff ff       	call   80103990 <myproc>
8010652e:	85 c0                	test   %eax,%eax
80106530:	0f 84 1f fe ff ff    	je     80106355 <trap+0x35>
80106536:	e8 55 d4 ff ff       	call   80103990 <myproc>
8010653b:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
8010653f:	0f 85 10 fe ff ff    	jne    80106355 <trap+0x35>
      yield();
80106545:	e8 f6 da ff ff       	call   80104040 <yield>
    lapiceoi();
8010654a:	e9 06 fe ff ff       	jmp    80106355 <trap+0x35>
8010654f:	90                   	nop
    exit();
80106550:	e8 8b d8 ff ff       	call   80103de0 <exit>
80106555:	e9 26 fe ff ff       	jmp    80106380 <trap+0x60>
8010655a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80106560:	83 ec 0c             	sub    $0xc,%esp
80106563:	68 00 57 11 80       	push   $0x80115700
80106568:	e8 43 e8 ff ff       	call   80104db0 <acquire>
      wakeup(&ticks);
8010656d:	c7 04 24 e0 56 11 80 	movl   $0x801156e0,(%esp)
      ticks++;
80106574:	83 05 e0 56 11 80 01 	addl   $0x1,0x801156e0
      wakeup(&ticks);
8010657b:	e8 d0 db ff ff       	call   80104150 <wakeup>
      release(&tickslock);
80106580:	c7 04 24 00 57 11 80 	movl   $0x80115700,(%esp)
80106587:	e8 c4 e7 ff ff       	call   80104d50 <release>
8010658c:	83 c4 10             	add    $0x10,%esp
8010658f:	eb 98                	jmp    80106529 <trap+0x209>
80106591:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      exit();
80106598:	e8 43 d8 ff ff       	call   80103de0 <exit>
8010659d:	e9 0e ff ff ff       	jmp    801064b0 <trap+0x190>
801065a2:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801065a5:	e8 c6 d3 ff ff       	call   80103970 <cpuid>
801065aa:	83 ec 0c             	sub    $0xc,%esp
801065ad:	56                   	push   %esi
801065ae:	57                   	push   %edi
801065af:	50                   	push   %eax
801065b0:	ff 73 30             	push   0x30(%ebx)
801065b3:	68 1c 84 10 80       	push   $0x8010841c
801065b8:	e8 e3 a0 ff ff       	call   801006a0 <cprintf>
      panic("trap");
801065bd:	83 c4 14             	add    $0x14,%esp
801065c0:	68 f2 83 10 80       	push   $0x801083f2
801065c5:	e8 b6 9d ff ff       	call   80100380 <panic>
...
{
  if(!uart)
801065d0:	a1 40 5f 11 80       	mov    0x80115f40,%eax
801065d5:	85 c0                	test   %eax,%eax
801065d7:	74 17                	je     801065f0 <uartgetc+0x20>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801065d9:	ba fd 03 00 00       	mov    $0x3fd,%edx
801065de:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
801065df:	a8 01                	test   $0x1,%al
801065e1:	74 0d                	je     801065f0 <uartgetc+0x20>
801065e3:	ba f8 03 00 00       	mov    $0x3f8,%edx
801065e8:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
...
80106657:	74 78                	je     801066d1 <uartinit+0xd1>
  uart = 1;
80106659:	c7 05 40 5f 11 80 01 	movl   $0x1,0x80115f40
80106660:	00 00 00 
...
8010666c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
8010666f:	bf 14 85 10 80       	mov    $0x80108514,%edi
80106674:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80106679:	6a 00                	push   $0x0
8010667b:	6a 04                	push   $0x4
8010667d:	e8 fe bd ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80106682:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
80106686:	83 c4 10             	add    $0x10,%esp
80106689:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80106690:	a1 40 5f 11 80       	mov    0x80115f40,%eax
80106695:	bb 80 00 00 00       	mov    $0x80,%ebx
8010669a:	85 c0                	test   %eax,%eax
8010669c:	75 14                	jne    801066b2 <uartinit+0xb2>
8010669e:	eb 23                	jmp    801066c3 <uartinit+0xc3>
    microdelay(10);
801066a0:	83 ec 0c             	sub    $0xc,%esp
801066a3:	6a 0a                	push   $0xa
801066a5:	e8 86 c2 ff ff       	call   80102930 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801066aa:	83 c4 10             	add    $0x10,%esp
801066ad:	83 eb 01             	sub    $0x1,%ebx
801066b0:	74 07                	je     801066b9 <uartinit+0xb9>
801066b2:	89 f2                	mov    %esi,%edx
801066b4:	ec                   	in     (%dx),%al
801066b5:	a8 20                	test   $0x20,%al
801066b7:	74 e7                	je     801066a0 <uartinit+0xa0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801066b9:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
801066bd:	ba f8 03 00 00       	mov    $0x3f8,%edx
801066c2:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
801066c3:	0f b6 47 01          	movzbl 0x1(%edi),%eax
801066c7:	83 c7 01             	add    $0x1,%edi
801066ca:	88 45 e7             	mov    %al,-0x19(%ebp)
801066cd:	84 c0                	test   %al,%al
801066cf:	75 bf                	jne    80106690 <uartinit+0x90>
}
...
801066e0 <uartputc>:
  if(!uart)
801066e0:	a1 40 5f 11 80       	mov    0x80115f40,%eax
801066e5:	85 c0                	test   %eax,%eax
801066e7:	74 47                	je     80106730 <uartputc+0x50>
{
...
801066f2:	53                   	push   %ebx
801066f3:	bb 80 00 00 00       	mov    $0x80,%ebx
801066f8:	eb 18                	jmp    80106712 <uartputc+0x32>
801066fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    microdelay(10);
80106700:	83 ec 0c             	sub    $0xc,%esp
80106703:	6a 0a                	push   $0xa
80106705:	e8 26 c2 ff ff       	call   80102930 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010670a:	83 c4 10             	add    $0x10,%esp
8010670d:	83 eb 01             	sub    $0x1,%ebx
80106710:	74 07                	je     80106719 <uartputc+0x39>
80106712:	89 f2                	mov    %esi,%edx
80106714:	ec                   	in     (%dx),%al
80106715:	a8 20                	test   $0x20,%al
80106717:	74 e7                	je     80106700 <uartputc+0x20>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106719:	8b 45 08             	mov    0x8(%ebp),%eax
8010671c:	ba f8 03 00 00       	mov    $0x3f8,%edx
80106721:	ee                   	out    %al,(%dx)
}
80106722:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106725:	5b                   	pop    %ebx
80106726:	5e                   	pop    %esi
80106727:	5d                   	pop    %ebp
80106728:	c3                   	ret    
...
8010674b:	e8 30 a1 ff ff       	call   80100880 <consoleintr>
}
...
80106757:	6a 00                	push   $0x0
  jmp alltraps
80106759:	e9 e9 fa ff ff       	jmp    80106247 <alltraps>
...
80106760:	6a 01                	push   $0x1
  jmp alltraps
80106762:	e9 e0 fa ff ff       	jmp    80106247 <alltraps>
...
80106769:	6a 02                	push   $0x2
  jmp alltraps
8010676b:	e9 d7 fa ff ff       	jmp    80106247 <alltraps>
...
80106772:	6a 03                	push   $0x3
  jmp alltraps
80106774:	e9 ce fa ff ff       	jmp    80106247 <alltraps>
...
8010677b:	6a 04                	push   $0x4
  jmp alltraps
8010677d:	e9 c5 fa ff ff       	jmp    80106247 <alltraps>
...
80106784:	6a 05                	push   $0x5
  jmp alltraps
80106786:	e9 bc fa ff ff       	jmp    80106247 <alltraps>
...
8010678d:	6a 06                	push   $0x6
  jmp alltraps
8010678f:	e9 b3 fa ff ff       	jmp    80106247 <alltraps>
...
80106796:	6a 07                	push   $0x7
  jmp alltraps
80106798:	e9 aa fa ff ff       	jmp    80106247 <alltraps>
...
8010679d:	6a 08                	push   $0x8
  jmp alltraps
8010679f:	e9 a3 fa ff ff       	jmp    80106247 <alltraps>
...
801067a6:	6a 09                	push   $0x9
  jmp alltraps
801067a8:	e9 9a fa ff ff       	jmp    80106247 <alltraps>
...
801067ad:	6a 0a                	push   $0xa
  jmp alltraps
801067af:	e9 93 fa ff ff       	jmp    80106247 <alltraps>
...
801067b4:	6a 0b                	push   $0xb
  jmp alltraps
801067b6:	e9 8c fa ff ff       	jmp    80106247 <alltraps>
...
801067bb:	6a 0c                	push   $0xc
  jmp alltraps
801067bd:	e9 85 fa ff ff       	jmp    80106247 <alltraps>
...
801067c2:	6a 0d                	push   $0xd
  jmp alltraps
801067c4:	e9 7e fa ff ff       	jmp    80106247 <alltraps>
...
801067c9:	6a 0e                	push   $0xe
  jmp alltraps
801067cb:	e9 77 fa ff ff       	jmp    80106247 <alltraps>
...
801067d2:	6a 0f                	push   $0xf
  jmp alltraps
801067d4:	e9 6e fa ff ff       	jmp    80106247 <alltraps>
...
801067db:	6a 10                	push   $0x10
  jmp alltraps
801067dd:	e9 65 fa ff ff       	jmp    80106247 <alltraps>
...
801067e2:	6a 11                	push   $0x11
  jmp alltraps
801067e4:	e9 5e fa ff ff       	jmp    80106247 <alltraps>
...
801067eb:	6a 12                	push   $0x12
  jmp alltraps
801067ed:	e9 55 fa ff ff       	jmp    80106247 <alltraps>
...
801067f4:	6a 13                	push   $0x13
  jmp alltraps
801067f6:	e9 4c fa ff ff       	jmp    80106247 <alltraps>
...
801067fd:	6a 14                	push   $0x14
  jmp alltraps
801067ff:	e9 43 fa ff ff       	jmp    80106247 <alltraps>
...
80106806:	6a 15                	push   $0x15
  jmp alltraps
80106808:	e9 3a fa ff ff       	jmp    80106247 <alltraps>
...
8010680f:	6a 16                	push   $0x16
  jmp alltraps
80106811:	e9 31 fa ff ff       	jmp    80106247 <alltraps>
...
80106818:	6a 17                	push   $0x17
  jmp alltraps
8010681a:	e9 28 fa ff ff       	jmp    80106247 <alltraps>
...
80106821:	6a 18                	push   $0x18
  jmp alltraps
80106823:	e9 1f fa ff ff       	jmp    80106247 <alltraps>
...
8010682a:	6a 19                	push   $0x19
  jmp alltraps
8010682c:	e9 16 fa ff ff       	jmp    80106247 <alltraps>
...
80106833:	6a 1a                	push   $0x1a
  jmp alltraps
80106835:	e9 0d fa ff ff       	jmp    80106247 <alltraps>
...
8010683c:	6a 1b                	push   $0x1b
  jmp alltraps
8010683e:	e9 04 fa ff ff       	jmp    80106247 <alltraps>
...
80106845:	6a 1c                	push   $0x1c
  jmp alltraps
80106847:	e9 fb f9 ff ff       	jmp    80106247 <alltraps>
...
8010684e:	6a 1d                	push   $0x1d
  jmp alltraps
80106850:	e9 f2 f9 ff ff       	jmp    80106247 <alltraps>
...
80106857:	6a 1e                	push   $0x1e
  jmp alltraps
80106859:	e9 e9 f9 ff ff       	jmp    80106247 <alltraps>
...
80106860:	6a 1f                	push   $0x1f
  jmp alltraps
80106862:	e9 e0 f9 ff ff       	jmp    80106247 <alltraps>
...
80106869:	6a 20                	push   $0x20
  jmp alltraps
8010686b:	e9 d7 f9 ff ff       	jmp    80106247 <alltraps>
...
80106872:	6a 21                	push   $0x21
  jmp alltraps
80106874:	e9 ce f9 ff ff       	jmp    80106247 <alltraps>
...
8010687b:	6a 22                	push   $0x22
  jmp alltraps
8010687d:	e9 c5 f9 ff ff       	jmp    80106247 <alltraps>
...
80106884:	6a 23                	push   $0x23
  jmp alltraps
80106886:	e9 bc f9 ff ff       	jmp    80106247 <alltraps>
...
8010688d:	6a 24                	push   $0x24
  jmp alltraps
8010688f:	e9 b3 f9 ff ff       	jmp    80106247 <alltraps>
...
80106896:	6a 25                	push   $0x25
  jmp alltraps
80106898:	e9 aa f9 ff ff       	jmp    80106247 <alltraps>
...
8010689f:	6a 26                	push   $0x26
  jmp alltraps
801068a1:	e9 a1 f9 ff ff       	jmp    80106247 <alltraps>
...
801068a8:	6a 27                	push   $0x27
  jmp alltraps
801068aa:	e9 98 f9 ff ff       	jmp    80106247 <alltraps>
...
801068b1:	6a 28                	push   $0x28
  jmp alltraps
801068b3:	e9 8f f9 ff ff       	jmp    80106247 <alltraps>
...
801068ba:	6a 29                	push   $0x29
  jmp alltraps
801068bc:	e9 86 f9 ff ff       	jmp    80106247 <alltraps>
...
801068c3:	6a 2a                	push   $0x2a
  jmp alltraps
801068c5:	e9 7d f9 ff ff       	jmp    80106247 <alltraps>
...
801068cc:	6a 2b                	push   $0x2b
  jmp alltraps
801068ce:	e9 74 f9 ff ff       	jmp    80106247 <alltraps>
...
801068d5:	6a 2c                	push   $0x2c
  jmp alltraps
801068d7:	e9 6b f9 ff ff       	jmp    80106247 <alltraps>
...
801068de:	6a 2d                	push   $0x2d
  jmp alltraps
801068e0:	e9 62 f9 ff ff       	jmp    80106247 <alltraps>
...
801068e7:	6a 2e                	push   $0x2e
  jmp alltraps
801068e9:	e9 59 f9 ff ff       	jmp    80106247 <alltraps>
...
801068f0:	6a 2f                	push   $0x2f
  jmp alltraps
801068f2:	e9 50 f9 ff ff       	jmp    80106247 <alltraps>
...
801068f9:	6a 30                	push   $0x30
  jmp alltraps
801068fb:	e9 47 f9 ff ff       	jmp    80106247 <alltraps>
...
80106902:	6a 31                	push   $0x31
  jmp alltraps
80106904:	e9 3e f9 ff ff       	jmp    80106247 <alltraps>
...
8010690b:	6a 32                	push   $0x32
  jmp alltraps
8010690d:	e9 35 f9 ff ff       	jmp    80106247 <alltraps>
...
80106914:	6a 33                	push   $0x33
  jmp alltraps
80106916:	e9 2c f9 ff ff       	jmp    80106247 <alltraps>
...
8010691d:	6a 34                	push   $0x34
  jmp alltraps
8010691f:	e9 23 f9 ff ff       	jmp    80106247 <alltraps>
...
80106926:	6a 35                	push   $0x35
  jmp alltraps
80106928:	e9 1a f9 ff ff       	jmp    80106247 <alltraps>
...
8010692f:	6a 36                	push   $0x36
  jmp alltraps
80106931:	e9 11 f9 ff ff       	jmp    80106247 <alltraps>
...
80106938:	6a 37                	push   $0x37
  jmp alltraps
8010693a:	e9 08 f9 ff ff       	jmp    80106247 <alltraps>
...
80106941:	6a 38                	push   $0x38
  jmp alltraps
80106943:	e9 ff f8 ff ff       	jmp    80106247 <alltraps>
...
8010694a:	6a 39                	push   $0x39
  jmp alltraps
8010694c:	e9 f6 f8 ff ff       	jmp    80106247 <alltraps>
...
80106953:	6a 3a                	push   $0x3a
  jmp alltraps
80106955:	e9 ed f8 ff ff       	jmp    80106247 <alltraps>
...
8010695c:	6a 3b                	push   $0x3b
  jmp alltraps
8010695e:	e9 e4 f8 ff ff       	jmp    80106247 <alltraps>
...
80106965:	6a 3c                	push   $0x3c
  jmp alltraps
80106967:	e9 db f8 ff ff       	jmp    80106247 <alltraps>
...
8010696e:	6a 3d                	push   $0x3d
  jmp alltraps
80106970:	e9 d2 f8 ff ff       	jmp    80106247 <alltraps>
...
80106977:	6a 3e                	push   $0x3e
  jmp alltraps
80106979:	e9 c9 f8 ff ff       	jmp    80106247 <alltraps>
...
80106980:	6a 3f                	push   $0x3f
  jmp alltraps
80106982:	e9 c0 f8 ff ff       	jmp    80106247 <alltraps>
...
80106989:	6a 40                	push   $0x40
  jmp alltraps
8010698b:	e9 b7 f8 ff ff       	jmp    80106247 <alltraps>
...
80106992:	6a 41                	push   $0x41
  jmp alltraps
80106994:	e9 ae f8 ff ff       	jmp    80106247 <alltraps>
...
8010699b:	6a 42                	push   $0x42
  jmp alltraps
8010699d:	e9 a5 f8 ff ff       	jmp    80106247 <alltraps>
...
801069a4:	6a 43                	push   $0x43
  jmp alltraps
801069a6:	e9 9c f8 ff ff       	jmp    80106247 <alltraps>
...
801069ad:	6a 44                	push   $0x44
  jmp alltraps
801069af:	e9 93 f8 ff ff       	jmp    80106247 <alltraps>
...
801069b6:	6a 45                	push   $0x45
  jmp alltraps
801069b8:	e9 8a f8 ff ff       	jmp    80106247 <alltraps>
...
801069bf:	6a 46                	push   $0x46
  jmp alltraps
801069c1:	e9 81 f8 ff ff       	jmp    80106247 <alltraps>
...
801069c8:	6a 47                	push   $0x47
  jmp alltraps
801069ca:	e9 78 f8 ff ff       	jmp    80106247 <alltraps>
...
801069d1:	6a 48                	push   $0x48
  jmp alltraps
801069d3:	e9 6f f8 ff ff       	jmp    80106247 <alltraps>
...
801069da:	6a 49                	push   $0x49
  jmp alltraps
801069dc:	e9 66 f8 ff ff       	jmp    80106247 <alltraps>
...
801069e3:	6a 4a                	push   $0x4a
  jmp alltraps
801069e5:	e9 5d f8 ff ff       	jmp    80106247 <alltraps>
...
801069ec:	6a 4b                	push   $0x4b
  jmp alltraps
801069ee:	e9 54 f8 ff ff       	jmp    80106247 <alltraps>
...
801069f5:	6a 4c                	push   $0x4c
  jmp alltraps
801069f7:	e9 4b f8 ff ff       	jmp    80106247 <alltraps>
...
801069fe:	6a 4d                	push   $0x4d
  jmp alltraps
80106a00:	e9 42 f8 ff ff       	jmp    80106247 <alltraps>
...
80106a07:	6a 4e                	push   $0x4e
  jmp alltraps
80106a09:	e9 39 f8 ff ff       	jmp    80106247 <alltraps>
...
80106a10:	6a 4f                	push   $0x4f
  jmp alltraps
80106a12:	e9 30 f8 ff ff       	jmp    80106247 <alltraps>
...
80106a19:	6a 50                	push   $0x50
  jmp alltraps
80106a1b:	e9 27 f8 ff ff       	jmp    80106247 <alltraps>
...
80106a22:	6a 51                	push   $0x51
  jmp alltraps
80106a24:	e9 1e f8 ff ff       	jmp    80106247 <alltraps>
...
80106a2b:	6a 52                	push   $0x52
  jmp alltraps
80106a2d:	e9 15 f8 ff ff       	jmp    80106247 <alltraps>
...
80106a34:	6a 53                	push   $0x53
  jmp alltraps
80106a36:	e9 0c f8 ff ff       	jmp    80106247 <alltraps>
...
80106a3d:	6a 54                	push   $0x54
  jmp alltraps
80106a3f:	e9 03 f8 ff ff       	jmp    80106247 <alltraps>
...
80106a46:	6a 55                	push   $0x55
  jmp alltraps
80106a48:	e9 fa f7 ff ff       	jmp    80106247 <alltraps>
...
80106a4f:	6a 56                	push   $0x56
  jmp alltraps
80106a51:	e9 f1 f7 ff ff       	jmp    80106247 <alltraps>
...
80106a58:	6a 57                	push   $0x57
  jmp alltraps
80106a5a:	e9 e8 f7 ff ff       	jmp    80106247 <alltraps>
...
80106a61:	6a 58                	push   $0x58
  jmp alltraps
80106a63:	e9 df f7 ff ff       	jmp    80106247 <alltraps>
...
80106a6a:	6a 59                	push   $0x59
  jmp alltraps
80106a6c:	e9 d6 f7 ff ff       	jmp    80106247 <alltraps>
...
80106a73:	6a 5a                	push   $0x5a
  jmp alltraps
80106a75:	e9 cd f7 ff ff       	jmp    80106247 <alltraps>
...
80106a7c:	6a 5b                	push   $0x5b
  jmp alltraps
80106a7e:	e9 c4 f7 ff ff       	jmp    80106247 <alltraps>
...
80106a85:	6a 5c                	push   $0x5c
  jmp alltraps
80106a87:	e9 bb f7 ff ff       	jmp    80106247 <alltraps>
...
80106a8e:	6a 5d                	push   $0x5d
  jmp alltraps
80106a90:	e9 b2 f7 ff ff       	jmp    80106247 <alltraps>
...
80106a97:	6a 5e                	push   $0x5e
  jmp alltraps
80106a99:	e9 a9 f7 ff ff       	jmp    80106247 <alltraps>
...
80106aa0:	6a 5f                	push   $0x5f
  jmp alltraps
80106aa2:	e9 a0 f7 ff ff       	jmp    80106247 <alltraps>
...
80106aa9:	6a 60                	push   $0x60
  jmp alltraps
80106aab:	e9 97 f7 ff ff       	jmp    80106247 <alltraps>
...
80106ab2:	6a 61                	push   $0x61
  jmp alltraps
80106ab4:	e9 8e f7 ff ff       	jmp    80106247 <alltraps>
...
80106abb:	6a 62                	push   $0x62
  jmp alltraps
80106abd:	e9 85 f7 ff ff       	jmp    80106247 <alltraps>
...
80106ac4:	6a 63                	push   $0x63
  jmp alltraps
80106ac6:	e9 7c f7 ff ff       	jmp    80106247 <alltraps>
...
80106acd:	6a 64                	push   $0x64
  jmp alltraps
80106acf:	e9 73 f7 ff ff       	jmp    80106247 <alltraps>
...
80106ad6:	6a 65                	push   $0x65
  jmp alltraps
80106ad8:	e9 6a f7 ff ff       	jmp    80106247 <alltraps>
...
80106adf:	6a 66                	push   $0x66
  jmp alltraps
80106ae1:	e9 61 f7 ff ff       	jmp    80106247 <alltraps>
...
80106ae8:	6a 67                	push   $0x67
  jmp alltraps
80106aea:	e9 58 f7 ff ff       	jmp    80106247 <alltraps>
...
80106af1:	6a 68                	push   $0x68
  jmp alltraps
80106af3:	e9 4f f7 ff ff       	jmp    80106247 <alltraps>
...
80106afa:	6a 69                	push   $0x69
  jmp alltraps
80106afc:	e9 46 f7 ff ff       	jmp    80106247 <alltraps>
...
80106b03:	6a 6a                	push   $0x6a
  jmp alltraps
80106b05:	e9 3d f7 ff ff       	jmp    80106247 <alltraps>
...
80106b0c:	6a 6b                	push   $0x6b
  jmp alltraps
80106b0e:	e9 34 f7 ff ff       	jmp    80106247 <alltraps>
...
80106b15:	6a 6c                	push   $0x6c
  jmp alltraps
80106b17:	e9 2b f7 ff ff       	jmp    80106247 <alltraps>
...
80106b1e:	6a 6d                	push   $0x6d
  jmp alltraps
80106b20:	e9 22 f7 ff ff       	jmp    80106247 <alltraps>
...
80106b27:	6a 6e                	push   $0x6e
  jmp alltraps
80106b29:	e9 19 f7 ff ff       	jmp    80106247 <alltraps>
...
80106b30:	6a 6f                	push   $0x6f
  jmp alltraps
80106b32:	e9 10 f7 ff ff       	jmp    80106247 <alltraps>
...
80106b39:	6a 70                	push   $0x70
  jmp alltraps
80106b3b:	e9 07 f7 ff ff       	jmp    80106247 <alltraps>
...
80106b42:	6a 71                	push   $0x71
  jmp alltraps
80106b44:	e9 fe f6 ff ff       	jmp    80106247 <alltraps>
...
80106b4b:	6a 72                	push   $0x72
  jmp alltraps
80106b4d:	e9 f5 f6 ff ff       	jmp    80106247 <alltraps>
...
80106b54:	6a 73                	push   $0x73
  jmp alltraps
80106b56:	e9 ec f6 ff ff       	jmp    80106247 <alltraps>
...
80106b5d:	6a 74                	push   $0x74
  jmp alltraps
80106b5f:	e9 e3 f6 ff ff       	jmp    80106247 <alltraps>
...
80106b66:	6a 75                	push   $0x75
  jmp alltraps
80106b68:	e9 da f6 ff ff       	jmp    80106247 <alltraps>
...
80106b6f:	6a 76                	push   $0x76
  jmp alltraps
80106b71:	e9 d1 f6 ff ff       	jmp    80106247 <alltraps>
...
80106b78:	6a 77                	push   $0x77
  jmp alltraps
80106b7a:	e9 c8 f6 ff ff       	jmp    80106247 <alltraps>
...
80106b81:	6a 78                	push   $0x78
  jmp alltraps
80106b83:	e9 bf f6 ff ff       	jmp    80106247 <alltraps>
...
80106b8a:	6a 79                	push   $0x79
  jmp alltraps
80106b8c:	e9 b6 f6 ff ff       	jmp    80106247 <alltraps>
...
80106b93:	6a 7a                	push   $0x7a
  jmp alltraps
80106b95:	e9 ad f6 ff ff       	jmp    80106247 <alltraps>
...
80106b9c:	6a 7b                	push   $0x7b
  jmp alltraps
80106b9e:	e9 a4 f6 ff ff       	jmp    80106247 <alltraps>
...
80106ba5:	6a 7c                	push   $0x7c
  jmp alltraps
80106ba7:	e9 9b f6 ff ff       	jmp    80106247 <alltraps>
...
80106bae:	6a 7d                	push   $0x7d
  jmp alltraps
80106bb0:	e9 92 f6 ff ff       	jmp    80106247 <alltraps>
...
80106bb7:	6a 7e                	push   $0x7e
  jmp alltraps
80106bb9:	e9 89 f6 ff ff       	jmp    80106247 <alltraps>
...
80106bc0:	6a 7f                	push   $0x7f
  jmp alltraps
80106bc2:	e9 80 f6 ff ff       	jmp    80106247 <alltraps>
...
80106bc9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106bce:	e9 74 f6 ff ff       	jmp    80106247 <alltraps>
...
80106bd5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106bda:	e9 68 f6 ff ff       	jmp    80106247 <alltraps>
...
80106be1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106be6:	e9 5c f6 ff ff       	jmp    80106247 <alltraps>
...
80106bed:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106bf2:	e9 50 f6 ff ff       	jmp    80106247 <alltraps>
...
80106bf9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106bfe:	e9 44 f6 ff ff       	jmp    80106247 <alltraps>
...
80106c05:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106c0a:	e9 38 f6 ff ff       	jmp    80106247 <alltraps>
...
80106c11:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106c16:	e9 2c f6 ff ff       	jmp    80106247 <alltraps>
...
80106c1d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106c22:	e9 20 f6 ff ff       	jmp    80106247 <alltraps>
...
80106c29:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106c2e:	e9 14 f6 ff ff       	jmp    80106247 <alltraps>
...
80106c35:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106c3a:	e9 08 f6 ff ff       	jmp    80106247 <alltraps>
...
80106c41:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106c46:	e9 fc f5 ff ff       	jmp    80106247 <alltraps>
...
80106c4d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106c52:	e9 f0 f5 ff ff       	jmp    80106247 <alltraps>
...
80106c59:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106c5e:	e9 e4 f5 ff ff       	jmp    80106247 <alltraps>
...
80106c65:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106c6a:	e9 d8 f5 ff ff       	jmp    80106247 <alltraps>
...
80106c71:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106c76:	e9 cc f5 ff ff       	jmp    80106247 <alltraps>
...
80106c7d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106c82:	e9 c0 f5 ff ff       	jmp    80106247 <alltraps>
...
80106c89:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80106c8e:	e9 b4 f5 ff ff       	jmp    80106247 <alltraps>
...
80106c95:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106c9a:	e9 a8 f5 ff ff       	jmp    80106247 <alltraps>
...
80106ca1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106ca6:	e9 9c f5 ff ff       	jmp    80106247 <alltraps>
...
80106cad:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106cb2:	e9 90 f5 ff ff       	jmp    80106247 <alltraps>
...
80106cb9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80106cbe:	e9 84 f5 ff ff       	jmp    80106247 <alltraps>
...
80106cc5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106cca:	e9 78 f5 ff ff       	jmp    80106247 <alltraps>
...
80106cd1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106cd6:	e9 6c f5 ff ff       	jmp    80106247 <alltraps>
...
80106cdd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106ce2:	e9 60 f5 ff ff       	jmp    80106247 <alltraps>
...
80106ce9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106cee:	e9 54 f5 ff ff       	jmp    80106247 <alltraps>
...
80106cf5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106cfa:	e9 48 f5 ff ff       	jmp    80106247 <alltraps>
...
80106d01:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106d06:	e9 3c f5 ff ff       	jmp    80106247 <alltraps>
...
80106d0d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106d12:	e9 30 f5 ff ff       	jmp    80106247 <alltraps>
...
80106d19:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106d1e:	e9 24 f5 ff ff       	jmp    80106247 <alltraps>
...
80106d25:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106d2a:	e9 18 f5 ff ff       	jmp    80106247 <alltraps>
...
80106d31:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106d36:	e9 0c f5 ff ff       	jmp    80106247 <alltraps>
...
80106d3d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106d42:	e9 00 f5 ff ff       	jmp    80106247 <alltraps>
...
80106d49:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106d4e:	e9 f4 f4 ff ff       	jmp    80106247 <alltraps>
...
80106d55:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106d5a:	e9 e8 f4 ff ff       	jmp    80106247 <alltraps>
...
80106d61:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106d66:	e9 dc f4 ff ff       	jmp    80106247 <alltraps>
...
80106d6d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106d72:	e9 d0 f4 ff ff       	jmp    80106247 <alltraps>
...
80106d79:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106d7e:	e9 c4 f4 ff ff       	jmp    80106247 <alltraps>
...
80106d85:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106d8a:	e9 b8 f4 ff ff       	jmp    80106247 <alltraps>
...
80106d91:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106d96:	e9 ac f4 ff ff       	jmp    80106247 <alltraps>
...
80106d9d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106da2:	e9 a0 f4 ff ff       	jmp    80106247 <alltraps>
...
80106da9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106dae:	e9 94 f4 ff ff       	jmp    80106247 <alltraps>
...
80106db5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106dba:	e9 88 f4 ff ff       	jmp    80106247 <alltraps>
...
80106dc1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106dc6:	e9 7c f4 ff ff       	jmp    80106247 <alltraps>
...
80106dcd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106dd2:	e9 70 f4 ff ff       	jmp    80106247 <alltraps>
...
80106dd9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106dde:	e9 64 f4 ff ff       	jmp    80106247 <alltraps>
...
80106de5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106dea:	e9 58 f4 ff ff       	jmp    80106247 <alltraps>
...
80106df1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106df6:	e9 4c f4 ff ff       	jmp    80106247 <alltraps>
...
80106dfd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106e02:	e9 40 f4 ff ff       	jmp    80106247 <alltraps>
...
80106e09:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106e0e:	e9 34 f4 ff ff       	jmp    80106247 <alltraps>
...
80106e15:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106e1a:	e9 28 f4 ff ff       	jmp    80106247 <alltraps>
...
80106e21:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106e26:	e9 1c f4 ff ff       	jmp    80106247 <alltraps>
...
80106e2d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106e32:	e9 10 f4 ff ff       	jmp    80106247 <alltraps>
...
80106e39:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106e3e:	e9 04 f4 ff ff       	jmp    80106247 <alltraps>
...
80106e45:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106e4a:	e9 f8 f3 ff ff       	jmp    80106247 <alltraps>
...
80106e51:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106e56:	e9 ec f3 ff ff       	jmp    80106247 <alltraps>
...
80106e5d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106e62:	e9 e0 f3 ff ff       	jmp    80106247 <alltraps>
...
80106e69:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106e6e:	e9 d4 f3 ff ff       	jmp    80106247 <alltraps>
...
80106e75:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106e7a:	e9 c8 f3 ff ff       	jmp    80106247 <alltraps>
...
80106e81:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106e86:	e9 bc f3 ff ff       	jmp    80106247 <alltraps>
...
80106e8d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106e92:	e9 b0 f3 ff ff       	jmp    80106247 <alltraps>
...
80106e99:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106e9e:	e9 a4 f3 ff ff       	jmp    80106247 <alltraps>
...
80106ea5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106eaa:	e9 98 f3 ff ff       	jmp    80106247 <alltraps>
...
80106eb1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106eb6:	e9 8c f3 ff ff       	jmp    80106247 <alltraps>
...
80106ebd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106ec2:	e9 80 f3 ff ff       	jmp    80106247 <alltraps>
...
80106ec9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106ece:	e9 74 f3 ff ff       	jmp    80106247 <alltraps>
...
80106ed5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106eda:	e9 68 f3 ff ff       	jmp    80106247 <alltraps>
...
80106ee1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106ee6:	e9 5c f3 ff ff       	jmp    80106247 <alltraps>
...
80106eed:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106ef2:	e9 50 f3 ff ff       	jmp    80106247 <alltraps>
...
80106ef9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106efe:	e9 44 f3 ff ff       	jmp    80106247 <alltraps>
...
80106f05:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106f0a:	e9 38 f3 ff ff       	jmp    80106247 <alltraps>
...
80106f11:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106f16:	e9 2c f3 ff ff       	jmp    80106247 <alltraps>
...
80106f1d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106f22:	e9 20 f3 ff ff       	jmp    80106247 <alltraps>
...
80106f29:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106f2e:	e9 14 f3 ff ff       	jmp    80106247 <alltraps>
...
80106f35:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106f3a:	e9 08 f3 ff ff       	jmp    80106247 <alltraps>
...
80106f41:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106f46:	e9 fc f2 ff ff       	jmp    80106247 <alltraps>
...
80106f4d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106f52:	e9 f0 f2 ff ff       	jmp    80106247 <alltraps>
...
80106f59:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106f5e:	e9 e4 f2 ff ff       	jmp    80106247 <alltraps>
...
80106f65:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106f6a:	e9 d8 f2 ff ff       	jmp    80106247 <alltraps>
...
80106f71:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106f76:	e9 cc f2 ff ff       	jmp    80106247 <alltraps>
...
80106f7d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106f82:	e9 c0 f2 ff ff       	jmp    80106247 <alltraps>
...
80106f89:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106f8e:	e9 b4 f2 ff ff       	jmp    80106247 <alltraps>
...
80106f95:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106f9a:	e9 a8 f2 ff ff       	jmp    80106247 <alltraps>
...
80106fa1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106fa6:	e9 9c f2 ff ff       	jmp    80106247 <alltraps>
...
80106fad:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106fb2:	e9 90 f2 ff ff       	jmp    80106247 <alltraps>
...
80106fb9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106fbe:	e9 84 f2 ff ff       	jmp    80106247 <alltraps>
...
80106fc5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106fca:	e9 78 f2 ff ff       	jmp    80106247 <alltraps>
...
80106fd1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106fd6:	e9 6c f2 ff ff       	jmp    80106247 <alltraps>
...
80106fdd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106fe2:	e9 60 f2 ff ff       	jmp    80106247 <alltraps>
...
80106fe9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106fee:	e9 54 f2 ff ff       	jmp    80106247 <alltraps>
...
80106ff5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106ffa:	e9 48 f2 ff ff       	jmp    80106247 <alltraps>
...
80107001:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107006:	e9 3c f2 ff ff       	jmp    80106247 <alltraps>
...
8010700d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107012:	e9 30 f2 ff ff       	jmp    80106247 <alltraps>
...
80107019:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010701e:	e9 24 f2 ff ff       	jmp    80106247 <alltraps>
...
80107025:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010702a:	e9 18 f2 ff ff       	jmp    80106247 <alltraps>
...
80107031:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80107036:	e9 0c f2 ff ff       	jmp    80106247 <alltraps>
...
8010703d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80107042:	e9 00 f2 ff ff       	jmp    80106247 <alltraps>
...
80107049:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010704e:	e9 f4 f1 ff ff       	jmp    80106247 <alltraps>
...
80107055:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010705a:	e9 e8 f1 ff ff       	jmp    80106247 <alltraps>
...
80107061:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80107066:	e9 dc f1 ff ff       	jmp    80106247 <alltraps>
...
8010706d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80107072:	e9 d0 f1 ff ff       	jmp    80106247 <alltraps>
...
80107079:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010707e:	e9 c4 f1 ff ff       	jmp    80106247 <alltraps>
...
80107085:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010708a:	e9 b8 f1 ff ff       	jmp    80106247 <alltraps>
...
80107091:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107096:	e9 ac f1 ff ff       	jmp    80106247 <alltraps>
...
8010709d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801070a2:	e9 a0 f1 ff ff       	jmp    80106247 <alltraps>
...
801070a9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801070ae:	e9 94 f1 ff ff       	jmp    80106247 <alltraps>
...
801070b5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801070ba:	e9 88 f1 ff ff       	jmp    80106247 <alltraps>
...
801070c1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801070c6:	e9 7c f1 ff ff       	jmp    80106247 <alltraps>
...
801070cd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801070d2:	e9 70 f1 ff ff       	jmp    80106247 <alltraps>
...
801070d9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801070de:	e9 64 f1 ff ff       	jmp    80106247 <alltraps>
...
801070e5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801070ea:	e9 58 f1 ff ff       	jmp    80106247 <alltraps>
...
801070f1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801070f6:	e9 4c f1 ff ff       	jmp    80106247 <alltraps>
...
801070fd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107102:	e9 40 f1 ff ff       	jmp    80106247 <alltraps>
...
80107109:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010710e:	e9 34 f1 ff ff       	jmp    80106247 <alltraps>
...
80107115:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010711a:	e9 28 f1 ff ff       	jmp    80106247 <alltraps>
...
80107121:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80107126:	e9 1c f1 ff ff       	jmp    80106247 <alltraps>
...
8010712d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80107132:	e9 10 f1 ff ff       	jmp    80106247 <alltraps>
...
80107139:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010713e:	e9 04 f1 ff ff       	jmp    80106247 <alltraps>
...
80107145:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010714a:	e9 f8 f0 ff ff       	jmp    80106247 <alltraps>
...
80107151:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80107156:	e9 ec f0 ff ff       	jmp    80106247 <alltraps>
...
8010715d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80107162:	e9 e0 f0 ff ff       	jmp    80106247 <alltraps>
...
80107169:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010716e:	e9 d4 f0 ff ff       	jmp    80106247 <alltraps>
...
80107175:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010717a:	e9 c8 f0 ff ff       	jmp    80106247 <alltraps>
...
80107181:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107186:	e9 bc f0 ff ff       	jmp    80106247 <alltraps>
...
8010718d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107192:	e9 b0 f0 ff ff       	jmp    80106247 <alltraps>
...
80107199:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010719e:	e9 a4 f0 ff ff       	jmp    80106247 <alltraps>
...
801071a5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801071aa:	e9 98 f0 ff ff       	jmp    80106247 <alltraps>
...
801071b1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801071b6:	e9 8c f0 ff ff       	jmp    80106247 <alltraps>
...
801071bd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801071c2:	e9 80 f0 ff ff       	jmp    80106247 <alltraps>
...
801071d5:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
801071d6:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
801071dc:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
801071e2:	83 ec 1c             	sub    $0x1c,%esp
801071e5:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801071e8:	39 d3                	cmp    %edx,%ebx
801071ea:	73 49                	jae    80107235 <deallocuvm.part.0+0x65>
801071ec:	89 c7                	mov    %eax,%edi
801071ee:	eb 0c                	jmp    801071fc <deallocuvm.part.0+0x2c>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801071f0:	83 c0 01             	add    $0x1,%eax
801071f3:	c1 e0 16             	shl    $0x16,%eax
801071f6:	89 c3                	mov    %eax,%ebx
  for(; a  < oldsz; a += PGSIZE){
801071f8:	39 da                	cmp    %ebx,%edx
801071fa:	76 39                	jbe    80107235 <deallocuvm.part.0+0x65>
  pde = &pgdir[PDX(va)];
801071fc:	89 d8                	mov    %ebx,%eax
801071fe:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80107201:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
80107204:	f6 c1 01             	test   $0x1,%cl
80107207:	74 e7                	je     801071f0 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
80107209:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010720b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80107211:	c1 ee 0a             	shr    $0xa,%esi
80107214:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
8010721a:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
    if(!pte)
80107221:	85 f6                	test   %esi,%esi
80107223:	74 cb                	je     801071f0 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
80107225:	8b 06                	mov    (%esi),%eax
80107227:	a8 01                	test   $0x1,%al
80107229:	75 15                	jne    80107240 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
8010722b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107231:	39 da                	cmp    %ebx,%edx
80107233:	77 c7                	ja     801071fc <deallocuvm.part.0+0x2c>
      kfree(v);
      *pte = 0;
    }
  }
...
80107235:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
8010723f:	c3                   	ret    
      if(pa == 0)
80107240:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107245:	74 25                	je     8010726c <deallocuvm.part.0+0x9c>
      kfree(v);
80107247:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
8010724a:	05 00 00 00 80       	add    $0x80000000,%eax
8010724f:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80107252:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80107258:	50                   	push   %eax
80107259:	e8 62 b2 ff ff       	call   801024c0 <kfree>
      *pte = 0;
8010725e:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  for(; a  < oldsz; a += PGSIZE){
80107264:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107267:	83 c4 10             	add    $0x10,%esp
8010726a:	eb 8c                	jmp    801071f8 <deallocuvm.part.0+0x28>
        panic("kfree");
8010726c:	83 ec 0c             	sub    $0xc,%esp
8010726f:	68 26 7e 10 80       	push   $0x80107e26
...
80107286:	89 d3                	mov    %edx,%ebx
80107288:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
{
8010728e:	83 ec 1c             	sub    $0x1c,%esp
80107291:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80107294:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
80107298:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010729d:	89 45 dc             	mov    %eax,-0x24(%ebp)
801072a0:	8b 45 08             	mov    0x8(%ebp),%eax
801072a3:	29 d8                	sub    %ebx,%eax
801072a5:	89 45 e0             	mov    %eax,-0x20(%ebp)
801072a8:	eb 3d                	jmp    801072e7 <mappages+0x67>
801072aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
801072b0:	89 da                	mov    %ebx,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
...
801072c9:	74 75                	je     80107340 <mappages+0xc0>
    if(*pte & PTE_P)
801072cb:	f6 00 01             	testb  $0x1,(%eax)
801072ce:	0f 85 86 00 00 00    	jne    8010735a <mappages+0xda>
    *pte = pa | perm | PTE_P;
801072d4:	0b 75 0c             	or     0xc(%ebp),%esi
801072d7:	83 ce 01             	or     $0x1,%esi
801072da:	89 30                	mov    %esi,(%eax)
    if(a == last)
801072dc:	3b 5d dc             	cmp    -0x24(%ebp),%ebx
801072df:	74 6f                	je     80107350 <mappages+0xd0>
    a += PGSIZE;
801072e1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
801072e7:	8b 45 e0             	mov    -0x20(%ebp),%eax
  pde = &pgdir[PDX(va)];
801072ea:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801072ed:	8d 34 18             	lea    (%eax,%ebx,1),%esi
801072f0:	89 d8                	mov    %ebx,%eax
801072f2:	c1 e8 16             	shr    $0x16,%eax
801072f5:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
801072f8:	8b 07                	mov    (%edi),%eax
801072fa:	a8 01                	test   $0x1,%al
801072fc:	75 b2                	jne    801072b0 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
801072fe:	e8 7d b3 ff ff       	call   80102680 <kalloc>
80107303:	85 c0                	test   %eax,%eax
80107305:	74 39                	je     80107340 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80107307:	83 ec 04             	sub    $0x4,%esp
8010730a:	89 45 d8             	mov    %eax,-0x28(%ebp)
8010730d:	68 00 10 00 00       	push   $0x1000
80107312:	6a 00                	push   $0x0
80107314:	50                   	push   %eax
80107315:	e8 56 db ff ff       	call   80104e70 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010731a:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
8010731d:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80107320:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80107326:	83 c8 07             	or     $0x7,%eax
80107329:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
8010732b:	89 d8                	mov    %ebx,%eax
8010732d:	c1 e8 0a             	shr    $0xa,%eax
80107330:	25 fc 0f 00 00       	and    $0xffc,%eax
80107335:	01 d0                	add    %edx,%eax
80107337:	eb 92                	jmp    801072cb <mappages+0x4b>
...
8010735d:	68 1c 85 10 80       	push   $0x8010851c
80107362:	e8 19 90 ff ff       	call   80100380 <panic>
...
80107373:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80107376:	e8 f5 c5 ff ff       	call   80103970 <cpuid>
  pd[0] = size-1;
8010737b:	ba 2f 00 00 00       	mov    $0x2f,%edx
80107380:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80107386:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010738a:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
80107391:	ff 00 00 
80107394:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
8010739b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010739e:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
801073a5:	ff 00 00 
801073a8:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
801073af:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801073b2:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
801073b9:	ff 00 00 
801073bc:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
801073c3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801073c6:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
801073cd:	ff 00 00 
801073d0:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
801073d7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801073da:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
801073df:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
801073e3:	c1 e8 10             	shr    $0x10,%eax
801073e6:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
801073ea:	8d 45 f2             	lea    -0xe(%ebp),%eax
801073ed:	0f 01 10             	lgdtl  (%eax)
}
801073f0:	c9                   	leave  
801073f1:	c3                   	ret    
...
80107400:	a1 44 5f 11 80       	mov    0x80115f44,%eax
80107405:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
8010741e:	0f 84 cb 00 00 00    	je     801074ef <switchuvm+0xdf>
  if(p->kstack == 0)
80107424:	8b 46 08             	mov    0x8(%esi),%eax
80107427:	85 c0                	test   %eax,%eax
80107429:	0f 84 da 00 00 00    	je     80107509 <switchuvm+0xf9>
  if(p->pgdir == 0)
8010742f:	8b 46 04             	mov    0x4(%esi),%eax
80107432:	85 c0                	test   %eax,%eax
80107434:	0f 84 c2 00 00 00    	je     801074fc <switchuvm+0xec>
  pushcli();
8010743a:	e8 21 d8 ff ff       	call   80104c60 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010743f:	e8 cc c4 ff ff       	call   80103910 <mycpu>
80107444:	89 c3                	mov    %eax,%ebx
80107446:	e8 c5 c4 ff ff       	call   80103910 <mycpu>
8010744b:	89 c7                	mov    %eax,%edi
8010744d:	e8 be c4 ff ff       	call   80103910 <mycpu>
80107452:	83 c7 08             	add    $0x8,%edi
80107455:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107458:	e8 b3 c4 ff ff       	call   80103910 <mycpu>
8010745d:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80107460:	ba 67 00 00 00       	mov    $0x67,%edx
80107465:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
8010746c:	83 c0 08             	add    $0x8,%eax
8010746f:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107476:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010747b:	83 c1 08             	add    $0x8,%ecx
8010747e:	c1 e8 18             	shr    $0x18,%eax
80107481:	c1 e9 10             	shr    $0x10,%ecx
80107484:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
8010748a:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80107490:	b9 99 40 00 00       	mov    $0x4099,%ecx
80107495:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010749c:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
801074a1:	e8 6a c4 ff ff       	call   80103910 <mycpu>
801074a6:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801074ad:	e8 5e c4 ff ff       	call   80103910 <mycpu>
801074b2:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
801074b6:	8b 5e 08             	mov    0x8(%esi),%ebx
801074b9:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801074bf:	e8 4c c4 ff ff       	call   80103910 <mycpu>
801074c4:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801074c7:	e8 44 c4 ff ff       	call   80103910 <mycpu>
801074cc:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
801074d0:	b8 28 00 00 00       	mov    $0x28,%eax
801074d5:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
801074d8:	8b 46 04             	mov    0x4(%esi),%eax
801074db:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
801074e0:	0f 22 d8             	mov    %eax,%cr3
}
...
801074e9:	5d                   	pop    %ebp
  popcli();
801074ea:	e9 c1 d7 ff ff       	jmp    80104cb0 <popcli>
    panic("switchuvm: no process");
801074ef:	83 ec 0c             	sub    $0xc,%esp
801074f2:	68 22 85 10 80       	push   $0x80108522
801074f7:	e8 84 8e ff ff       	call   80100380 <panic>
    panic("switchuvm: no pgdir");
801074fc:	83 ec 0c             	sub    $0xc,%esp
801074ff:	68 4d 85 10 80       	push   $0x8010854d
80107504:	e8 77 8e ff ff       	call   80100380 <panic>
    panic("switchuvm: no kstack");
80107509:	83 ec 0c             	sub    $0xc,%esp
8010750c:	68 38 85 10 80       	push   $0x80108538
...
8010752c:	8b 75 10             	mov    0x10(%ebp),%esi
8010752f:	8b 7d 08             	mov    0x8(%ebp),%edi
80107532:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80107535:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
8010753b:	77 4b                	ja     80107588 <inituvm+0x68>
  mem = kalloc();
8010753d:	e8 3e b1 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
8010754f:	e8 1c d9 ff ff       	call   80104e70 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80107554:	58                   	pop    %eax
80107555:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010755b:	5a                   	pop    %edx
8010755c:	6a 06                	push   $0x6
8010755e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107563:	31 d2                	xor    %edx,%edx
80107565:	50                   	push   %eax
80107566:	89 f8                	mov    %edi,%eax
80107568:	e8 13 fd ff ff       	call   80107280 <mappages>
  memmove(mem, init, sz);
8010756d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80107570:	89 75 10             	mov    %esi,0x10(%ebp)
80107573:	83 c4 10             	add    $0x10,%esp
80107576:	89 5d 08             	mov    %ebx,0x8(%ebp)
80107579:	89 45 0c             	mov    %eax,0xc(%ebp)
}
8010757c:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010757f:	5b                   	pop    %ebx
80107580:	5e                   	pop    %esi
80107581:	5f                   	pop    %edi
80107582:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107583:	e9 88 d9 ff ff       	jmp    80104f10 <memmove>
    panic("inituvm: more than a page");
80107588:	83 ec 0c             	sub    $0xc,%esp
8010758b:	68 61 85 10 80       	push   $0x80108561
80107590:	e8 eb 8d ff ff       	call   80100380 <panic>
80107595:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801075ac:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
801075af:	a9 ff 0f 00 00       	test   $0xfff,%eax
801075b4:	0f 85 bb 00 00 00    	jne    80107675 <loaduvm+0xd5>
  for(i = 0; i < sz; i += PGSIZE){
801075ba:	01 f0                	add    %esi,%eax
801075bc:	89 f3                	mov    %esi,%ebx
801075be:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
801075c1:	8b 45 14             	mov    0x14(%ebp),%eax
801075c4:	01 f0                	add    %esi,%eax
801075c6:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
801075c9:	85 f6                	test   %esi,%esi
801075cb:	0f 84 87 00 00 00    	je     80107658 <loaduvm+0xb8>
801075d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
801075d8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  if(*pde & PTE_P){
801075db:	8b 4d 08             	mov    0x8(%ebp),%ecx
801075de:	29 d8                	sub    %ebx,%eax
  pde = &pgdir[PDX(va)];
801075e0:	89 c2                	mov    %eax,%edx
801075e2:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
801075e5:	8b 14 91             	mov    (%ecx,%edx,4),%edx
801075e8:	f6 c2 01             	test   $0x1,%dl
801075eb:	75 13                	jne    80107600 <loaduvm+0x60>
      panic("loaduvm: address should exist");
801075ed:	83 ec 0c             	sub    $0xc,%esp
801075f0:	68 7b 85 10 80       	push   $0x8010857b
801075f5:	e8 86 8d ff ff       	call   80100380 <panic>
801075fa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80107600:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107603:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80107609:	25 fc 0f 00 00       	and    $0xffc,%eax
8010760e:	8d 84 02 00 00 00 80 	lea    -0x80000000(%edx,%eax,1),%eax
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107615:	85 c0                	test   %eax,%eax
80107617:	74 d4                	je     801075ed <loaduvm+0x4d>
    pa = PTE_ADDR(*pte);
...
8010763b:	ff 75 10             	push   0x10(%ebp)
8010763e:	e8 4d a4 ff ff       	call   80101a90 <readi>
80107643:	83 c4 10             	add    $0x10,%esp
80107646:	39 f8                	cmp    %edi,%eax
80107648:	75 1e                	jne    80107668 <loaduvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
8010764a:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80107650:	89 f0                	mov    %esi,%eax
80107652:	29 d8                	sub    %ebx,%eax
80107654:	39 c6                	cmp    %eax,%esi
80107656:	77 80                	ja     801075d8 <loaduvm+0x38>
}
...
80107678:	68 1c 86 10 80       	push   $0x8010861c
8010767d:	e8 fe 8c ff ff       	call   80100380 <panic>
...
80107696:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
80107699:	8b 45 10             	mov    0x10(%ebp),%eax
{
8010769c:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
8010769f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801076a2:	85 c0                	test   %eax,%eax
801076a4:	0f 88 b6 00 00 00    	js     80107760 <allocuvm+0xd0>
  if(newsz < oldsz)
801076aa:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
801076ad:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
801076b0:	0f 82 9a 00 00 00    	jb     80107750 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
801076b6:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
801076bc:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
801076c2:	39 75 10             	cmp    %esi,0x10(%ebp)
801076c5:	77 44                	ja     8010770b <allocuvm+0x7b>
801076c7:	e9 87 00 00 00       	jmp    80107753 <allocuvm+0xc3>
...
801076db:	e8 90 d7 ff ff       	call   80104e70 <memset>
...
801076f4:	e8 87 fb ff ff       	call   80107280 <mappages>
...
80107709:	76 48                	jbe    80107753 <allocuvm+0xc3>
    mem = kalloc();
8010770b:	e8 70 af ff ff       	call   80102680 <kalloc>
...
80107719:	68 99 85 10 80       	push   $0x80108599
8010771e:	e8 7d 8f ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
80107735:	e8 96 fa ff ff       	call   801071d0 <deallocuvm.part.0>
      return 0;
...
8010777b:	68 b1 85 10 80       	push   $0x801085b1
80107780:	e8 1b 8f ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
80107797:	e8 34 fa ff ff       	call   801071d0 <deallocuvm.part.0>
      kfree(mem);
8010779c:	83 ec 0c             	sub    $0xc,%esp
8010779f:	53                   	push   %ebx
801077a0:	e8 1b ad ff ff       	call   801024c0 <kfree>
      return 0;
...
801077d0:	5d                   	pop    %ebp
801077d1:	e9 fa f9 ff ff       	jmp    801071d0 <deallocuvm.part.0>
...
80107809:	89 f3                	mov    %esi,%ebx
8010780b:	e8 c0 f9 ff ff       	call   801071d0 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80107810:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80107816:	eb 0f                	jmp    80107827 <freevm+0x37>
80107818:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010781f:	90                   	nop
...
8010783e:	e8 7d ac ff ff       	call   801024c0 <kfree>
...
80107853:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107854:	e9 67 ac ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80107859:	83 ec 0c             	sub    $0xc,%esp
8010785c:	68 cd 85 10 80       	push   $0x801085cd
...
80107875:	e8 06 ae ff ff       	call   80102680 <kalloc>
8010787a:	89 c6                	mov    %eax,%esi
...
80107890:	e8 db d5 ff ff       	call   80104e70 <memset>
...
801078ab:	e8 d0 f9 ff ff       	call   80107280 <mappages>
...
801078fb:	a3 44 5f 11 80       	mov    %eax,0x80115f44
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107916:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80107919:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
8010791c:	89 c1                	mov    %eax,%ecx
8010791e:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80107921:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
80107924:	f6 c2 01             	test   $0x1,%dl
80107927:	75 17                	jne    80107940 <clearpteu+0x30>
  pte_t *pte;
...
8010792c:	68 de 85 10 80       	push   $0x801085de
80107931:	e8 4a 8a ff ff       	call   80100380 <panic>
80107936:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010793d:	8d 76 00             	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80107940:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107943:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80107949:	25 fc 0f 00 00       	and    $0xffc,%eax
8010794e:	8d 84 02 00 00 00 80 	lea    -0x80000000(%edx,%eax,1),%eax
  if(pte == 0)
80107955:	85 c0                	test   %eax,%eax
80107957:	74 d0                	je     80107929 <clearpteu+0x19>
  *pte &= ~PTE_U;
80107959:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
8010795c:	c9                   	leave  
8010795d:	c3                   	ret    
...
80107966:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80107969:	e8 02 ff ff ff       	call   80107870 <setupkvm>
8010796e:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107971:	85 c0                	test   %eax,%eax
80107973:	0f 84 bd 00 00 00    	je     80107a36 <copyuvm+0xd6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107979:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010797c:	85 c9                	test   %ecx,%ecx
8010797e:	0f 84 b2 00 00 00    	je     80107a36 <copyuvm+0xd6>
80107984:	31 f6                	xor    %esi,%esi
80107986:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010798d:	8d 76 00             	lea    0x0(%esi),%esi
  if(*pde & PTE_P){
80107990:	8b 4d 08             	mov    0x8(%ebp),%ecx
  pde = &pgdir[PDX(va)];
80107993:	89 f0                	mov    %esi,%eax
80107995:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80107998:	8b 04 81             	mov    (%ecx,%eax,4),%eax
8010799b:	a8 01                	test   $0x1,%al
8010799d:	75 11                	jne    801079b0 <copyuvm+0x50>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
8010799f:	83 ec 0c             	sub    $0xc,%esp
801079a2:	68 e8 85 10 80       	push   $0x801085e8
801079a7:	e8 d4 89 ff ff       	call   80100380 <panic>
801079ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  return &pgtab[PTX(va)];
801079b0:	89 f2                	mov    %esi,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
...
801079c9:	74 d4                	je     8010799f <copyuvm+0x3f>
    if(!(*pte & PTE_P))
801079cb:	8b 00                	mov    (%eax),%eax
801079cd:	a8 01                	test   $0x1,%al
801079cf:	0f 84 9f 00 00 00    	je     80107a74 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
801079d5:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
801079d7:	25 ff 0f 00 00       	and    $0xfff,%eax
801079dc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
801079df:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
801079e5:	e8 96 ac ff ff       	call   80102680 <kalloc>
801079ea:	89 c3                	mov    %eax,%ebx
801079ec:	85 c0                	test   %eax,%eax
801079ee:	74 64                	je     80107a54 <copyuvm+0xf4>
      goto bad;
...
80107a36:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80107a4c:	e8 6f aa ff ff       	call   801024c0 <kfree>
      goto bad;
80107a51:	83 c4 10             	add    $0x10,%esp
  freevm(d);
80107a54:	83 ec 0c             	sub    $0xc,%esp
80107a57:	ff 75 e0             	push   -0x20(%ebp)
80107a5a:	e8 91 fd ff ff       	call   801077f0 <freevm>
  return 0;
80107a5f:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
80107a66:	83 c4 10             	add    $0x10,%esp
}
80107a69:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107a6c:	8d 65 f4             	lea    -0xc(%ebp),%esp
80107a6f:	5b                   	pop    %ebx
80107a70:	5e                   	pop    %esi
80107a71:	5f                   	pop    %edi
80107a72:	5d                   	pop    %ebp
...
80107a77:	68 02 86 10 80       	push   $0x80108602
80107a7c:	e8 ff 88 ff ff       	call   80100380 <panic>
...
80107a93:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80107a96:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
80107a99:	89 c1                	mov    %eax,%ecx
80107a9b:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80107a9e:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
80107aa1:	f6 c2 01             	test   $0x1,%dl
80107aa4:	0f 84 00 01 00 00    	je     80107baa <uva2ka.cold>
  return &pgtab[PTX(va)];
80107aaa:	c1 e8 0c             	shr    $0xc,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107aad:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  if((*pte & PTE_P) == 0)
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
80107ab3:	5d                   	pop    %ebp
  return &pgtab[PTX(va)];
80107ab4:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
80107ab9:	8b 84 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%eax
  if((*pte & PTE_U) == 0)
80107ac0:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107ac2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
80107ac7:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107aca:	05 00 00 00 80       	add    $0x80000000,%eax
80107acf:	83 fa 05             	cmp    $0x5,%edx
80107ad2:	ba 00 00 00 00       	mov    $0x0,%edx
80107ad7:	0f 45 c2             	cmovne %edx,%eax
}
80107ada:	c3                   	ret    
...
80107ae9:	8b 75 14             	mov    0x14(%ebp),%esi
80107aec:	8b 45 0c             	mov    0xc(%ebp),%eax
80107aef:	8b 55 10             	mov    0x10(%ebp),%edx
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80107af2:	85 f6                	test   %esi,%esi
80107af4:	75 51                	jne    80107b47 <copyout+0x67>
80107af6:	e9 a5 00 00 00       	jmp    80107ba0 <copyout+0xc0>
80107afb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107aff:	90                   	nop
  return (char*)P2V(PTE_ADDR(*pte));
80107b00:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80107b06:	8d 8b 00 00 00 80    	lea    -0x80000000(%ebx),%ecx
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
80107b0c:	81 fb 00 00 00 80    	cmp    $0x80000000,%ebx
80107b12:	74 75                	je     80107b89 <copyout+0xa9>
      return -1;
    n = PGSIZE - (va - va0);
80107b14:	89 fb                	mov    %edi,%ebx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80107b16:	89 55 10             	mov    %edx,0x10(%ebp)
    n = PGSIZE - (va - va0);
80107b19:	29 c3                	sub    %eax,%ebx
80107b1b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107b21:	39 f3                	cmp    %esi,%ebx
80107b23:	0f 47 de             	cmova  %esi,%ebx
    memmove(pa0 + (va - va0), buf, n);
80107b26:	29 f8                	sub    %edi,%eax
80107b28:	83 ec 04             	sub    $0x4,%esp
80107b2b:	01 c1                	add    %eax,%ecx
80107b2d:	53                   	push   %ebx
80107b2e:	52                   	push   %edx
80107b2f:	51                   	push   %ecx
80107b30:	e8 db d3 ff ff       	call   80104f10 <memmove>
    len -= n;
    buf += n;
80107b35:	8b 55 10             	mov    0x10(%ebp),%edx
    va = va0 + PGSIZE;
80107b38:	8d 87 00 10 00 00    	lea    0x1000(%edi),%eax
  while(len > 0){
80107b3e:	83 c4 10             	add    $0x10,%esp
    buf += n;
80107b41:	01 da                	add    %ebx,%edx
  while(len > 0){
80107b43:	29 de                	sub    %ebx,%esi
80107b45:	74 59                	je     80107ba0 <copyout+0xc0>
  if(*pde & PTE_P){
80107b47:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pde = &pgdir[PDX(va)];
...
80107b4e:	c1 e9 16             	shr    $0x16,%ecx
    va0 = (uint)PGROUNDDOWN(va);
80107b51:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  if(*pde & PTE_P){
80107b57:	8b 0c 8b             	mov    (%ebx,%ecx,4),%ecx
80107b5a:	f6 c1 01             	test   $0x1,%cl
80107b5d:	0f 84 4e 00 00 00    	je     80107bb1 <copyout.cold>
  return &pgtab[PTX(va)];
80107b63:	89 fb                	mov    %edi,%ebx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107b65:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80107b6b:	c1 eb 0c             	shr    $0xc,%ebx
80107b6e:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
  if((*pte & PTE_P) == 0)
80107b74:	8b 9c 99 00 00 00 80 	mov    -0x80000000(%ecx,%ebx,4),%ebx
  if((*pte & PTE_U) == 0)
80107b7b:	89 d9                	mov    %ebx,%ecx
80107b7d:	83 e1 05             	and    $0x5,%ecx
80107b80:	83 f9 05             	cmp    $0x5,%ecx
80107b83:	0f 84 77 ff ff ff    	je     80107b00 <copyout+0x20>
  }
  return 0;
}
...
80107baa <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
80107baa:	a1 00 00 00 00       	mov    0x0,%eax
80107baf:	0f 0b                	ud2    

80107bb1 <copyout.cold>:
80107bb1:	a1 00 00 00 00       	mov    0x0,%eax
80107bb6:	0f 0b                	ud2    

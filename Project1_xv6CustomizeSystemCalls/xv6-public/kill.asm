 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b5:	57                   	push   %edi
 4b6:	56                   	push   %esi
 4b7:	e8 17 fe ff ff       	call   2d3 <write>
 ...
 50e:	e8 c0 fd ff ff       	call   2d3 <write>
        putc(fd, c);
 ...
 51f:	57                   	push   %edi
 520:	56                   	push   %esi
 521:	e8 ad fd ff ff       	call   2d3 <write>
        putc(fd, c);
 ...
 5cc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5cf:	e8 ff fc ff ff       	call   2d3 <write>
        ap++;
 ...
 611:	a1 c4 0a 00 00       	mov    0xac4,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 c4 0a 00 00    	mov    %edx,0xac4
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 c4 0a 00 00    	mov    %edx,0xac4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d c4 0a 00 00    	mov    0xac4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d c4 0a 00 00    	mov    0xac4,%edi
 ...
 703:	e8 33 fc ff ff       	call   33b <sbrk>
  if(p == (char*)-1)
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 c4 0a 00 00    	mov    0xac4,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 c4 0a 00 00    	mov    %edx,0xac4
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 c4 0a 00 00 c8 	movl   $0xac8,0xac4
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf c8 0a 00 00       	mov    $0xac8,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 c8 0a 00 00 c8 	movl   $0xac8,0xac8
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 cc 0a 00 00 00 	movl   $0x0,0xacc
 782:	00 00 00 
    if(p->s.size >= nunits){

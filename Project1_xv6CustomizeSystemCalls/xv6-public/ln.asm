 ...
 611:	a1 cc 0a 00 00       	mov    0xacc,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 cc 0a 00 00    	mov    %edx,0xacc
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 cc 0a 00 00    	mov    %edx,0xacc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d cc 0a 00 00    	mov    0xacc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d cc 0a 00 00    	mov    0xacc,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 cc 0a 00 00    	mov    0xacc,%edx
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf d0 0a 00 00       	mov    $0xad0,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 d4 0a 00 00 00 	movl   $0x0,0xad4
 782:	00 00 00 
    if(p->s.size >= nunits){

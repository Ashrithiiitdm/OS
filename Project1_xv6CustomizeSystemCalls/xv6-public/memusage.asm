 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 7c 08 00 00 	movzbl 0x87c(%edx),%edx
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 24 08 00 00 	jmp    *0x824(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba 1a 08 00 00       	mov    $0x81a,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 28 0b 00 00       	mov    0xb28,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 28 0b 00 00    	mov    %edx,0xb28
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 28 0b 00 00    	mov    %edx,0xb28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d 28 0b 00 00    	mov    0xb28,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d 28 0b 00 00    	mov    0xb28,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 28 0b 00 00    	mov    0xb28,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 28 0b 00 00    	mov    %edx,0xb28
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 28 0b 00 00 2c 	movl   $0xb2c,0xb28
 767:	0b 00 00 
    base.s.size = 0;
 76a:	bf 2c 0b 00 00       	mov    $0xb2c,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 2c 0b 00 00 2c 	movl   $0xb2c,0xb2c
 776:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 30 0b 00 00 00 	movl   $0x0,0xb30
 782:	00 00 00 
    if(p->s.size >= nunits){

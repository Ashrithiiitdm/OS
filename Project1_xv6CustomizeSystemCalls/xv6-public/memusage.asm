...
int main(int argc, char *argv[]){
  ...
  41:	50                   	push   %eax
  42:	e8 54 03 00 00       	call   39b <mem_usage>
 ...
 3ec:	89 d1                	mov    %edx,%ecx
{
 ...
 419:	0f b6 92 9c 08 00 00 	movzbl 0x89c(%edx),%edx
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 44 08 00 00 	jmp    *0x844(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba 3a 08 00 00       	mov    $0x83a,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 48 0b 00 00       	mov    0xb48,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 48 0b 00 00    	mov    %edx,0xb48
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 48 0b 00 00    	mov    %edx,0xb48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 48 0b 00 00    	mov    0xb48,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 48 0b 00 00    	mov    0xb48,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 48 0b 00 00    	mov    0xb48,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 48 0b 00 00    	mov    %edx,0xb48
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 48 0b 00 00 4c 	movl   $0xb4c,0xb48
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 4c 0b 00 00       	mov    $0xb4c,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 4c 0b 00 00 4c 	movl   $0xb4c,0xb4c
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 50 0b 00 00 00 	movl   $0x0,0xb50
 7a2:	00 00 00 
    if(p->s.size >= nunits){

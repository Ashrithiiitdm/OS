...
_ps_ash:     file format elf32-i386
...
0000034b <sem_signal>:
SYSCALL(sem_signal)
 34b:	b8 21 00 00 00       	mov    $0x21,%eax
 350:	cd 40                	int    $0x40
 352:	c3                   	ret    

00000353 <getppid>:
 353:	b8 22 00 00 00       	mov    $0x22,%eax
 358:	cd 40                	int    $0x40
 35a:	c3                   	ret    
 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 3de:	56                   	push   %esi
 3df:	57                   	push   %edi
 3e0:	e8 9e fe ff ff       	call   283 <write>
  while(--i >= 0)
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 455:	57                   	push   %edi
 456:	56                   	push   %esi
 457:	e8 27 fe ff ff       	call   283 <write>
 ...
 4ae:	e8 d0 fd ff ff       	call   283 <write>
        putc(fd, c);
 ...
 4bf:	57                   	push   %edi
 4c0:	56                   	push   %esi
 4c1:	e8 bd fd ff ff       	call   283 <write>
        putc(fd, c);
 ...
 52b:	57                   	push   %edi
 52c:	56                   	push   %esi
 52d:	e8 51 fd ff ff       	call   283 <write>
        while(*s != 0){
 ...
 56c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 56f:	e8 0f fd ff ff       	call   283 <write>
        ap++;
 ...
 5b1:	a1 38 0a 00 00       	mov    0xa38,%eax
{
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 38 0a 00 00    	mov    %edx,0xa38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 38 0a 00 00    	mov    0xa38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 38 0a 00 00    	mov    0xa38,%edi
 ...
 6a3:	e8 43 fc ff ff       	call   2eb <sbrk>
  if(p == (char*)-1)
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 38 0a 00 00    	mov    0xa38,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 38 0a 00 00    	mov    %edx,0xa38
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 38 0a 00 00 3c 	movl   $0xa3c,0xa38
 707:	0a 00 00 
    base.s.size = 0;
 70a:	bf 3c 0a 00 00       	mov    $0xa3c,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 3c 0a 00 00 3c 	movl   $0xa3c,0xa3c
 716:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 40 0a 00 00 00 	movl   $0x0,0xa40
 722:	00 00 00 
    if(p->s.size >= nunits){

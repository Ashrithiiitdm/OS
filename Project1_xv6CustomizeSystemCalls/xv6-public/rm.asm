 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 ec 07 00 00 	jmp    *0x7ec(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba e5 07 00 00       	mov    $0x7e5,%edx
        while(*s != 0){
 ...
 631:	a1 fc 0a 00 00       	mov    0xafc,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 fc 0a 00 00    	mov    %edx,0xafc
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 fc 0a 00 00    	mov    %edx,0xafc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 fc 0a 00 00    	mov    0xafc,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 fc 0a 00 00    	mov    %edx,0xafc
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 fc 0a 00 00 00 	movl   $0xb00,0xafc
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 00 0b 00 00       	mov    $0xb00,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 00 0b 00 00 00 	movl   $0xb00,0xb00
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){

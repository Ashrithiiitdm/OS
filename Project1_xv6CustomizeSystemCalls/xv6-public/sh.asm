...
00000efb <sem_destroy>:
SYSCALL(sem_destroy)
     efb:	b8 1f 00 00 00       	mov    $0x1f,%eax
     f00:	cd 40                	int    $0x40
     f02:	c3                   	ret    

00000f03 <sem_wait>:
SYSCALL(sem_wait)
     f03:	b8 20 00 00 00       	mov    $0x20,%eax
     f08:	cd 40                	int    $0x40
     f0a:	c3                   	ret    

00000f0b <sem_signal>:
SYSCALL(sem_signal)
     f0b:	b8 21 00 00 00       	mov    $0x21,%eax
     f10:	cd 40                	int    $0x40
     f12:	c3                   	ret    

00000f13 <getppid>:
     f13:	b8 22 00 00 00       	mov    $0x22,%eax
     f18:	cd 40                	int    $0x40
     f1a:	c3                   	ret    

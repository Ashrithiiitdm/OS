...
int main(int argc, char *argv[]){
  ...
  2e:	83 c3 01             	add    $0x1,%ebx
		printf(1, "%s", argv[i]);
  31:	68 b8 07 00 00       	push   $0x7b8
  36:	6a 01                	push   $0x1
  38:	e8 43 04 00 00       	call   480 <printf>
	for(i = 1; i < argc; i++){
  3d:	83 c4 10             	add    $0x10,%esp
  40:	39 de                	cmp    %ebx,%esi
  42:	75 e4                	jne    28 <main+0x28>
	}

	printf(1, "\n");
  44:	83 ec 08             	sub    $0x8,%esp
  47:	68 bb 07 00 00       	push   $0x7bb
  4c:	6a 01                	push   $0x1
  4e:	e8 2d 04 00 00       	call   480 <printf>
	exit();
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 c4 07 00 00 	jmp    *0x7c4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba bd 07 00 00       	mov    $0x7bd,%edx
        while(*s != 0){
 ...
 621:	a1 d4 0a 00 00       	mov    0xad4,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 d4 0a 00 00    	mov    %edx,0xad4
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 d4 0a 00 00    	mov    %edx,0xad4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d d4 0a 00 00    	mov    0xad4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d d4 0a 00 00    	mov    0xad4,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 d4 0a 00 00    	mov    0xad4,%edx
 ...
 75c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 75f:	89 15 d4 0a 00 00    	mov    %edx,0xad4
}
 ...
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf d8 0a 00 00       	mov    $0xad8,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 d8 0a 00 00 d8 	movl   $0xad8,0xad8
 786:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 dc 0a 00 00 00 	movl   $0x0,0xadc
 792:	00 00 00 
    if(p->s.size >= nunits){

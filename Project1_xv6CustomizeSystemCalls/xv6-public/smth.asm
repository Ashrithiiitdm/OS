 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 8d 07 00 00       	mov    $0x78d,%edx
        while(*s != 0){
 ...
 5f1:	a1 a4 0a 00 00       	mov    0xaa4,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 a4 0a 00 00    	mov    %edx,0xaa4
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 a4 0a 00 00    	mov    %edx,0xaa4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d a4 0a 00 00    	mov    0xaa4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d a4 0a 00 00    	mov    0xaa4,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 a4 0a 00 00    	mov    0xaa4,%edx
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 72f:	89 15 a4 0a 00 00    	mov    %edx,0xaa4
}
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 a4 0a 00 00 a8 	movl   $0xaa8,0xaa4
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf a8 0a 00 00       	mov    $0xaa8,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 a8 0a 00 00 a8 	movl   $0xaa8,0xaa8
 756:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 ac 0a 00 00 00 	movl   $0x0,0xaac
 762:	00 00 00 
    if(p->s.size >= nunits){

 ...
 4ac:	89 d1                	mov    %edx,%ecx
{
 ...
 4d9:	0f b6 92 fc 08 00 00 	movzbl 0x8fc(%edx),%edx
 ...
 559:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 595:	57                   	push   %edi
 596:	56                   	push   %esi
 597:	e8 17 fe ff ff       	call   3b3 <write>
 ...
 5c9:	ff 24 85 a4 08 00 00 	jmp    *0x8a4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5ee:	e8 c0 fd ff ff       	call   3b3 <write>
        putc(fd, c);
 ...
 5ff:	57                   	push   %edi
 600:	56                   	push   %esi
 601:	e8 ad fd ff ff       	call   3b3 <write>
        putc(fd, c);
 ...
 66b:	57                   	push   %edi
 66c:	56                   	push   %esi
 66d:	e8 41 fd ff ff       	call   3b3 <write>
        while(*s != 0){
 ...
 6ac:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6af:	e8 ff fc ff ff       	call   3b3 <write>
        ap++;
 ...
 6d7:	90                   	nop
          s = "(null)";
 6d8:	ba 9b 08 00 00       	mov    $0x89b,%edx
        while(*s != 0){
 ...
 6f1:	a1 b4 0b 00 00       	mov    0xbb4,%eax
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	89 15 b4 0b 00 00    	mov    %edx,0xbb4
}
 738:	5e                   	pop    %esi
 739:	5f                   	pop    %edi
 73a:	5d                   	pop    %ebp
 ...
 769:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 76c:	89 15 b4 0b 00 00    	mov    %edx,0xbb4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 3d b4 0b 00 00    	mov    0xbb4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 4f                	jae    820 <malloc+0xa0>
    ...
    if(p == freep)
 7d1:	8b 3d b4 0b 00 00    	mov    0xbb4,%edi
 ...
 7e3:	e8 33 fc ff ff       	call   41b <sbrk>
  if(p == (char*)-1)
 ...
 7fa:	e8 f1 fe ff ff       	call   6f0 <free>
  return freep;
 7ff:	8b 15 b4 0b 00 00    	mov    0xbb4,%edx
 ...
 82c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 82f:	89 15 b4 0b 00 00    	mov    %edx,0xbb4
}
 ...
 847:	0b 00 00 
    base.s.size = 0;
 84a:	bf b8 0b 00 00       	mov    $0xbb8,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 b8 0b 00 00 b8 	movl   $0xbb8,0xbb8
 856:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){

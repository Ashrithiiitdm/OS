...
int main(int argc, char *argv[]){
  ...
  14:	83 ec 10             	sub    $0x10,%esp
    ...
    for (int i = 0; i < 3; i++) { // Create 3 background processes
        pid = fork();
  17:	e8 9f 02 00 00       	call   2bb <fork>
        if (pid < 0) {
  1c:	85 c0                	test   %eax,%eax
  1e:	78 11                	js     31 <main+0x31>
            printf(1, "Fork failed\n");
            exit();
        } else if (pid == 0) {
  20:	74 22                	je     44 <main+0x44>
    for (int i = 0; i < 3; i++) { // Create 3 background processes
  22:	83 eb 01             	sub    $0x1,%ebx
  25:	75 f0                	jne    17 <main+0x17>
    ...
    cps();
  27:	e8 37 03 00 00       	call   363 <cps>
    exit();
  2c:	e8 92 02 00 00       	call   2c3 <exit>
            printf(1, "Fork failed\n");
  31:	50                   	push   %eax
  32:	50                   	push   %eax
  33:	68 98 07 00 00       	push   $0x798
  38:	6a 01                	push   $0x1
  3a:	e8 31 04 00 00       	call   470 <printf>
            exit();
  3f:	e8 7f 02 00 00       	call   2c3 <exit>
            for (volatile int j = 0; j < 1e8; j++); // Simulate work
  44:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
  4e:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  53:	7f d7                	jg     2c <main+0x2c>
  ...
  64:	3d ff e0 f5 05       	cmp    $0x5f5e0ff,%eax
  69:	7e ed                	jle    58 <main+0x58>
  6b:	eb bf                	jmp    2c <main+0x2c>
  6d:	66 90                	xchg   %ax,%ax
  6f:	90                   	nop
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 ac 07 00 00 	jmp    *0x7ac(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba a5 07 00 00       	mov    $0x7a5,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 b0 0a 00 00       	mov    0xab0,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 b0 0a 00 00    	mov    %edx,0xab0
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 b0 0a 00 00    	mov    %edx,0xab0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 b0 0a 00 00    	mov    %edx,0xab0
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 b0 0a 00 00 b4 	movl   $0xab4,0xab0
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf b4 0a 00 00       	mov    $0xab4,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 b4 0a 00 00 b4 	movl   $0xab4,0xab4
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){

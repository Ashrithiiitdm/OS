...
_test_get_set_p:     file format elf32-i386
...
int main() {
  ...
  14:	e8 9a 03 00 00       	call   3b3 <getpid>
  ...
  1d:	89 c3                	mov    %eax,%ebx
    int parent_priority = get_priority(parent_pid);
  1f:	e8 df 03 00 00       	call   403 <get_priority>
  ...
  37:	e8 ef 02 00 00       	call   32b <fork>
    
    if (pid < 0) {
  3c:	85 c0                	test   %eax,%eax
  3e:	0f 88 82 00 00 00    	js     c6 <main+0xc6>
        // fork failed
        printf(1, "Fork failed!\n");
        exit();
    } else if (pid == 0) {
  44:	75 58                	jne    9e <main+0x9e>
        // This is the child process
        int child_pid = getpid();
  46:	e8 68 03 00 00       	call   3b3 <getpid>
        int child_priority = parent_priority + 1; // Higher priority than parent
  4b:	8d 7e 01             	lea    0x1(%esi),%edi
  ...
  55:	57                   	push   %edi
  56:	53                   	push   %ebx
  57:	e8 af 03 00 00       	call   40b <set_priority>
        printf(1, "Child Process: PID = %d, Priority = %d\n", child_pid, child_priority);
  5c:	57                   	push   %edi
  5d:	53                   	push   %ebx
  5e:	68 44 08 00 00       	push   $0x844
  63:	6a 01                	push   $0x1
  ...
  ab:	e8 53 03 00 00       	call   403 <get_priority>
        printf(1, "Parent Process Ends: PID = %d, Priority = %d\n", parent_pid, final_parent_priority);
  b0:	50                   	push   %eax
  b1:	53                   	push   %ebx
  b2:	68 cc 08 00 00       	push   $0x8cc
  b7:	6a 01                	push   $0x1
  b9:	e8 32 04 00 00       	call   4f0 <printf>
    }
  ...
  c6:	52                   	push   %edx
  c7:	52                   	push   %edx
  c8:	68 fa 08 00 00       	push   $0x8fa
  cd:	6a 01                	push   $0x1
  cf:	e8 1c 04 00 00       	call   4f0 <printf>
        exit();
  d4:	e8 5a 02 00 00       	call   333 <exit>
  d9:	66 90                	xchg   %ax,%ax
  db:	66 90                	xchg   %ax,%ax
  dd:	66 90                	xchg   %ax,%ax
  df:	90                   	nop
 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 479:	0f b6 92 68 09 00 00 	movzbl 0x968(%edx),%edx
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 535:	57                   	push   %edi
 536:	56                   	push   %esi
 537:	e8 17 fe ff ff       	call   353 <write>
 ...
 569:	ff 24 85 10 09 00 00 	jmp    *0x910(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 58e:	e8 c0 fd ff ff       	call   353 <write>
        putc(fd, c);
 ...
 59f:	57                   	push   %edi
 5a0:	56                   	push   %esi
 5a1:	e8 ad fd ff ff       	call   353 <write>
        putc(fd, c);
 ...
 64c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 64f:	e8 ff fc ff ff       	call   353 <write>
        ap++;
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 08 09 00 00       	mov    $0x908,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 1c 0c 00 00       	mov    0xc1c,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 1c 0c 00 00    	mov    %edx,0xc1c
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 1c 0c 00 00    	mov    %edx,0xc1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 1c 0c 00 00    	mov    0xc1c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d 1c 0c 00 00    	mov    0xc1c,%edi
 ...
 783:	e8 33 fc ff ff       	call   3bb <sbrk>
  if(p == (char*)-1)
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 1c 0c 00 00    	mov    0xc1c,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 1c 0c 00 00    	mov    %edx,0xc1c
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 1c 0c 00 00 20 	movl   $0xc20,0xc1c
 7e7:	0c 00 00 
    base.s.size = 0;
 7ea:	bf 20 0c 00 00       	mov    $0xc20,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 20 0c 00 00 20 	movl   $0xc20,0xc20
 7f6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 24 0c 00 00 00 	movl   $0x0,0xc24
 802:	00 00 00 
    if(p->s.size >= nunits){

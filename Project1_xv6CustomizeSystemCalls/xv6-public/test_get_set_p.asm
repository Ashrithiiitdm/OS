...
int main() {
  ...
  18:	89 c3                	mov    %eax,%ebx
    int priority = get_priority(pid);
  1a:	e8 64 03 00 00       	call   383 <get_priority>
    
    printf(1, "Process: PID = %d, Priority = %d\n", pid, priority);
  1f:	50                   	push   %eax
  20:	53                   	push   %ebx
  21:	68 98 07 00 00       	push   $0x798
  26:	6a 01                	push   $0x1
  28:	e8 43 04 00 00       	call   470 <printf>

    printf(1,"Setting the priority\n");    
  2d:	83 c4 18             	add    $0x18,%esp
  30:	68 ba 07 00 00       	push   $0x7ba
  35:	6a 01                	push   $0x1
  37:	e8 34 04 00 00       	call   470 <printf>
    set_priority(pid, 20);
  3c:	58                   	pop    %eax
  3d:	5a                   	pop    %edx
  3e:	6a 14                	push   $0x14
  40:	53                   	push   %ebx
  41:	e8 45 03 00 00       	call   38b <set_priority>

    priority = get_priority(pid);
  46:	89 1c 24             	mov    %ebx,(%esp)
  49:	e8 35 03 00 00       	call   383 <get_priority>
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 d8 07 00 00 	jmp    *0x7d8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba d0 07 00 00       	mov    $0x7d0,%edx
        while(*s != 0){

...
int main() {
  ...
  55:	57                   	push   %edi
  56:	53                   	push   %ebx
  57:	e8 9f 03 00 00       	call   3fb <set_priority>
        printf(1, "Child Process: PID = %d, Priority = %d\n", child_pid, child_priority);
  5c:	57                   	push   %edi
  5d:	53                   	push   %ebx
  5e:	68 34 08 00 00       	push   $0x834
  63:	6a 01                	push   $0x1
  ...
  c6:	52                   	push   %edx
  c7:	52                   	push   %edx
  c8:	68 ea 08 00 00       	push   $0x8ea
  cd:	6a 01                	push   $0x1
  cf:	e8 0c 04 00 00       	call   4e0 <printf>
        exit();
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 469:	0f b6 92 58 09 00 00 	movzbl 0x958(%edx),%edx
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 525:	57                   	push   %edi
 526:	56                   	push   %esi
 527:	e8 27 fe ff ff       	call   353 <write>
 ...
 559:	ff 24 85 00 09 00 00 	jmp    *0x900(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 57e:	e8 d0 fd ff ff       	call   353 <write>
        putc(fd, c);
 ...
 58f:	57                   	push   %edi
 590:	56                   	push   %esi
 591:	e8 bd fd ff ff       	call   353 <write>
        putc(fd, c);
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba f8 08 00 00       	mov    $0x8f8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 0c 0c 00 00       	mov    0xc0c,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 0c 0c 00 00    	mov    %edx,0xc0c
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 0c 0c 00 00    	mov    %edx,0xc0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d 0c 0c 00 00    	mov    0xc0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d 0c 0c 00 00    	mov    0xc0c,%edi
 ...
 773:	e8 43 fc ff ff       	call   3bb <sbrk>
  if(p == (char*)-1)
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 0c 0c 00 00    	mov    0xc0c,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 0c 0c 00 00    	mov    %edx,0xc0c
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 0c 0c 00 00 10 	movl   $0xc10,0xc0c
 7d7:	0c 00 00 
    base.s.size = 0;
 7da:	bf 10 0c 00 00       	mov    $0xc10,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 10 0c 00 00 10 	movl   $0xc10,0xc10
 7e6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 14 0c 00 00 00 	movl   $0x0,0xc14
 7f2:	00 00 00 
    if(p->s.size >= nunits){

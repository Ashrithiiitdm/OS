...
int main() {
  ...
  13:	e8 5b 03 00 00       	call   373 <getpid>
  ...
  34:	78 44                	js     7a <main+0x7a>
        printf(1,"Fork failed\n");
        exit();
    }

    if (pid == 0) {
  36:	75 38                	jne    70 <main+0x70>
        // Child process
        int ppid = getppid(getpid());
  38:	e8 36 03 00 00       	call   373 <getpid>
  3d:	83 ec 0c             	sub    $0xc,%esp
  40:	50                   	push   %eax
  41:	e8 9d 03 00 00       	call   3e3 <getppid>
  ...
  4f:	6a 01                	push   $0x1
  51:	e8 4a 04 00 00       	call   4a0 <printf>
        if (ppid != parent_pid) {
  56:	83 c4 20             	add    $0x20,%esp
  59:	39 f3                	cmp    %esi,%ebx
  5b:	74 30                	je     8d <main+0x8d>
            printf(1,"Test failed: Parent PID mismatch\n");
  5d:	52                   	push   %edx
  5e:	52                   	push   %edx
  5f:	68 24 08 00 00       	push   $0x824
  64:	6a 01                	push   $0x1
  66:	e8 35 04 00 00       	call   4a0 <printf>
            exit();
  6b:	e8 83 02 00 00       	call   2f3 <exit>
  ...
  70:	e8 86 02 00 00       	call   2fb <wait>
    }

    exit();
  75:	e8 79 02 00 00       	call   2f3 <exit>
        printf(1,"Fork failed\n");
  7a:	51                   	push   %ecx
  7b:	51                   	push   %ecx
  7c:	68 dc 07 00 00       	push   $0x7dc
  81:	6a 01                	push   $0x1
  83:	e8 18 04 00 00       	call   4a0 <printf>
        exit();
  88:	e8 66 02 00 00       	call   2f3 <exit>
            printf(1,"Test passed\n");
  8d:	50                   	push   %eax
  8e:	50                   	push   %eax
  8f:	68 e9 07 00 00       	push   $0x7e9
  94:	6a 01                	push   $0x1
  96:	e8 05 04 00 00       	call   4a0 <printf>
            exit();
  9b:	e8 53 02 00 00       	call   2f3 <exit>
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 46 08 00 00       	mov    $0x846,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 58 0b 00 00       	mov    0xb58,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 58 0b 00 00    	mov    %edx,0xb58
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 58 0b 00 00    	mov    %edx,0xb58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 58 0b 00 00    	mov    0xb58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 58 0b 00 00    	mov    0xb58,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 58 0b 00 00    	mov    0xb58,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 58 0b 00 00    	mov    %edx,0xb58
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 58 0b 00 00 5c 	movl   $0xb5c,0xb58
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf 5c 0b 00 00       	mov    $0xb5c,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 5c 0b 00 00 5c 	movl   $0xb5c,0xb5c
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 60 0b 00 00 00 	movl   $0x0,0xb60
 7b2:	00 00 00 
    if(p->s.size >= nunits){

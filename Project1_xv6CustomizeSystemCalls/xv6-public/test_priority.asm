...
int main(void) {
  ...
  11:	68 a8 08 00 00       	push   $0x8a8
  16:	6a 01                	push   $0x1
  18:	e8 63 05 00 00       	call   580 <printf>
    
    // Create first child with low priority (higher number)
    if((pid1 = fork()) == 0) {
  1d:	e8 a9 03 00 00       	call   3cb <fork>
  22:	83 c4 10             	add    $0x10,%esp
  25:	85 c0                	test   %eax,%eax
  27:	75 56                	jne    7f <main+0x7f>
        int cur_pid1 = getpid();
  29:	e8 25 04 00 00       	call   453 <getpid>
        set_priority(cur_pid1,12);  // Lower priority
  2e:	52                   	push   %edx
  2f:	52                   	push   %edx
  30:	6a 0c                	push   $0xc
  32:	50                   	push   %eax
  33:	e8 63 04 00 00       	call   49b <set_priority>
        sleep(20); //buffer for the prirority to be set
  38:	c7 04 24 14 00 00 00 	movl   $0x14,(%esp)
  3f:	e8 1f 04 00 00       	call   463 <sleep>
        printf(1, "Low priority process (pid %d) starting\n", getpid());
  44:	e8 0a 04 00 00       	call   453 <getpid>
  49:	83 c4 0c             	add    $0xc,%esp
  4c:	50                   	push   %eax
  4d:	68 d4 08 00 00       	push   $0x8d4
  52:	6a 01                	push   $0x1
  54:	e8 27 05 00 00       	call   580 <printf>
        spin(100);  // Spin for some time
  59:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  60:	e8 fb 00 00 00       	call   160 <spin>
        printf(1, "Low priority process (pid %d) finishing\n", getpid());
  65:	e8 e9 03 00 00       	call   453 <getpid>
  6a:	83 c4 0c             	add    $0xc,%esp
  6d:	50                   	push   %eax
  6e:	68 fc 08 00 00       	push   $0x8fc
  73:	6a 01                	push   $0x1
  ...
  7a:	e8 54 03 00 00       	call   3d3 <exit>
    ...
    if((pid2 = fork()) == 0) {
  7f:	e8 47 03 00 00       	call   3cb <fork>
  84:	85 c0                	test   %eax,%eax
  86:	75 56                	jne    de <main+0xde>
        int cur_pid2 = getpid();
  88:	e8 c6 03 00 00       	call   453 <getpid>
        set_priority(cur_pid2,15);  // Medium priority
  8d:	51                   	push   %ecx
  8e:	51                   	push   %ecx
  8f:	6a 0f                	push   $0xf
  91:	50                   	push   %eax
  92:	e8 04 04 00 00       	call   49b <set_priority>
        sleep(20); //buffer for prirotiy to be set
  97:	c7 04 24 14 00 00 00 	movl   $0x14,(%esp)
  9e:	e8 c0 03 00 00       	call   463 <sleep>
        printf(1, "Medium priority process (pid %d) starting\n", getpid());
  a3:	e8 ab 03 00 00       	call   453 <getpid>
  a8:	83 c4 0c             	add    $0xc,%esp
  ab:	50                   	push   %eax
  ac:	68 28 09 00 00       	push   $0x928
  b1:	6a 01                	push   $0x1
  b3:	e8 c8 04 00 00       	call   580 <printf>
        spin(100);  // Spin for some time
  b8:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  bf:	e8 9c 00 00 00       	call   160 <spin>
        printf(1, "Medium priority process (pid %d) finishing\n", getpid());
  c4:	e8 8a 03 00 00       	call   453 <getpid>
  c9:	83 c4 0c             	add    $0xc,%esp
  cc:	50                   	push   %eax
  cd:	68 54 09 00 00       	push   $0x954
  d2:	6a 01                	push   $0x1
  d4:	e8 a7 04 00 00       	call   580 <printf>
        exit();
  d9:	e8 f5 02 00 00       	call   3d3 <exit>
    }

    // Create third child with high priority
    if((pid3 = fork()) == 0) {
  de:	e8 e8 02 00 00       	call   3cb <fork>
  e3:	85 c0                	test   %eax,%eax
  e5:	75 56                	jne    13d <main+0x13d>
        int cur_pid3 = getpid();
  e7:	e8 67 03 00 00       	call   453 <getpid>
        set_priority(cur_pid3,20);   // Higher priority (lower number)
  ec:	52                   	push   %edx
  ed:	52                   	push   %edx
  ee:	6a 14                	push   $0x14
  f0:	50                   	push   %eax
  f1:	e8 a5 03 00 00       	call   49b <set_priority>
        sleep(20); //buffer for the priroity to be set
  f6:	c7 04 24 14 00 00 00 	movl   $0x14,(%esp)
 ...
 10a:	50                   	push   %eax
 10b:	68 80 09 00 00       	push   $0x980
 110:	6a 01                	push   $0x1
 112:	e8 69 04 00 00       	call   580 <printf>
        spin(100);  // Spin for some time
 117:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
 11e:	e8 3d 00 00 00       	call   160 <spin>
        printf(1, "High priority process (pid %d) finishing\n", getpid());
 123:	e8 2b 03 00 00       	call   453 <getpid>
 128:	83 c4 0c             	add    $0xc,%esp
 12b:	50                   	push   %eax
 12c:	68 ac 09 00 00       	push   $0x9ac
 131:	6a 01                	push   $0x1
 133:	e8 48 04 00 00       	call   580 <printf>
        exit();
 138:	e8 96 02 00 00       	call   3d3 <exit>
    }

    // Wait for all children to complete
    wait();
 13d:	e8 99 02 00 00       	call   3db <wait>
    wait();
 142:	e8 94 02 00 00       	call   3db <wait>
    wait();
 147:	e8 8f 02 00 00       	call   3db <wait>

    printf(1, "All tests completed!\n");
 14c:	50                   	push   %eax
 14d:	50                   	push   %eax
 14e:	68 d6 09 00 00       	push   $0x9d6
 153:	6a 01                	push   $0x1
 155:	e8 26 04 00 00       	call   580 <printf>
    exit();
 15a:	e8 74 02 00 00       	call   3d3 <exit>
 15f:	90                   	nop
...
void spin(int duration) {
 ...
 165:	8b 75 08             	mov    0x8(%ebp),%esi
    uint start = uptime();
 168:	e8 fe 02 00 00       	call   46b <uptime>
 16d:	89 c3                	mov    %eax,%ebx
    while(uptime() - start < duration) { }
 16f:	90                   	nop
 170:	e8 f6 02 00 00       	call   46b <uptime>
 175:	29 d8                	sub    %ebx,%eax
 177:	39 f0                	cmp    %esi,%eax
 179:	72 f5                	jb     170 <spin+0x10>
}
 17b:	5b                   	pop    %ebx
 17c:	5e                   	pop    %esi
 17d:	5d                   	pop    %ebp
 ...
 4dc:	89 d1                	mov    %edx,%ecx
{
 ...
 509:	0f b6 92 4c 0a 00 00 	movzbl 0xa4c(%edx),%edx
 ...
 589:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5f9:	ff 24 85 f4 09 00 00 	jmp    *0x9f4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 707:	90                   	nop
          s = "(null)";
 708:	ba ec 09 00 00       	mov    $0x9ec,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 721:	a1 1c 0d 00 00       	mov    0xd1c,%eax
{
 ...
 761:	5b                   	pop    %ebx
  freep = p;
 762:	89 15 1c 0d 00 00    	mov    %edx,0xd1c
}
 768:	5e                   	pop    %esi
 769:	5f                   	pop    %edi
 76a:	5d                   	pop    %ebp
 ...
 799:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 79c:	89 15 1c 0d 00 00    	mov    %edx,0xd1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7bc:	8b 3d 1c 0d 00 00    	mov    0xd1c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ff:	73 4f                	jae    850 <malloc+0xa0>
    ...
    if(p == freep)
 801:	8b 3d 1c 0d 00 00    	mov    0xd1c,%edi
 ...
 82a:	e8 f1 fe ff ff       	call   720 <free>
  return freep;
 82f:	8b 15 1c 0d 00 00    	mov    0xd1c,%edx
 ...
 85c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 85f:	89 15 1c 0d 00 00    	mov    %edx,0xd1c
}
 ...
 86f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 1c 0d 00 00 20 	movl   $0xd20,0xd1c
 877:	0d 00 00 
    base.s.size = 0;
 87a:	bf 20 0d 00 00       	mov    $0xd20,%edi
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 20 0d 00 00 20 	movl   $0xd20,0xd20
 886:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 889:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 88b:	c7 05 24 0d 00 00 00 	movl   $0x0,0xd24
 892:	00 00 00 
    if(p->s.size >= nunits){

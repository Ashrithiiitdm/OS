...
main(void)
{
  ...
  11:	6a 00                	push   $0x0
  13:	6a 00                	push   $0x0
  15:	e8 09 04 00 00       	call   423 <sem_init>
    sem_init(SEM_MUTEX2, 0);
  1a:	58                   	pop    %eax
  1b:	5a                   	pop    %edx
  1c:	6a 00                	push   $0x0
  1e:	6a 01                	push   $0x1
  20:	e8 fe 03 00 00       	call   423 <sem_init>
  ...
  5b:	6a 00                	push   $0x0
  5d:	e8 c9 03 00 00       	call   42b <sem_destroy>
    sem_destroy(SEM_MUTEX2);
  62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  69:	e8 bd 03 00 00       	call   42b <sem_destroy>
...
void thread_func1() {
  ...
  86:	68 28 08 00 00       	push   $0x828
  8b:	6a 01                	push   $0x1
  8d:	e8 6e 04 00 00       	call   500 <printf>
    sem_wait(SEM_MUTEX1, 1);
  92:	58                   	pop    %eax
  93:	5a                   	pop    %edx
  94:	6a 01                	push   $0x1
  96:	6a 00                	push   $0x0
  98:	e8 96 03 00 00       	call   433 <sem_wait>
    printf(1, "Statement A2\n");
  9d:	59                   	pop    %ecx
  9e:	58                   	pop    %eax
  9f:	68 36 08 00 00       	push   $0x836
  a4:	6a 01                	push   $0x1
  a6:	e8 55 04 00 00       	call   500 <printf>
    sem_signal(SEM_MUTEX2, 1);
  ab:	58                   	pop    %eax
  ac:	5a                   	pop    %edx
  ad:	6a 01                	push   $0x1
  af:	6a 01                	push   $0x1
  b1:	e8 85 03 00 00       	call   43b <sem_signal>
}
...
void thread_func2() {
  ...
  d4:	6a 01                	push   $0x1
  d6:	6a 00                	push   $0x0
  d8:	e8 5e 03 00 00       	call   43b <sem_signal>
    sem_wait(SEM_MUTEX2, 1);
  dd:	59                   	pop    %ecx
  de:	58                   	pop    %eax
  df:	6a 01                	push   $0x1
  e1:	6a 01                	push   $0x1
  e3:	e8 4b 03 00 00       	call   433 <sem_wait>
    printf(1, "Statement B2\n");
  e8:	58                   	pop    %eax
  e9:	5a                   	pop    %edx
  ea:	68 52 08 00 00       	push   $0x852
  ef:	6a 01                	push   $0x1
  f1:	e8 0a 04 00 00       	call   500 <printf>
}
 ...
 509:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 579:	ff 24 85 68 08 00 00 	jmp    *0x868(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 687:	90                   	nop
          s = "(null)";
 688:	ba 60 08 00 00       	mov    $0x860,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a1:	a1 a8 0b 00 00       	mov    0xba8,%eax
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 6e8:	5e                   	pop    %esi
 6e9:	5f                   	pop    %edi
 6ea:	5d                   	pop    %ebp
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 a8 0b 00 00    	mov    %edx,0xba8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d a8 0b 00 00    	mov    0xba8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 4f                	jae    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	8b 3d a8 0b 00 00    	mov    0xba8,%edi
 ...
 7aa:	e8 f1 fe ff ff       	call   6a0 <free>
  return freep;
 7af:	8b 15 a8 0b 00 00    	mov    0xba8,%edx
 ...
 7dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7df:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 ...
 7ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 a8 0b 00 00 ac 	movl   $0xbac,0xba8
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	bf ac 0b 00 00       	mov    $0xbac,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 ac 0b 00 00 ac 	movl   $0xbac,0xbac
 806:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 80b:	c7 05 b0 0b 00 00 00 	movl   $0x0,0xbb0
 812:	00 00 00 
    if(p->s.size >= nunits){

...
main(void)
{
  ...
  11:	6a 00                	push   $0x0
  13:	6a 00                	push   $0x0
  15:	e8 19 04 00 00       	call   433 <sem_init>
    sem_init(SEM_MUTEX2, 0);
  1a:	58                   	pop    %eax
  1b:	5a                   	pop    %edx
  1c:	6a 00                	push   $0x0
  1e:	6a 01                	push   $0x1
  20:	e8 0e 04 00 00       	call   433 <sem_init>

    // Fork first thread
    if (fork() == 0) {
  25:	e8 21 03 00 00       	call   34b <fork>
  2a:	83 c4 10             	add    $0x10,%esp
  2d:	85 c0                	test   %eax,%eax
  2f:	75 0a                	jne    3b <main+0x3b>
        thread_func1();
  31:	e8 4a 00 00 00       	call   80 <thread_func1>
        exit();
  36:	e8 18 03 00 00       	call   353 <exit>
    }

    // Fork second thread
    if (fork() == 0) {
  3b:	e8 0b 03 00 00       	call   34b <fork>
  40:	85 c0                	test   %eax,%eax
  42:	75 0a                	jne    4e <main+0x4e>
        thread_func2();
  44:	e8 77 00 00 00       	call   c0 <thread_func2>
        exit();
  49:	e8 05 03 00 00       	call   353 <exit>
    }

    // Wait for both child processes
    wait();
  4e:	e8 08 03 00 00       	call   35b <wait>
    wait();
  53:	e8 03 03 00 00       	call   35b <wait>

    sem_destroy(SEM_MUTEX1);
  58:	83 ec 0c             	sub    $0xc,%esp
  5b:	6a 00                	push   $0x0
  5d:	e8 d9 03 00 00       	call   43b <sem_destroy>
    sem_destroy(SEM_MUTEX2);
  62:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  69:	e8 cd 03 00 00       	call   43b <sem_destroy>
...
00000080 <thread_func1>:
void thread_func1() {
  80:	55                   	push   %ebp
  81:	89 e5                	mov    %esp,%ebp
  83:	83 ec 10             	sub    $0x10,%esp
    printf(1, "Statement A1\n");
  86:	68 38 08 00 00       	push   $0x838
  8b:	6a 01                	push   $0x1
  ...
  94:	6a 01                	push   $0x1
  96:	6a 00                	push   $0x0
  98:	e8 a6 03 00 00       	call   443 <sem_wait>
    printf(1, "Statement A2\n");
  9d:	59                   	pop    %ecx
  9e:	58                   	pop    %eax
  9f:	68 46 08 00 00       	push   $0x846
  a4:	6a 01                	push   $0x1
  a6:	e8 65 04 00 00       	call   510 <printf>
    sem_signal(SEM_MUTEX2, 1);
  ab:	58                   	pop    %eax
  ac:	5a                   	pop    %edx
  ad:	6a 01                	push   $0x1
  af:	6a 01                	push   $0x1
  b1:	e8 95 03 00 00       	call   44b <sem_signal>
}
...
000000c0 <thread_func2>:
void thread_func2() {
  c0:	55                   	push   %ebp
  c1:	89 e5                	mov    %esp,%ebp
  c3:	83 ec 10             	sub    $0x10,%esp
    printf(1, "Statement B1\n");
  c6:	68 54 08 00 00       	push   $0x854
  cb:	6a 01                	push   $0x1
  cd:	e8 3e 04 00 00       	call   510 <printf>
    sem_signal(SEM_MUTEX1, 1);
  d2:	58                   	pop    %eax
  d3:	5a                   	pop    %edx
  d4:	6a 01                	push   $0x1
  d6:	6a 00                	push   $0x0
  d8:	e8 6e 03 00 00       	call   44b <sem_signal>
    sem_wait(SEM_MUTEX2, 1);
  dd:	59                   	pop    %ecx
  de:	58                   	pop    %eax
  df:	6a 01                	push   $0x1
  e1:	6a 01                	push   $0x1
  e3:	e8 5b 03 00 00       	call   443 <sem_wait>
    printf(1, "Statement B2\n");
  e8:	58                   	pop    %eax
  e9:	5a                   	pop    %edx
  ea:	68 62 08 00 00       	push   $0x862
  ef:	6a 01                	push   $0x1
  f1:	e8 1a 04 00 00       	call   510 <printf>
}
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 555:	57                   	push   %edi
 556:	56                   	push   %esi
 557:	e8 17 fe ff ff       	call   373 <write>
 ...
 5ae:	e8 c0 fd ff ff       	call   373 <write>
        putc(fd, c);
 ...
 5bf:	57                   	push   %edi
 5c0:	56                   	push   %esi
 5c1:	e8 ad fd ff ff       	call   373 <write>
        putc(fd, c);
 ...
 66c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 66f:	e8 ff fc ff ff       	call   373 <write>
        ap++;
...
free(void *ap)
{
 ...
 6b1:	a1 b8 0b 00 00       	mov    0xbb8,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
 ...
 7a3:	e8 33 fc ff ff       	call   3db <sbrk>
  if(p == (char*)-1)
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 b8 0b 00 00    	mov    0xbb8,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
}
 ...
 7ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 b8 0b 00 00 bc 	movl   $0xbbc,0xbb8
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf bc 0b 00 00       	mov    $0xbbc,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 bc 0b 00 00 bc 	movl   $0xbbc,0xbbc
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 c0 0b 00 00 00 	movl   $0x0,0xbc0
 822:	00 00 00 
    if(p->s.size >= nunits){

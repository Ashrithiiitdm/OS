...
int main()
{
   ...
   e:	51                   	push   %ecx
  int pid = fork();
   f:	e8 f7 02 00 00       	call   30b <fork>
  
  if(pid < 0){
  14:	85 c0                	test   %eax,%eax
  16:	78 75                	js     8d <main+0x8d>
    printf(1, "fork failed\n");
    exit();
  }
  int pid1 = -1;
  if(pid == 0){  
  18:	75 4d                	jne    67 <main+0x67>
    // Child process
    sleep(5);
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 7f 03 00 00       	call   3a3 <sleep>
    pid1 = getpid();
  24:	e8 6a 03 00 00       	call   393 <getpid>
  29:	89 c3                	mov    %eax,%ebx
    printf(1, "Child: Going to sleep for a while...\n");
  2b:	58                   	pop    %eax
  2c:	5a                   	pop    %edx
  2d:	68 f8 07 00 00       	push   $0x7f8
  32:	6a 01                	push   $0x1
  34:	e8 77 04 00 00       	call   4b0 <printf>
    sleep(100);
  39:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  40:	e8 5e 03 00 00       	call   3a3 <sleep>

    printf(1, "Child: Waking up and calling unwait\n");
  45:	59                   	pop    %ecx
  46:	58                   	pop    %eax
  47:	68 20 08 00 00       	push   $0x820
  4c:	6a 01                	push   $0x1
  4e:	e8 5d 04 00 00       	call   4b0 <printf>
    // Wake up any waiting processes
    int flag = unwait_pid(pid1);
  53:	89 1c 24             	mov    %ebx,(%esp)
  56:	e8 78 03 00 00       	call   3d3 <unwait_pid>
    if(!flag){
  ...
  75:	59                   	pop    %ecx
  76:	5b                   	pop    %ebx
  77:	68 70 08 00 00       	push   $0x870
  7c:	6a 01                	push   $0x1
  7e:	e8 2d 04 00 00       	call   4b0 <printf>
    // Wait for child to exit
    wait();       
  83:	e8 93 02 00 00       	call   31b <wait>
  }
  
  exit();
  88:	e8 86 02 00 00       	call   313 <exit>
    printf(1, "fork failed\n");
  8d:	50                   	push   %eax
  8e:	50                   	push   %eax
  8f:	68 d8 07 00 00       	push   $0x7d8
  94:	6a 01                	push   $0x1
  96:	e8 15 04 00 00       	call   4b0 <printf>
    exit();
  9b:	e8 73 02 00 00       	call   313 <exit>
      printf(1, "Unwait successful\n");
  a0:	50                   	push   %eax
  a1:	50                   	push   %eax
  a2:	68 e5 07 00 00       	push   $0x7e5
  a7:	6a 01                	push   $0x1
  a9:	e8 02 04 00 00       	call   4b0 <printf>
  ae:	83 c4 10             	add    $0x10,%esp
  b1:	eb af                	jmp    62 <main+0x62>
  b3:	66 90                	xchg   %ax,%ax
  b5:	66 90                	xchg   %ax,%ax
  b7:	66 90                	xchg   %ax,%ax
  b9:	66 90                	xchg   %ax,%ax
...
000003e3 <get_priority>:
 3e3:	b8 1c 00 00 00       	mov    $0x1c,%eax
 3e8:	cd 40                	int    $0x40
 3ea:	c3                   	ret    

000003eb <set_priority>:
 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 439:	0f b6 92 f0 08 00 00 	movzbl 0x8f0(%edx),%edx
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 529:	ff 24 85 98 08 00 00 	jmp    *0x898(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 637:	90                   	nop
          s = "(null)";
 638:	ba 91 08 00 00       	mov    $0x891,%edx
        while(*s != 0){

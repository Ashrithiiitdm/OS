...
int main()
{
  ...
  int pid = fork();
  11:	e8 c5 02 00 00       	call   2db <fork>
  
  if(pid < 0){
  16:	85 c0                	test   %eax,%eax
  18:	78 5f                	js     79 <main+0x79>
    printf(1, "fork failed\n");
    exit();
  }
  int pid1 = -1;
  if(pid == 0){  
  1a:	75 37                	jne    53 <main+0x53>
    // Child process
    pid1 = getpid();
  1c:	e8 42 03 00 00       	call   363 <getpid>
  ...
  36:	e8 38 03 00 00       	call   373 <sleep>

    printf(1, "Child: Waking up and calling unwait\n");
  3b:	58                   	pop    %eax
  3c:	5a                   	pop    %edx
  3d:	68 d0 07 00 00       	push   $0x7d0
  42:	6a 01                	push   $0x1
  44:	e8 27 04 00 00       	call   470 <printf>
    // Wake up any waiting processes
    unwait_pid();    
  49:	e8 55 03 00 00       	call   3a3 <unwait_pid>
    exit();
  4e:	e8 90 02 00 00       	call   2e3 <exit>
  } 
  else{        
    // Parent process
  ...
  68:	6a 01                	push   $0x1
  6a:	e8 01 04 00 00       	call   470 <printf>
    // Wait for child to exit
    wait();       
  6f:	e8 77 02 00 00       	call   2eb <wait>
  }
  
  exit();
  74:	e8 6a 02 00 00       	call   2e3 <exit>
    printf(1, "fork failed\n");
  79:	51                   	push   %ecx
  7a:	51                   	push   %ecx
  7b:	68 98 07 00 00       	push   $0x798
  80:	6a 01                	push   $0x1
 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 a0 08 00 00 	movzbl 0x8a0(%edx),%edx
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 48 08 00 00 	jmp    *0x848(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba 41 08 00 00       	mov    $0x841,%edx
        while(*s != 0){

...
int main()
{
  ...
  int pid = fork();
  11:	e8 d5 02 00 00       	call   2eb <fork>
  
  if(pid < 0){
  16:	85 c0                	test   %eax,%eax
  18:	78 69                	js     83 <main+0x83>
    printf(1, "fork failed\n");
    exit();
  }
  int pid1 = -1;
  if(pid == 0){  
  1a:	75 41                	jne    5d <main+0x5d>
    // Child process
    sleep(5);
  1c:	83 ec 0c             	sub    $0xc,%esp
  1f:	6a 05                	push   $0x5
  21:	e8 5d 03 00 00       	call   383 <sleep>
    pid1 = getpid();
  26:	e8 48 03 00 00       	call   373 <getpid>
    printf(1, "Child: Going to sleep for a while...\n");
  2b:	58                   	pop    %eax
  2c:	5a                   	pop    %edx
  2d:	68 c8 07 00 00       	push   $0x7c8
  32:	6a 01                	push   $0x1
  34:	e8 57 04 00 00       	call   490 <printf>
    sleep(100);
  39:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  40:	e8 3e 03 00 00       	call   383 <sleep>

    printf(1, "Child: Waking up and calling unwait\n");
  45:	59                   	pop    %ecx
  46:	58                   	pop    %eax
  47:	68 f0 07 00 00       	push   $0x7f0
  4c:	6a 01                	push   $0x1
  4e:	e8 3d 04 00 00       	call   490 <printf>
    // Wake up any waiting processes
    unwait_pid();    
  53:	e8 5b 03 00 00       	call   3b3 <unwait_pid>
    exit();
  58:	e8 96 02 00 00       	call   2f3 <exit>
  } 
  else{        
    // Parent process
  ...
  6b:	59                   	pop    %ecx
  6c:	58                   	pop    %eax
  6d:	68 40 08 00 00       	push   $0x840
  72:	6a 01                	push   $0x1
  74:	e8 17 04 00 00       	call   490 <printf>
    // Wait for child to exit
    wait();       
  79:	e8 7d 02 00 00       	call   2fb <wait>
  }
 ...
 3ec:	89 d1                	mov    %edx,%ecx
{
 ...
 419:	0f b6 92 c0 08 00 00 	movzbl 0x8c0(%edx),%edx
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 68 08 00 00 	jmp    *0x868(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba 61 08 00 00       	mov    $0x861,%edx
        while(*s != 0){

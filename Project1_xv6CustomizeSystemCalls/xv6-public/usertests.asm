...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
      ...
      16:	6a 01                	push   $0x1
      18:	e8 73 3a 00 00       	call   3a90 <printf>
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    printf(1, "already ran user tests -- rebuild fs.img\n");
      ...
      39:	6a 01                	push   $0x1
      3b:	e8 50 3a 00 00       	call   3a90 <printf>
    exit();
...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     131:	e8 5a 39 00 00       	call   3a90 <printf>
  if(mkdir("iputdir") < 0){
  ...
  printf(stdout, "iput test ok\n");
     ...
     197:	e8 f4 38 00 00       	call   3a90 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1ae:	e8 dd 38 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1c5:	e8 c6 38 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1dc:	e8 af 38 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1f3:	e8 98 38 00 00       	call   3a90 <printf>
    exit();
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     211:	e8 7a 38 00 00       	call   3a90 <printf>
  pid = fork();
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     28b:	e8 00 38 00 00       	call   3a90 <printf>
}
     ...
     2a6:	e8 e5 37 00 00       	call   3a90 <printf>
      exit();
    ...
    printf(stdout, "fork failed\n");
     ...
     2bd:	e8 ce 37 00 00       	call   3a90 <printf>
    exit();
     ...
     2d4:	e8 b7 37 00 00       	call   3a90 <printf>
      exit();
     ...
     2eb:	e8 a0 37 00 00       	call   3a90 <printf>
      exit();
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     311:	e8 7a 37 00 00       	call   3a90 <printf>
  if(mkdir("oidir") < 0){
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     35c:	e8 2f 37 00 00       	call   3a90 <printf>
      exit();
  ...
  printf(stdout, "openiput test ok\n");
     ...
     3a0:	e8 eb 36 00 00       	call   3a90 <printf>
}
    ...
    printf(stdout, "fork failed\n");
     ...
     3c2:	e8 c9 36 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d9:	e8 b2 36 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "unlink failed\n");
     ...
     3f0:	e8 9b 36 00 00       	call   3a90 <printf>
    exit();
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     411:	e8 7a 36 00 00       	call   3a90 <printf>
  fd = open("echo", 0);
     416:	58                   	pop    %eax
     417:	5a                   	pop    %edx
     418:	6a 00                	push   $0x0
  ...
  printf(stdout, "open test ok\n");
     ...
     457:	e8 34 36 00 00       	call   3a90 <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     ...
     46e:	e8 1d 36 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     485:	e8 06 36 00 00       	call   3a90 <printf>
    exit();
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     4a3:	e8 e8 35 00 00       	call   3a90 <printf>
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d6:	e8 b5 35 00 00       	call   3a90 <printf>
  ...
  printf(stdout, "writes ok\n");
     ...
     52e:	e8 5d 35 00 00       	call   3a90 <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     564:	e8 27 35 00 00       	call   3a90 <printf>
  i = read(fd, buf, 2000);
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     598:	e8 f3 34 00 00       	call   3a90 <printf>
  close(fd);
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c6:	e8 c5 34 00 00       	call   3a90 <printf>
}
     ...
     5e4:	e8 a7 34 00 00       	call   3a90 <printf>
      exit();
     ...
     5fd:	e8 8e 34 00 00       	call   3a90 <printf>
      exit();
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     614:	e8 77 34 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "read failed\n");
     ...
     62b:	e8 60 34 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "unlink small failed\n");
     ...
     642:	e8 49 34 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     659:	e8 32 34 00 00       	call   3a90 <printf>
    exit();
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     683:	e8 08 34 00 00       	call   3a90 <printf>
  ...
  printf(stdout, "big files ok\n");
     ...
     77b:	e8 10 33 00 00       	call   3a90 <printf>
}
     ...
     799:	e8 f2 32 00 00       	call   3a90 <printf>
      exit();
     ...
     7b0:	e8 db 32 00 00       	call   3a90 <printf>
      exit();
     ...
     7c9:	e8 c2 32 00 00       	call   3a90 <printf>
      exit();
     ...
     7e4:	e8 a7 32 00 00       	call   3a90 <printf>
        exit();
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7fb:	e8 90 32 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     812:	e8 79 32 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "unlink big failed\n");
     ...
     829:	e8 62 32 00 00       	call   3a90 <printf>
    exit();
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     857:	e8 34 32 00 00       	call   3a90 <printf>
  name[0] = 'a';
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8dc:	e8 af 31 00 00       	call   3a90 <printf>
}
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     901:	e8 8a 31 00 00       	call   3a90 <printf>
  if(mkdir("dir0") < 0){
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     967:	e8 24 31 00 00       	call   3a90 <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     97e:	e8 0d 31 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     995:	e8 f6 30 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9ac:	e8 df 30 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9c3:	e8 c8 30 00 00       	call   3a90 <printf>
    exit();
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9e1:	e8 aa 30 00 00       	call   3a90 <printf>
  if(exec("echo", echoargv) < 0){
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a0d:	e8 7e 30 00 00       	call   3a90 <printf>
    exit();
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ab8:	68 0e 41 00 00       	push   $0x410e
     abd:	6a 01                	push   $0x1
     abf:	e8 cc 2f 00 00       	call   3a90 <printf>
  ...
  printf(1, "pipe1 ok\n");
     ...
     b4d:	6a 01                	push   $0x1
     b4f:	e8 3c 2f 00 00       	call   3a90 <printf>
     ...
     b65:	6a 01                	push   $0x1
     b67:	e8 24 2f 00 00       	call   3a90 <printf>
      exit();
    ...
    printf(1, "pipe() failed\n");
     ...
     b78:	6a 01                	push   $0x1
     b7a:	e8 11 2f 00 00       	call   3a90 <printf>
    exit();
    ...
    printf(1, "fork() failed\n");
     ...
     b8b:	6a 01                	push   $0x1
     b8d:	e8 fe 2e 00 00       	call   3a90 <printf>
    exit();
     ...
     b9e:	6a 01                	push   $0x1
     ba0:	e8 eb 2e 00 00       	call   3a90 <printf>
        exit();
...
00000bb0 <preempt>:
{
  ...
  printf(1, "preempt: ");
     ...
     bbe:	6a 01                	push   $0x1
     bc0:	e8 cb 2e 00 00       	call   3a90 <printf>
  pid1 = fork();
  ...
  printf(1, "kill... ");
     ...
     c82:	6a 01                	push   $0x1
     c84:	e8 07 2e 00 00       	call   3a90 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     ca8:	6a 01                	push   $0x1
     caa:	e8 e1 2d 00 00       	call   3a90 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     cc5:	6a 01                	push   $0x1
     cc7:	e8 c4 2d 00 00       	call   3a90 <printf>
    ...
    printf(1, "preempt read error");
     ...
     cdf:	6a 01                	push   $0x1
     ce1:	e8 aa 2d 00 00       	call   3a90 <printf>
     ...
     cf3:	6a 01                	push   $0x1
     cf5:	e8 96 2d 00 00       	call   3a90 <printf>
...
00000d10 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d43:	6a 01                	push   $0x1
     d45:	e8 46 2d 00 00       	call   3a90 <printf>
      return;
     ...
     d60:	6a 01                	push   $0x1
     d62:	e8 29 2d 00 00       	call   3a90 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     d79:	6a 01                	push   $0x1
     d7b:	e8 10 2d 00 00       	call   3a90 <printf>
...
00000d90 <mem>:
{
  ...
  printf(1, "mem test\n");
     ...
     d9f:	6a 01                	push   $0x1
     da1:	e8 ea 2c 00 00       	call   3a90 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
     ...
     e18:	6a 01                	push   $0x1
     e1a:	e8 71 2c 00 00       	call   3a90 <printf>
    exit();
     ...
     e30:	6a 01                	push   $0x1
     e32:	e8 59 2c 00 00       	call   3a90 <printf>
      kill(ppid);
...
00000e60 <sharedfd>:
{
  ...
  printf(1, "sharedfd test\n");
     ...
     e6e:	6a 01                	push   $0x1
     e70:	e8 1b 2c 00 00       	call   3a90 <printf>
  unlink("sharedfd");
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ef1:	6a 01                	push   $0x1
     ef3:	e8 98 2b 00 00       	call   3a90 <printf>
      break;
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     fb5:	6a 01                	push   $0x1
     fb7:	e8 d4 2a 00 00       	call   3a90 <printf>
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     fcf:	6a 01                	push   $0x1
     fd1:	e8 ba 2a 00 00       	call   3a90 <printf>
    return;
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     fe9:	6a 01                	push   $0x1
     feb:	e8 a0 2a 00 00       	call   3a90 <printf>
    return;
    ...
    1007:	6a 01                	push   $0x1
    1009:	e8 82 2a 00 00       	call   3a90 <printf>
    exit();
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    1053:	e8 38 2a 00 00       	call   3a90 <printf>
  ...
  printf(1, "fourfiles ok\n");
    ...
    1133:	6a 01                	push   $0x1
    1135:	e8 56 29 00 00       	call   3a90 <printf>
}
    ...
    1157:	6a 01                	push   $0x1
    1159:	e8 32 29 00 00       	call   3a90 <printf>
          exit();
    ...
    11c6:	6a 01                	push   $0x1
    11c8:	e8 c3 28 00 00       	call   3a90 <printf>
        exit();
    ...
    11e0:	6a 01                	push   $0x1
    11e2:	e8 a9 28 00 00       	call   3a90 <printf>
      exit();
    ...
    11f3:	6a 01                	push   $0x1
    11f5:	e8 96 28 00 00       	call   3a90 <printf>
      exit();
    ...
    1206:	6a 01                	push   $0x1
    1208:	e8 83 28 00 00       	call   3a90 <printf>
          exit();
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    1230:	6a 01                	push   $0x1
    1232:	e8 59 28 00 00       	call   3a90 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    1329:	6a 01                	push   $0x1
    132b:	e8 60 27 00 00       	call   3a90 <printf>
}
    ...
    134b:	6a 01                	push   $0x1
    134d:	e8 3e 27 00 00       	call   3a90 <printf>
        exit();
    ...
    13dc:	6a 01                	push   $0x1
    13de:	e8 ad 26 00 00       	call   3a90 <printf>
            exit();
    ...
    13fe:	6a 01                	push   $0x1
    1400:	e8 8b 26 00 00       	call   3a90 <printf>
        exit();
    ...
    1412:	6a 01                	push   $0x1
    1414:	e8 77 26 00 00       	call   3a90 <printf>
      exit();
    ...
    1426:	6a 01                	push   $0x1
    1428:	e8 63 26 00 00       	call   3a90 <printf>
          exit();
...
00001440 <unlinkread>:
{
  ...
  printf(1, "unlinkread test\n");
    ...
    144d:	6a 01                	push   $0x1
    144f:	e8 3c 26 00 00       	call   3a90 <printf>
  ...
  printf(1, "unlinkread ok\n");
    ...
    1545:	6a 01                	push   $0x1
    1547:	e8 44 25 00 00       	call   3a90 <printf>
}
    ...
    155d:	6a 01                	push   $0x1
    155f:	e8 2c 25 00 00       	call   3a90 <printf>
    exit();
    ...
    1570:	6a 01                	push   $0x1
    1572:	e8 19 25 00 00       	call   3a90 <printf>
    exit();
    ...
    1583:	6a 01                	push   $0x1
    1585:	e8 06 25 00 00       	call   3a90 <printf>
    exit();
    ...
    1596:	6a 01                	push   $0x1
    1598:	e8 f3 24 00 00       	call   3a90 <printf>
    exit();
    ...
    15a9:	6a 01                	push   $0x1
    15ab:	e8 e0 24 00 00       	call   3a90 <printf>
    exit();
    ...
    15bc:	6a 01                	push   $0x1
    15be:	e8 cd 24 00 00       	call   3a90 <printf>
    exit();
...
000015d0 <linktest>:
{
  ...
  printf(1, "linktest\n");
    ...
    15dc:	6a 01                	push   $0x1
    15de:	e8 ad 24 00 00       	call   3a90 <printf>
  unlink("lf1");
  ...
  printf(1, "linktest ok\n");
    ...
    1726:	6a 01                	push   $0x1
    1728:	e8 63 23 00 00       	call   3a90 <printf>
}
    ...
    173c:	6a 01                	push   $0x1
    173e:	e8 4d 23 00 00       	call   3a90 <printf>
    exit();
    ...
    174f:	6a 01                	push   $0x1
    1751:	e8 3a 23 00 00       	call   3a90 <printf>
    exit();
    ...
    1762:	6a 01                	push   $0x1
    1764:	e8 27 23 00 00       	call   3a90 <printf>
    exit();
    ...
    1775:	6a 01                	push   $0x1
    1777:	e8 14 23 00 00       	call   3a90 <printf>
    exit();
    ...
    1788:	6a 01                	push   $0x1
    178a:	e8 01 23 00 00       	call   3a90 <printf>
    exit();
    ...
    179b:	6a 01                	push   $0x1
    179d:	e8 ee 22 00 00       	call   3a90 <printf>
    exit();
    ...
    17ae:	6a 01                	push   $0x1
    17b0:	e8 db 22 00 00       	call   3a90 <printf>
    exit();
    ...
    17c1:	6a 01                	push   $0x1
    17c3:	e8 c8 22 00 00       	call   3a90 <printf>
    exit();
    ...
    17d4:	6a 01                	push   $0x1
    17d6:	e8 b5 22 00 00       	call   3a90 <printf>
    exit();
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "concreate test\n");
    ...
    17f3:	6a 01                	push   $0x1
    17f5:	e8 96 22 00 00       	call   3a90 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    189e:	6a 01                	push   $0x1
    18a0:	e8 eb 21 00 00       	call   3a90 <printf>
        exit();
  ...
  printf(1, "concreate ok\n");
    ...
    1a68:	6a 01                	push   $0x1
    1a6a:	e8 21 20 00 00       	call   3a90 <printf>
}
    ...
    1a7f:	6a 01                	push   $0x1
    1a81:	e8 0a 20 00 00       	call   3a90 <printf>
      exit();
    ...
    1a92:	6a 01                	push   $0x1
    1a94:	e8 f7 1f 00 00       	call   3a90 <printf>
    exit();
    ...
    1aaa:	6a 01                	push   $0x1
    1aac:	e8 df 1f 00 00       	call   3a90 <printf>
        exit();
    ...
    1ac2:	6a 01                	push   $0x1
    1ac4:	e8 c7 1f 00 00       	call   3a90 <printf>
        exit();
...
00001ae0 <linkunlink>:
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1aee:	6a 01                	push   $0x1
    1af0:	e8 9b 1f 00 00       	call   3a90 <printf>
  unlink("x");
  ...
  printf(1, "linkunlink ok\n");
    ...
    1b9f:	6a 01                	push   $0x1
    1ba1:	e8 ea 1e 00 00       	call   3a90 <printf>
}
    ...
    1bd1:	6a 01                	push   $0x1
    1bd3:	e8 b8 1e 00 00       	call   3a90 <printf>
    exit();
...
00001bf0 <bigdir>:
{
  ...
  printf(1, "bigdir test\n");
    ...
    1bfe:	6a 01                	push   $0x1
    1c00:	e8 8b 1e 00 00       	call   3a90 <printf>
  unlink("bd");
  ...
  printf(1, "bigdir ok\n");
    ...
    1cd1:	6a 01                	push   $0x1
    1cd3:	e8 b8 1d 00 00       	call   3a90 <printf>
    ...
    1ceb:	6a 01                	push   $0x1
    1ced:	e8 9e 1d 00 00       	call   3a90 <printf>
      exit();
    ...
    1cff:	6a 01                	push   $0x1
    1d01:	e8 8a 1d 00 00       	call   3a90 <printf>
      exit();
    ...
    1d12:	6a 01                	push   $0x1
    1d14:	e8 77 1d 00 00       	call   3a90 <printf>
    exit();
...
00001d20 <subdir>:
{
  ...
  printf(1, "subdir test\n");
    ...
    1d2c:	6a 01                	push   $0x1
    1d2e:	e8 5d 1d 00 00       	call   3a90 <printf>
  unlink("ff");
  ...
  printf(1, "subdir ok\n");
    ...
    2158:	6a 01                	push   $0x1
    215a:	e8 31 19 00 00       	call   3a90 <printf>
}
    ...
    216e:	6a 01                	push   $0x1
    2170:	e8 1b 19 00 00       	call   3a90 <printf>
    exit();
    ...
    2181:	6a 01                	push   $0x1
    2183:	e8 08 19 00 00       	call   3a90 <printf>
    exit();
    ...
    2194:	6a 01                	push   $0x1
    2196:	e8 f5 18 00 00       	call   3a90 <printf>
    exit();
    ...
    21a7:	6a 01                	push   $0x1
    21a9:	e8 e2 18 00 00       	call   3a90 <printf>
    exit();
    ...
    21ba:	6a 01                	push   $0x1
    21bc:	e8 cf 18 00 00       	call   3a90 <printf>
    exit();
    ...
    21cd:	6a 01                	push   $0x1
    21cf:	e8 bc 18 00 00       	call   3a90 <printf>
    exit();
    ...
    21e0:	6a 01                	push   $0x1
    21e2:	e8 a9 18 00 00       	call   3a90 <printf>
    exit();
    ...
    21f3:	6a 01                	push   $0x1
    21f5:	e8 96 18 00 00       	call   3a90 <printf>
    exit();
    ...
    2206:	6a 01                	push   $0x1
    2208:	e8 83 18 00 00       	call   3a90 <printf>
    exit();
    ...
    2219:	6a 01                	push   $0x1
    221b:	e8 70 18 00 00       	call   3a90 <printf>
    exit();
    ...
    222c:	6a 01                	push   $0x1
    222e:	e8 5d 18 00 00       	call   3a90 <printf>
    exit();
    ...
    223f:	6a 01                	push   $0x1
    2241:	e8 4a 18 00 00       	call   3a90 <printf>
    exit();
    ...
    2252:	6a 01                	push   $0x1
    2254:	e8 37 18 00 00       	call   3a90 <printf>
    exit();
    ...
    2265:	6a 01                	push   $0x1
    2267:	e8 24 18 00 00       	call   3a90 <printf>
    exit();
    ...
    2278:	6a 01                	push   $0x1
    227a:	e8 11 18 00 00       	call   3a90 <printf>
    exit();
    ...
    228b:	6a 01                	push   $0x1
    228d:	e8 fe 17 00 00       	call   3a90 <printf>
    exit();
    ...
    229e:	6a 01                	push   $0x1
    22a0:	e8 eb 17 00 00       	call   3a90 <printf>
    exit();
    ...
    22b1:	6a 01                	push   $0x1
    22b3:	e8 d8 17 00 00       	call   3a90 <printf>
    exit();
    ...
    22c4:	6a 01                	push   $0x1
    22c6:	e8 c5 17 00 00       	call   3a90 <printf>
    exit();
    ...
    22d7:	6a 01                	push   $0x1
    22d9:	e8 b2 17 00 00       	call   3a90 <printf>
    exit();
    ...
    22ea:	6a 01                	push   $0x1
    22ec:	e8 9f 17 00 00       	call   3a90 <printf>
    exit();
    ...
    22fd:	6a 01                	push   $0x1
    22ff:	e8 8c 17 00 00       	call   3a90 <printf>
    exit();
    ...
    2310:	6a 01                	push   $0x1
    2312:	e8 79 17 00 00       	call   3a90 <printf>
    exit();
    ...
    2323:	6a 01                	push   $0x1
    2325:	e8 66 17 00 00       	call   3a90 <printf>
    exit();
    ...
    2336:	6a 01                	push   $0x1
    2338:	e8 53 17 00 00       	call   3a90 <printf>
    exit();
    ...
    2349:	6a 01                	push   $0x1
    234b:	e8 40 17 00 00       	call   3a90 <printf>
    exit();
    ...
    235c:	6a 01                	push   $0x1
    235e:	e8 2d 17 00 00       	call   3a90 <printf>
    exit();
    ...
    236f:	6a 01                	push   $0x1
    2371:	e8 1a 17 00 00       	call   3a90 <printf>
    exit();
    ...
    2382:	6a 01                	push   $0x1
    2384:	e8 07 17 00 00       	call   3a90 <printf>
    exit();
    ...
    2395:	6a 01                	push   $0x1
    2397:	e8 f4 16 00 00       	call   3a90 <printf>
    exit();
    ...
    23a8:	6a 01                	push   $0x1
    23aa:	e8 e1 16 00 00       	call   3a90 <printf>
    exit();
    ...
    23bb:	6a 01                	push   $0x1
    23bd:	e8 ce 16 00 00       	call   3a90 <printf>
    exit();
    ...
    23ce:	6a 01                	push   $0x1
    23d0:	e8 bb 16 00 00       	call   3a90 <printf>
    exit();
    ...
    23e1:	6a 01                	push   $0x1
    23e3:	e8 a8 16 00 00       	call   3a90 <printf>
    exit();
    ...
    23f4:	6a 01                	push   $0x1
    23f6:	e8 95 16 00 00       	call   3a90 <printf>
    exit();
...
00002400 <bigwrite>:
{
  ...
  printf(1, "bigwrite test\n");
    ...
    2412:	6a 01                	push   $0x1
    2414:	e8 77 16 00 00       	call   3a90 <printf>
  unlink("bigwrite");
  ...
  printf(1, "bigwrite ok\n");
    ...
    24a5:	6a 01                	push   $0x1
    24a7:	e8 e4 15 00 00       	call   3a90 <printf>
}
    ...
    24bd:	6a 01                	push   $0x1
    24bf:	e8 cc 15 00 00       	call   3a90 <printf>
        exit();
    ...
    24d1:	6a 01                	push   $0x1
    24d3:	e8 b8 15 00 00       	call   3a90 <printf>
      exit();
...
000024e0 <bigfile>:
{
  ...
  printf(1, "bigfile test\n");
    ...
    24ee:	6a 01                	push   $0x1
    24f0:	e8 9b 15 00 00       	call   3a90 <printf>
  unlink("bigfile");
  ...
  printf(1, "bigfile test ok\n");
    ...
    2606:	6a 01                	push   $0x1
    2608:	e8 83 14 00 00       	call   3a90 <printf>
}
    ...
    2620:	6a 01                	push   $0x1
    2622:	e8 69 14 00 00       	call   3a90 <printf>
      exit();
    ...
    2634:	6a 01                	push   $0x1
    2636:	e8 55 14 00 00       	call   3a90 <printf>
      exit();
    ...
    2648:	6a 01                	push   $0x1
    264a:	e8 41 14 00 00       	call   3a90 <printf>
      exit();
    ...
    265c:	6a 01                	push   $0x1
    265e:	e8 2d 14 00 00       	call   3a90 <printf>
      exit();
    ...
    266f:	6a 01                	push   $0x1
    2671:	e8 1a 14 00 00       	call   3a90 <printf>
    exit();
    ...
    2682:	6a 01                	push   $0x1
    2684:	e8 07 14 00 00       	call   3a90 <printf>
    exit();
    ...
    2695:	6a 01                	push   $0x1
    2697:	e8 f4 13 00 00       	call   3a90 <printf>
    exit();
...
000026b0 <fourteen>:
{
  ...
  printf(1, "fourteen test\n");
    ...
    26bb:	6a 01                	push   $0x1
    26bd:	e8 ce 13 00 00       	call   3a90 <printf>
  ...
  printf(1, "fourteen ok\n");
    ...
    2764:	6a 01                	push   $0x1
    2766:	e8 25 13 00 00       	call   3a90 <printf>
}
    ...
    2777:	6a 01                	push   $0x1
    2779:	e8 12 13 00 00       	call   3a90 <printf>
    exit();
    ...
    278a:	6a 01                	push   $0x1
    278c:	e8 ff 12 00 00       	call   3a90 <printf>
    exit();
    ...
    279d:	6a 01                	push   $0x1
    279f:	e8 ec 12 00 00       	call   3a90 <printf>
    exit();
    ...
    27b0:	6a 01                	push   $0x1
    27b2:	e8 d9 12 00 00       	call   3a90 <printf>
    exit();
    ...
    27c3:	6a 01                	push   $0x1
    27c5:	e8 c6 12 00 00       	call   3a90 <printf>
    exit();
    ...
    27d6:	6a 01                	push   $0x1
    27d8:	e8 b3 12 00 00       	call   3a90 <printf>
    exit();
...
000027f0 <rmdot>:
{
  ...
  printf(1, "rmdot test\n");
    ...
    27fb:	6a 01                	push   $0x1
    27fd:	e8 8e 12 00 00       	call   3a90 <printf>
  if(mkdir("dots") != 0){
  ...
  printf(1, "rmdot ok\n");
    ...
    28bd:	6a 01                	push   $0x1
    28bf:	e8 cc 11 00 00       	call   3a90 <printf>
}
    ...
    28d0:	6a 01                	push   $0x1
    28d2:	e8 b9 11 00 00       	call   3a90 <printf>
    exit();
    ...
    28e3:	6a 01                	push   $0x1
    28e5:	e8 a6 11 00 00       	call   3a90 <printf>
    exit();
    ...
    28f6:	6a 01                	push   $0x1
    28f8:	e8 93 11 00 00       	call   3a90 <printf>
    exit();
    ...
    2909:	6a 01                	push   $0x1
    290b:	e8 80 11 00 00       	call   3a90 <printf>
    exit();
    ...
    291c:	6a 01                	push   $0x1
    291e:	e8 6d 11 00 00       	call   3a90 <printf>
    exit();
    ...
    292f:	6a 01                	push   $0x1
    2931:	e8 5a 11 00 00       	call   3a90 <printf>
    exit();
    ...
    2942:	6a 01                	push   $0x1
    2944:	e8 47 11 00 00       	call   3a90 <printf>
    exit();
    ...
    2955:	6a 01                	push   $0x1
    2957:	e8 34 11 00 00       	call   3a90 <printf>
    exit();
...
00002970 <dirfile>:
{
  ...
  printf(1, "dir vs file\n");
    ...
    297c:	6a 01                	push   $0x1
    297e:	e8 0d 11 00 00       	call   3a90 <printf>
  ...
  printf(1, "dir vs file OK\n");
    ...
    2aad:	6a 01                	push   $0x1
    2aaf:	e8 dc 0f 00 00       	call   3a90 <printf>
}
    ...
    2ac3:	6a 01                	push   $0x1
    2ac5:	e8 c6 0f 00 00       	call   3a90 <printf>
    exit();
    ...
    2ad6:	6a 01                	push   $0x1
    2ad8:	e8 b3 0f 00 00       	call   3a90 <printf>
    exit();
    ...
    2ae9:	6a 01                	push   $0x1
    2aeb:	e8 a0 0f 00 00       	call   3a90 <printf>
    exit();
    ...
    2afc:	6a 01                	push   $0x1
    2afe:	e8 8d 0f 00 00       	call   3a90 <printf>
    exit();
    ...
    2b0f:	6a 01                	push   $0x1
    2b11:	e8 7a 0f 00 00       	call   3a90 <printf>
    exit();
    ...
    2b22:	6a 01                	push   $0x1
    2b24:	e8 67 0f 00 00       	call   3a90 <printf>
    exit();
    ...
    2b35:	6a 01                	push   $0x1
    2b37:	e8 54 0f 00 00       	call   3a90 <printf>
    exit();
    ...
    2b48:	6a 01                	push   $0x1
    2b4a:	e8 41 0f 00 00       	call   3a90 <printf>
    exit();
    ...
    2b5b:	6a 01                	push   $0x1
    2b5d:	e8 2e 0f 00 00       	call   3a90 <printf>
    exit();
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b81:	6a 01                	push   $0x1
    2b83:	e8 08 0f 00 00       	call   3a90 <printf>
  ...
  printf(1, "empty file name OK\n");
    ...
    2c54:	6a 01                	push   $0x1
    2c56:	e8 35 0e 00 00       	call   3a90 <printf>
}
    ...
    2c6b:	6a 01                	push   $0x1
    2c6d:	e8 1e 0e 00 00       	call   3a90 <printf>
      exit();
    ...
    2c7f:	6a 01                	push   $0x1
    2c81:	e8 0a 0e 00 00       	call   3a90 <printf>
      exit();
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
    ...
    2c9e:	6a 01                	push   $0x1
    2ca0:	e8 eb 0d 00 00       	call   3a90 <printf>
  ...
  printf(1, "fork test OK\n");
    ...
    2cf0:	6a 01                	push   $0x1
    2cf2:	e8 99 0d 00 00       	call   3a90 <printf>
}
    ...
    2d09:	6a 01                	push   $0x1
    2d0b:	e8 80 0d 00 00       	call   3a90 <printf>
      exit();
    ...
    2d1c:	6a 01                	push   $0x1
    2d1e:	e8 6d 0d 00 00       	call   3a90 <printf>
    exit();
    ...
    2d2f:	6a 01                	push   $0x1
    2d31:	e8 5a 0d 00 00       	call   3a90 <printf>
    exit();
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d50:	ff 35 a8 5e 00 00    	push   0x5ea8
    2d56:	e8 35 0d 00 00       	call   3a90 <printf>
  oldbrk = sbrk(0);
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fba:	ff 35 a8 5e 00 00    	push   0x5ea8
    2fc0:	e8 cb 0a 00 00       	call   3a90 <printf>
}
    ...
    303e:	ff 35 a8 5e 00 00    	push   0x5ea8
    3044:	e8 47 0a 00 00       	call   3a90 <printf>
      exit();
    ...
    3059:	ff 35 a8 5e 00 00    	push   0x5ea8
    305f:	e8 2c 0a 00 00       	call   3a90 <printf>
      exit();
    ...
    3073:	ff 35 a8 5e 00 00    	push   0x5ea8
    3079:	e8 12 0a 00 00       	call   3a90 <printf>
      kill(ppid);
    ...
    3092:	ff 35 a8 5e 00 00    	push   0x5ea8
    3098:	e8 f3 09 00 00       	call   3a90 <printf>
    exit();
    ...
    30a9:	ff 35 a8 5e 00 00    	push   0x5ea8
    30af:	e8 dc 09 00 00       	call   3a90 <printf>
    exit();
    ...
    30c0:	ff 35 a8 5e 00 00    	push   0x5ea8
    30c6:	e8 c5 09 00 00       	call   3a90 <printf>
    exit();
    ...
    30d7:	ff 35 a8 5e 00 00    	push   0x5ea8
    30dd:	e8 ae 09 00 00       	call   3a90 <printf>
    exit();
    ...
    30ee:	ff 35 a8 5e 00 00    	push   0x5ea8
    30f4:	e8 97 09 00 00       	call   3a90 <printf>
    exit();
    ...
    3105:	6a 01                	push   $0x1
    3107:	e8 84 09 00 00       	call   3a90 <printf>
    exit();
    ...
    311d:	ff 35 a8 5e 00 00    	push   0x5ea8
    3123:	e8 68 09 00 00       	call   3a90 <printf>
    exit();
    ...
    3134:	ff 35 a8 5e 00 00    	push   0x5ea8
    313a:	e8 51 09 00 00       	call   3a90 <printf>
    exit();
    ...
    314b:	ff 35 a8 5e 00 00    	push   0x5ea8
    3151:	e8 3a 09 00 00       	call   3a90 <printf>
    exit();
    ...
    3162:	ff 35 a8 5e 00 00    	push   0x5ea8
    3168:	e8 23 09 00 00       	call   3a90 <printf>
    exit();
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    319f:	ff 35 a8 5e 00 00    	push   0x5ea8
    31a5:	e8 e6 08 00 00       	call   3a90 <printf>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 a8 5e 00 00    	push   0x5ea8
    320f:	e8 7c 08 00 00       	call   3a90 <printf>
}
    ...
    322b:	ff 35 a8 5e 00 00    	push   0x5ea8
    3231:	e8 5a 08 00 00       	call   3a90 <printf>
      exit();
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 a8 5e 00 00    	push   0x5ea8
    3251:	e8 3a 08 00 00       	call   3a90 <printf>
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 a8 5e 00 00    	push   0x5ea8
    3281:	e8 0a 08 00 00       	call   3a90 <printf>
}
    ...
    3293:	ff 35 a8 5e 00 00    	push   0x5ea8
    3299:	e8 f2 07 00 00       	call   3a90 <printf>
      exit();
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    3310:	c7 04 85 e0 a5 00 00 	movl   $0x5420,0xa5e0(,%eax,4)
    3317:	20 54 00 00 
    ...
    332a:	ff 35 a8 5e 00 00    	push   0x5ea8
    args[MAXARG-1] = 0;
    3330:	c7 05 5c a6 00 00 00 	movl   $0x0,0xa65c
    3337:	00 00 00 
    printf(stdout, "bigarg test\n");
    333a:	e8 51 07 00 00       	call   3a90 <printf>
    exec("echo", args);
    333f:	58                   	pop    %eax
    3340:	5a                   	pop    %edx
    ...
    3357:	ff 35 a8 5e 00 00    	push   0x5ea8
    335d:	e8 2e 07 00 00       	call   3a90 <printf>
    ...
    3387:	ff 35 a8 5e 00 00    	push   0x5ea8
    338d:	e8 fe 06 00 00       	call   3a90 <printf>
    exit();
    ...
    339e:	ff 35 a8 5e 00 00    	push   0x5ea8
    33a4:	e8 e7 06 00 00       	call   3a90 <printf>
    exit();
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    33c0:	6a 01                	push   $0x1
    33c2:	e8 c9 06 00 00       	call   3a90 <printf>
    ...
    3447:	6a 01                	push   $0x1
    3449:	e8 42 06 00 00       	call   3a90 <printf>
    ...
    3498:	6a 01                	push   $0x1
    349a:	e8 f1 05 00 00       	call   3a90 <printf>
    close(fd);
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    34c2:	6a 01                	push   $0x1
    34c4:	e8 c7 05 00 00       	call   3a90 <printf>
      break;
  ...
  printf(1, "fsfull test finished\n");
    ...
    3561:	6a 01                	push   $0x1
    3563:	e8 28 05 00 00       	call   3a90 <printf>
}
...
00003580 <uio>:
{
  ...
  printf(1, "uio test\n");
    ...
    358b:	6a 01                	push   $0x1
    358d:	e8 fe 04 00 00       	call   3a90 <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    35ad:	6a 01                	push   $0x1
    35af:	e8 dc 04 00 00       	call   3a90 <printf>
}
    ...
    35d1:	6a 01                	push   $0x1
    35d3:	e8 b8 04 00 00       	call   3a90 <printf>
    exit();
    ...
    35e4:	6a 01                	push   $0x1
    35e6:	e8 a5 04 00 00       	call   3a90 <printf>
    exit();
...
000035f0 <argptest>:
{
  ...
  printf(1, "arg test passed\n");
    ...
    3634:	6a 01                	push   $0x1
    3636:	e8 55 04 00 00       	call   3a90 <printf>
}
    ...
    364a:	6a 02                	push   $0x2
    364c:	e8 3f 04 00 00       	call   3a90 <printf>
    exit();
...
00003660 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3660:	69 05 a4 5e 00 00 0d 	imul   $0x19660d,0x5ea4,%eax
    3667:	66 19 00 
    366a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    366f:	a3 a4 5e 00 00       	mov    %eax,0x5ea4
}
    3674:	c3                   	ret    
...
000039cb <sem_signal>:
SYSCALL(sem_signal)
    39cb:	b8 21 00 00 00       	mov    $0x21,%eax
    39d0:	cd 40                	int    $0x40
    39d2:	c3                   	ret    

000039d3 <getppid>:
    39d3:	b8 22 00 00 00       	mov    $0x22,%eax
    39d8:	cd 40                	int    $0x40
    39da:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    39e9:	89 4d c4             	mov    %ecx,-0x3c(%ebp)
  uint x;
...
{
    39ee:	89 45 b8             	mov    %eax,-0x48(%ebp)
  if(sgn && xx < 0){
    39f1:	85 d2                	test   %edx,%edx
    39f3:	0f 89 7f 00 00 00    	jns    3a78 <printint+0x98>
    39f9:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    39fd:	74 79                	je     3a78 <printint+0x98>
    neg = 1;
    39ff:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    x = -xx;
    3a06:	f7 d9                	neg    %ecx
  } else {
    x = xx;
  ...
  i = 0;
    3a08:	31 db                	xor    %ebx,%ebx
    3a0a:	8d 75 d7             	lea    -0x29(%ebp),%esi
    3a0d:	8d 76 00             	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    3a10:	89 c8                	mov    %ecx,%eax
    3a12:	31 d2                	xor    %edx,%edx
    3a14:	89 cf                	mov    %ecx,%edi
    3a16:	f7 75 c4             	divl   -0x3c(%ebp)
    3a19:	0f b6 92 b0 55 00 00 	movzbl 0x55b0(%edx),%edx
    3a20:	89 45 c0             	mov    %eax,-0x40(%ebp)
    3a23:	89 d8                	mov    %ebx,%eax
    3a25:	8d 5b 01             	lea    0x1(%ebx),%ebx
  }while((x /= base) != 0);
    3a28:	8b 4d c0             	mov    -0x40(%ebp),%ecx
    buf[i++] = digits[x % base];
    3a2b:	88 14 1e             	mov    %dl,(%esi,%ebx,1)
  }while((x /= base) != 0);
    3a2e:	39 7d c4             	cmp    %edi,-0x3c(%ebp)
    3a31:	76 dd                	jbe    3a10 <printint+0x30>
  if(neg)
    3a33:	8b 4d bc             	mov    -0x44(%ebp),%ecx
    3a36:	85 c9                	test   %ecx,%ecx
    3a38:	74 0c                	je     3a46 <printint+0x66>
    buf[i++] = '-';
    3a3a:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    buf[i++] = digits[x % base];
    3a3f:	89 d8                	mov    %ebx,%eax
    buf[i++] = '-';
    3a41:	ba 2d 00 00 00       	mov    $0x2d,%edx

  while(--i >= 0)
    3a46:	8b 7d b8             	mov    -0x48(%ebp),%edi
    3a49:	8d 5c 05 d7          	lea    -0x29(%ebp,%eax,1),%ebx
    3a4d:	eb 07                	jmp    3a56 <printint+0x76>
    3a4f:	90                   	nop
    putc(fd, buf[i]);
    3a50:	0f b6 13             	movzbl (%ebx),%edx
    3a53:	83 eb 01             	sub    $0x1,%ebx
  write(fd, &c, 1);
    3a56:	83 ec 04             	sub    $0x4,%esp
    3a59:	88 55 d7             	mov    %dl,-0x29(%ebp)
    3a5c:	6a 01                	push   $0x1
    3a5e:	56                   	push   %esi
    3a5f:	57                   	push   %edi
    3a60:	e8 8e fe ff ff       	call   38f3 <write>
  while(--i >= 0)
    3a65:	83 c4 10             	add    $0x10,%esp
    3a68:	39 de                	cmp    %ebx,%esi
    3a6a:	75 e4                	jne    3a50 <printint+0x70>
}
    3a6c:	8d 65 f4             	lea    -0xc(%ebp),%esp
    3a6f:	5b                   	pop    %ebx
    3a70:	5e                   	pop    %esi
    3a71:	5f                   	pop    %edi
    3a72:	5d                   	pop    %ebp
  ...
  neg = 0;
    3a78:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
    3a7f:	eb 87                	jmp    3a08 <printint+0x28>
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    3a99:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
    3a9c:	8b 75 08             	mov    0x8(%ebp),%esi
  for(i = 0; fmt[i]; i++){
    3a9f:	0f b6 13             	movzbl (%ebx),%edx
    3aa2:	84 d2                	test   %dl,%dl
    3aa4:	74 6a                	je     3b10 <printf+0x80>
  ap = (uint*)(void*)&fmt + 1;
    3aa6:	8d 45 10             	lea    0x10(%ebp),%eax
    3aa9:	83 c3 01             	add    $0x1,%ebx
  write(fd, &c, 1);
    3aac:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    3aaf:	31 c9                	xor    %ecx,%ecx
  ap = (uint*)(void*)&fmt + 1;
    3ab1:	89 45 d0             	mov    %eax,-0x30(%ebp)
    3ab4:	eb 36                	jmp    3aec <printf+0x5c>
    3ab6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3abd:	8d 76 00             	lea    0x0(%esi),%esi
    3ac0:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    3ac3:	b9 25 00 00 00       	mov    $0x25,%ecx
      if(c == '%'){
    3ac8:	83 f8 25             	cmp    $0x25,%eax
    3acb:	74 15                	je     3ae2 <printf+0x52>
  write(fd, &c, 1);
    3acd:	83 ec 04             	sub    $0x4,%esp
    3ad0:	88 55 e7             	mov    %dl,-0x19(%ebp)
    3ad3:	6a 01                	push   $0x1
    3ad5:	57                   	push   %edi
    3ad6:	56                   	push   %esi
    3ad7:	e8 17 fe ff ff       	call   38f3 <write>
    3adc:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
      } else {
        putc(fd, c);
    3adf:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    3ae2:	0f b6 13             	movzbl (%ebx),%edx
    3ae5:	83 c3 01             	add    $0x1,%ebx
    3ae8:	84 d2                	test   %dl,%dl
    3aea:	74 24                	je     3b10 <printf+0x80>
    c = fmt[i] & 0xff;
    3aec:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
    3aef:	85 c9                	test   %ecx,%ecx
    3af1:	74 cd                	je     3ac0 <printf+0x30>
      }
    } else if(state == '%'){
    3af3:	83 f9 25             	cmp    $0x25,%ecx
    3af6:	75 ea                	jne    3ae2 <printf+0x52>
      if(c == 'd'){
    3af8:	83 f8 25             	cmp    $0x25,%eax
    3afb:	0f 84 07 01 00 00    	je     3c08 <printf+0x178>
    3b01:	83 e8 63             	sub    $0x63,%eax
    3b04:	83 f8 15             	cmp    $0x15,%eax
    3b07:	77 17                	ja     3b20 <printf+0x90>
    3b09:	ff 24 85 58 55 00 00 	jmp    *0x5558(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    3b23:	88 55 d4             	mov    %dl,-0x2c(%ebp)
    3b26:	6a 01                	push   $0x1
    3b28:	57                   	push   %edi
    3b29:	56                   	push   %esi
    3b2a:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    3b2e:	e8 c0 fd ff ff       	call   38f3 <write>
        putc(fd, c);
    3b33:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
  write(fd, &c, 1);
    3b37:	83 c4 0c             	add    $0xc,%esp
    3b3a:	88 55 e7             	mov    %dl,-0x19(%ebp)
    3b3d:	6a 01                	push   $0x1
    3b3f:	57                   	push   %edi
    3b40:	56                   	push   %esi
    3b41:	e8 ad fd ff ff       	call   38f3 <write>
        putc(fd, c);
    3b46:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3b49:	31 c9                	xor    %ecx,%ecx
    3b4b:	eb 95                	jmp    3ae2 <printf+0x52>
    3b4d:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    3b50:	83 ec 0c             	sub    $0xc,%esp
    3b53:	b9 10 00 00 00       	mov    $0x10,%ecx
    3b58:	6a 00                	push   $0x0
    3b5a:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3b5d:	8b 10                	mov    (%eax),%edx
    3b5f:	89 f0                	mov    %esi,%eax
    3b61:	e8 7a fe ff ff       	call   39e0 <printint>
        ap++;
    3b66:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    3b6a:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3b6d:	31 c9                	xor    %ecx,%ecx
    3b6f:	e9 6e ff ff ff       	jmp    3ae2 <printf+0x52>
    3b74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    3b78:	8b 45 d0             	mov    -0x30(%ebp),%eax
    3b7b:	8b 10                	mov    (%eax),%edx
        ap++;
    3b7d:	83 c0 04             	add    $0x4,%eax
    3b80:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    3b83:	85 d2                	test   %edx,%edx
    3b85:	0f 84 8d 00 00 00    	je     3c18 <printf+0x188>
        while(*s != 0){
    3b8b:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
    3b8e:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
    3b90:	84 c0                	test   %al,%al
    3b92:	0f 84 4a ff ff ff    	je     3ae2 <printf+0x52>
    3b98:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    3b9b:	89 d3                	mov    %edx,%ebx
  ...
  write(fd, &c, 1);
    ...
    3bab:	57                   	push   %edi
    3bac:	56                   	push   %esi
    3bad:	e8 41 fd ff ff       	call   38f3 <write>
        while(*s != 0){
    3bb2:	0f b6 03             	movzbl (%ebx),%eax
    3bb5:	83 c4 10             	add    $0x10,%esp
    3bb8:	84 c0                	test   %al,%al
    3bba:	75 e4                	jne    3ba0 <printf+0x110>
      state = 0;
    3bbc:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
    3bbf:	31 c9                	xor    %ecx,%ecx
    3bc1:	e9 1c ff ff ff       	jmp    3ae2 <printf+0x52>
    3bc6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    3bcd:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
    3bd0:	83 ec 0c             	sub    $0xc,%esp
    3bd3:	b9 0a 00 00 00       	mov    $0xa,%ecx
    3bd8:	6a 01                	push   $0x1
    3bda:	e9 7b ff ff ff       	jmp    3b5a <printf+0xca>
    3bdf:	90                   	nop
        putc(fd, *ap);
  ...
  write(fd, &c, 1);
    ...
    3beb:	56                   	push   %esi
        putc(fd, *ap);
    3bec:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    3bef:	e8 ff fc ff ff       	call   38f3 <write>
        ap++;
    3bf4:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    3bf8:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3bfb:	31 c9                	xor    %ecx,%ecx
    3bfd:	e9 e0 fe ff ff       	jmp    3ae2 <printf+0x52>
    3c02:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        putc(fd, c);
    3c08:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    3c0b:	83 ec 04             	sub    $0x4,%esp
    3c0e:	e9 2a ff ff ff       	jmp    3b3d <printf+0xad>
    3c13:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3c17:	90                   	nop
          s = "(null)";
    3c18:	ba 4e 55 00 00       	mov    $0x554e,%edx
        while(*s != 0){
    3c1d:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    3c20:	b8 28 00 00 00       	mov    $0x28,%eax
    3c25:	89 d3                	mov    %edx,%ebx
    3c27:	e9 74 ff ff ff       	jmp    3ba0 <printf+0x110>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c31:	a1 60 a6 00 00       	mov    0xa660,%eax
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    3c48:	89 c2                	mov    %eax,%edx
    3c4a:	8b 00                	mov    (%eax),%eax
    3c4c:	39 ca                	cmp    %ecx,%edx
    3c4e:	73 30                	jae    3c80 <free+0x50>
    3c50:	39 c1                	cmp    %eax,%ecx
    3c52:	72 04                	jb     3c58 <free+0x28>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3c54:	39 c2                	cmp    %eax,%edx
    3c56:	72 f0                	jb     3c48 <free+0x18>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3c58:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3c5b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3c5e:	39 f8                	cmp    %edi,%eax
    3c60:	74 30                	je     3c92 <free+0x62>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    3c62:	89 43 f8             	mov    %eax,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    3c65:	8b 42 04             	mov    0x4(%edx),%eax
    3c68:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    3c6b:	39 f1                	cmp    %esi,%ecx
    3c6d:	74 3a                	je     3ca9 <free+0x79>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    3c6f:	89 0a                	mov    %ecx,(%edx)
  } else
    p->s.ptr = bp;
  freep = p;
}
    3c71:	5b                   	pop    %ebx
  freep = p;
    3c72:	89 15 60 a6 00 00    	mov    %edx,0xa660
}
    3c78:	5e                   	pop    %esi
    3c79:	5f                   	pop    %edi
    3c7a:	5d                   	pop    %ebp
    ...
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3c80:	39 c2                	cmp    %eax,%edx
    3c82:	72 c4                	jb     3c48 <free+0x18>
    3c84:	39 c1                	cmp    %eax,%ecx
    3c86:	73 c0                	jae    3c48 <free+0x18>
  if(bp + bp->s.size == p->s.ptr){
    3c88:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3c8b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3c8e:	39 f8                	cmp    %edi,%eax
    3c90:	75 d0                	jne    3c62 <free+0x32>
    bp->s.size += p->s.ptr->s.size;
    3c92:	03 70 04             	add    0x4(%eax),%esi
    3c95:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3c98:	8b 02                	mov    (%edx),%eax
    3c9a:	8b 00                	mov    (%eax),%eax
    3c9c:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    3c9f:	8b 42 04             	mov    0x4(%edx),%eax
    3ca2:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    3ca5:	39 f1                	cmp    %esi,%ecx
    3ca7:	75 c6                	jne    3c6f <free+0x3f>
    p->s.size += bp->s.size;
    3ca9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
    3cac:	89 15 60 a6 00 00    	mov    %edx,0xa660
    p->s.size += bp->s.size;
    3cb2:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    3cb5:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    3cb8:	89 0a                	mov    %ecx,(%edx)
}
    3cba:	5b                   	pop    %ebx
    3cbb:	5e                   	pop    %esi
    3cbc:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3ccc:	8b 3d 60 a6 00 00    	mov    0xa660,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3cea:	73 6a                	jae    3d56 <malloc+0x96>
    3cec:	bb 00 10 00 00       	mov    $0x1000,%ebx
    3cf1:	39 de                	cmp    %ebx,%esi
    3cf3:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    3cf6:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    3cfd:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    3d00:	eb 17                	jmp    3d19 <malloc+0x59>
    3d02:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d08:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    3d0a:	8b 48 04             	mov    0x4(%eax),%ecx
    3d0d:	39 f1                	cmp    %esi,%ecx
    3d0f:	73 4f                	jae    3d60 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    3d11:	8b 3d 60 a6 00 00    	mov    0xa660,%edi
    3d17:	89 c2                	mov    %eax,%edx
    3d19:	39 d7                	cmp    %edx,%edi
    3d1b:	75 eb                	jne    3d08 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    3d1d:	83 ec 0c             	sub    $0xc,%esp
    3d20:	ff 75 e4             	push   -0x1c(%ebp)
    3d23:	e8 33 fc ff ff       	call   395b <sbrk>
  if(p == (char*)-1)
    3d28:	83 c4 10             	add    $0x10,%esp
    3d2b:	83 f8 ff             	cmp    $0xffffffff,%eax
    3d2e:	74 1c                	je     3d4c <malloc+0x8c>
  hp->s.size = nu;
    3d30:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3d33:	83 ec 0c             	sub    $0xc,%esp
    3d36:	83 c0 08             	add    $0x8,%eax
    3d39:	50                   	push   %eax
    3d3a:	e8 f1 fe ff ff       	call   3c30 <free>
  return freep;
    3d3f:	8b 15 60 a6 00 00    	mov    0xa660,%edx
      if((p = morecore(nunits)) == 0)
    3d45:	83 c4 10             	add    $0x10,%esp
    3d48:	85 d2                	test   %edx,%edx
    3d4a:	75 bc                	jne    3d08 <malloc+0x48>
        return 0;
  }
}
    3d4c:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    3d4f:	31 c0                	xor    %eax,%eax
}
    3d51:	5b                   	pop    %ebx
    3d52:	5e                   	pop    %esi
    3d53:	5f                   	pop    %edi
    ...
    3d55:	c3                   	ret    
    if(p->s.size >= nunits){
    3d56:	89 d0                	mov    %edx,%eax
    3d58:	89 fa                	mov    %edi,%edx
    3d5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    3d60:	39 ce                	cmp    %ecx,%esi
    3d62:	74 4c                	je     3db0 <malloc+0xf0>
        p->s.size -= nunits;
    3d64:	29 f1                	sub    %esi,%ecx
    3d66:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    3d69:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    3d6c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3d6f:	89 15 60 a6 00 00    	mov    %edx,0xa660
}
    3d75:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    3d78:	83 c0 08             	add    $0x8,%eax
}
    3d7b:	5b                   	pop    %ebx
    3d7c:	5e                   	pop    %esi
    3d7d:	5f                   	pop    %edi
    ...
    3d7f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3d80:	c7 05 60 a6 00 00 64 	movl   $0xa664,0xa660
    3d87:	a6 00 00 
    base.s.size = 0;
    3d8a:	bf 64 a6 00 00       	mov    $0xa664,%edi
    base.s.ptr = freep = prevp = &base;
    3d8f:	c7 05 64 a6 00 00 64 	movl   $0xa664,0xa664
    3d96:	a6 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d99:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3d9b:	c7 05 68 a6 00 00 00 	movl   $0x0,0xa668
    3da2:	00 00 00 
    if(p->s.size >= nunits){
    3da5:	e9 42 ff ff ff       	jmp    3cec <malloc+0x2c>
    3daa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    3db0:	8b 08                	mov    (%eax),%ecx
    3db2:	89 0a                	mov    %ecx,(%edx)
    3db4:	eb b9                	jmp    3d6f <malloc+0xaf>

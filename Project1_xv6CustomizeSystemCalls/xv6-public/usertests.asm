...
00003993 <get_priority>:
SYSCALL(get_priority)
    3993:	b8 1c 00 00 00       	mov    $0x1c,%eax
    3998:	cd 40                	int    $0x40
    399a:	c3                   	ret    

0000399b <set_priority>:
SYSCALL(set_priority)
    399b:	b8 1d 00 00 00       	mov    $0x1d,%eax
    39a0:	cd 40                	int    $0x40
    39a2:	c3                   	ret    

000039a3 <sem_init>:
SYSCALL(sem_init)
    39a3:	b8 1e 00 00 00       	mov    $0x1e,%eax
    39a8:	cd 40                	int    $0x40
    39aa:	c3                   	ret    

000039ab <sem_destroy>:
SYSCALL(sem_destroy)
    39ab:	b8 1f 00 00 00       	mov    $0x1f,%eax
    39b0:	cd 40                	int    $0x40
    39b2:	c3                   	ret    

000039b3 <sem_wait>:
SYSCALL(sem_wait)
    39b3:	b8 20 00 00 00       	mov    $0x20,%eax
    39b8:	cd 40                	int    $0x40
    39ba:	c3                   	ret    

000039bb <sem_signal>:
SYSCALL(sem_signal)
    39bb:	b8 21 00 00 00       	mov    $0x21,%eax
    39c0:	cd 40                	int    $0x40
    39c2:	c3                   	ret    

000039c3 <getppid>:
    39c3:	b8 22 00 00 00       	mov    $0x22,%eax
    39c8:	cd 40                	int    $0x40
    39ca:	c3                   	ret    

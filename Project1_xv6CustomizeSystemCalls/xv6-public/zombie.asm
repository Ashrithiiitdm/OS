 ...
 5e1:	a1 70 0a 00 00       	mov    0xa70,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 70 0a 00 00    	mov    %edx,0xa70
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 70 0a 00 00    	mov    %edx,0xa70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 70 0a 00 00    	mov    0xa70,%edx
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 70 0a 00 00 74 	movl   $0xa74,0xa70
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf 74 0a 00 00       	mov    $0xa74,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 752:	00 00 00 
    if(p->s.size >= nunits){
